...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr0 = msat_make_plus(menv, xs[7], n_11_0)
    ...
    # ltl property: (G (! ((! (x_23 - x_19 >= 10)) U (! (X (x_10 - x_18 >= 0))))))
    ltl = enc.make_G(msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_geq(menv, msat_make_minus(menv, xs[23], xs[19]), msat_make_number(menv, "10"))), msat_make_not(menv, enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[10], xs[18]), msat_make_number(menv, "0")))))))
