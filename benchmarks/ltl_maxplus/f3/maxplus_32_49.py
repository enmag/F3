...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_31 - x_23 >= 13) & ((x_7 - x_12 >= 13) | (x_13 - x_30 > -15)))
    ltl = msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[31], xs[23]), msat_make_number(menv, "13")), msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[7], xs[12]), msat_make_number(menv, "13")), msat_make_gt(menv, msat_make_minus(menv, xs[13], xs[30]), msat_make_number(menv, "-15"))))
