...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr10 = msat_make_plus(menv, xs[27], n_14_0)
    ...
    expr16 = msat_make_plus(menv, xs[29], n_18_0)
    ...
    expr6 = msat_make_plus(menv, xs[6], n_17_0)
    ...
    expr0 = msat_make_plus(menv, xs[6], n_2_0)
    expr1 = msat_make_plus(menv, xs[9], n_20_0)
    ...
    expr2 = msat_make_plus(menv, xs[10], n_13_0)
    ...
    expr8 = msat_make_plus(menv, xs[26], n_20_0)
    expr9 = msat_make_plus(menv, xs[27], n_18_0)
    expr10 = msat_make_plus(menv, xs[28], n_8_0)
    expr11 = msat_make_plus(menv, xs[29], n_1_0)
    ...
    expr0 = msat_make_plus(menv, xs[7], n_1_0)
    expr1 = msat_make_plus(menv, xs[9], n_1_0)
    expr2 = msat_make_plus(menv, xs[10], n_18_0)
    ...
    # ltl property: ((F (x_10 - x_26 > 15)) & (X (x_39 - x_22 >= -15)))
    ltl = msat_make_and(menv, enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[10], xs[26]), msat_make_number(menv, "15"))), enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[39], xs[22]), msat_make_number(menv, "-15"))))
