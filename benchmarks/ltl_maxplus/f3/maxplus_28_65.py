...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (G ((x_23 - x_8 >= -17) | (G (x_7 - x_2 > -5))))
    ltl = enc.make_G(msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[23], xs[8]), msat_make_number(menv, "-17")), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[7], xs[2]), msat_make_number(menv, "-5")))))
