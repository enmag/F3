...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (! ((! (G (x_21 - x_0 >= -10))) U (! (X (x_12 - x_25 >= -16)))))
    ltl = msat_make_not(menv, enc.make_U(msat_make_not(menv, enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[21], xs[0]), msat_make_number(menv, "-10")))), msat_make_not(menv, enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[12], xs[25]), msat_make_number(menv, "-16"))))))
