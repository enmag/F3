...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_16 - x_15 >= 17) | (X (G (x_10 - x_16 > 3))))
    ltl = msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[16], xs[15]), msat_make_number(menv, "17")), enc.make_X(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[10], xs[16]), msat_make_number(menv, "3")))))
