...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (X ((x_10 - x_5 >= 18) | (X (x_14 - x_6 >= -2))))
    ltl = enc.make_X(msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[10], xs[5]), msat_make_number(menv, "18")), enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[14], xs[6]), msat_make_number(menv, "-2")))))
