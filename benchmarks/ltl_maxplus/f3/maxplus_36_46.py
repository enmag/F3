...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr1 = msat_make_plus(menv, xs[8], n_20_0)
    ...
    # ltl property: ((X (x_21 - x_20 > 7)) | (F (x_25 - x_35 > 1)))
    ltl = msat_make_or(menv, enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[21], xs[20]), msat_make_number(menv, "7"))), enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[25], xs[35]), msat_make_number(menv, "1"))))
