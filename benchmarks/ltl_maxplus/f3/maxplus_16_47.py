...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (F (G ((x_4 - x_1 > 8) & (x_9 - x_13 >= 17))))
    ltl = enc.make_F(enc.make_G(msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[4], xs[1]), msat_make_number(menv, "8")), msat_make_geq(menv, msat_make_minus(menv, xs[9], xs[13]), msat_make_number(menv, "17")))))
