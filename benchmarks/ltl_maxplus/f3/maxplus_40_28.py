...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr1 = msat_make_plus(menv, xs[8], n_2_0)
    ...
    expr13 = msat_make_plus(menv, xs[31], n_8_0)
    ...
    expr18 = msat_make_plus(menv, xs[30], n_7_0)
    ...
    expr11 = msat_make_plus(menv, xs[15], n_13_0)
    ...
    # ltl property: (X ((x_13 - x_34 > 20) & (G (x_16 - x_31 >= -12))))
    ltl = enc.make_X(msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[13], xs[34]), msat_make_number(menv, "20")), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[16], xs[31]), msat_make_number(menv, "-12")))))
