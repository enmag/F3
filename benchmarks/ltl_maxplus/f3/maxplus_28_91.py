...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (X (F (G (F (x_25 - x_23 > 17)))))
    ltl = enc.make_X(enc.make_F(enc.make_G(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[25], xs[23]), msat_make_number(menv, "17"))))))
