...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (G ((X (x_12 - x_15 >= -12)) U (x_3 - x_12 >= 18)))
    ltl = enc.make_G(enc.make_U(enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[12], xs[15]), msat_make_number(menv, "-12"))), msat_make_geq(menv, msat_make_minus(menv, xs[3], xs[12]), msat_make_number(menv, "18"))))
