...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_3 - x_24 >= 15) & ((x_7 - x_20 >= -13) | (x_0 - x_12 >= -12)))
    ltl = msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[3], xs[24]), msat_make_number(menv, "15")), msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[7], xs[20]), msat_make_number(menv, "-13")), msat_make_geq(menv, msat_make_minus(menv, xs[0], xs[12]), msat_make_number(menv, "-12"))))
