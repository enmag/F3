...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr9 = msat_make_plus(menv, xs[11], n_15_0)
    expr10 = msat_make_plus(menv, xs[12], n_16_0)
    expr11 = msat_make_plus(menv, xs[13], n_20_0)
    expr12 = msat_make_plus(menv, xs[14], n_8_0)
    expr13 = msat_make_plus(menv, xs[17], n_3_0)
    expr14 = msat_make_plus(menv, xs[18], n_7_0)
    ...
    expr5 = msat_make_plus(menv, xs[19], n_1_0)
    ...
    # ltl property: ((x_10 - x_22 > 1) & (G (F (x_9 - x_18 > 4))))
    ltl = msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[10], xs[22]), msat_make_number(menv, "1")), enc.make_G(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[9], xs[18]), msat_make_number(menv, "4")))))
