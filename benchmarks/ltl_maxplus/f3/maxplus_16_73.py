...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((X (X (x_5 - x_7 >= 2))) U (x_12 - x_14 > 4))
    ltl = enc.make_U(enc.make_X(enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[5], xs[7]), msat_make_number(menv, "2")))), msat_make_gt(menv, msat_make_minus(menv, xs[12], xs[14]), msat_make_number(menv, "4")))
