...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (F (X (F (G (x_2 - x_3 >= 7)))))
    ltl = enc.make_F(enc.make_X(enc.make_F(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[2], xs[3]), msat_make_number(menv, "7"))))))
