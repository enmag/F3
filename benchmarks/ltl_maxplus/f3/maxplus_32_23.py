...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((G (x_21 - x_11 >= -13)) U (G (x_30 - x_17 > 17)))
    ltl = enc.make_U(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[21], xs[11]), msat_make_number(menv, "-13"))), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[30], xs[17]), msat_make_number(menv, "17"))))
