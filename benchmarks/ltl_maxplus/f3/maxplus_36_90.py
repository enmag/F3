...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr6 = msat_make_plus(menv, xs[7], n_15_0)
    ...
    # ltl property: (F ((F (x_18 - x_5 >= -4)) U (x_34 - x_25 >= 5)))
    ltl = enc.make_F(enc.make_U(enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[18], xs[5]), msat_make_number(menv, "-4"))), msat_make_geq(menv, msat_make_minus(menv, xs[34], xs[25]), msat_make_number(menv, "5"))))
