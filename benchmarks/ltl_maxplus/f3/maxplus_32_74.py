...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr0 = msat_make_plus(menv, xs[6], n_14_0)
    ...
    # ltl property: ((x_4 - x_16 >= 4) & (F (G (x_21 - x_11 >= -20))))
    ltl = msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[4], xs[16]), msat_make_number(menv, "4")), enc.make_F(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[21], xs[11]), msat_make_number(menv, "-20")))))
