...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr7 = msat_make_plus(menv, xs[7], n_3_0)
    expr8 = msat_make_plus(menv, xs[9], n_16_0)
    expr9 = msat_make_plus(menv, xs[13], n_3_0)
    expr10 = msat_make_plus(menv, xs[15], n_12_0)
    expr11 = msat_make_plus(menv, xs[16], n_18_0)
    expr12 = msat_make_plus(menv, xs[18], n_7_0)
    ...
    expr10 = msat_make_plus(menv, xs[18], n_1_0)
    ...
    expr3 = msat_make_plus(menv, xs[12], n_3_0)
    expr4 = msat_make_plus(menv, xs[14], n_9_0)
    expr5 = msat_make_plus(menv, xs[16], n_9_0)
    expr6 = msat_make_plus(menv, xs[18], n_2_0)
    ...
    expr9 = msat_make_plus(menv, xs[11], n_10_0)
    expr10 = msat_make_plus(menv, xs[13], n_6_0)
    expr11 = msat_make_plus(menv, xs[15], n_3_0)
    ...
    expr1 = msat_make_plus(menv, xs[6], n_16_0)
    ...
    expr19 = msat_make_plus(menv, xs[36], n_6_0)
    _t = msat_make_and(menv,
    ...
    expr12 = msat_make_plus(menv, xs[19], n_11_0)
    ...
    expr13 = msat_make_plus(menv, xs[22], n_15_0)
    expr14 = msat_make_plus(menv, xs[24], n_13_0)
    ...
    expr18 = msat_make_plus(menv, xs[33], n_7_0)
    ...
    expr12 = msat_make_plus(menv, xs[21], n_1_0)
    expr13 = msat_make_plus(menv, xs[28], n_2_0)
    ...
    expr0 = msat_make_plus(menv, xs[6], n_6_0)
    ...
    # ltl property: (F ((X (x_10 - x_16 > 4)) U (x_10 - x_27 >= 8)))
    ltl = enc.make_F(enc.make_U(enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[10], xs[16]), msat_make_number(menv, "4"))), msat_make_geq(menv, msat_make_minus(menv, xs[10], xs[27]), msat_make_number(menv, "8"))))
