...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (X (! ((! (F (x_21 - x_17 > -4))) U (! (x_28 - x_11 >= -6)))))
    ltl = enc.make_X(msat_make_not(menv, enc.make_U(msat_make_not(menv, enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[21], xs[17]), msat_make_number(menv, "-4")))), msat_make_not(menv, msat_make_geq(menv, msat_make_minus(menv, xs[28], xs[11]), msat_make_number(menv, "-6"))))))
