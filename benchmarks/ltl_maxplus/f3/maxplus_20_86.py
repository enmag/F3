...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_19 - x_0 > 18) & (G (F (x_1 - x_18 > -20))))
    ltl = msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[19], xs[0]), msat_make_number(menv, "18")), enc.make_G(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[1], xs[18]), msat_make_number(menv, "-20")))))
