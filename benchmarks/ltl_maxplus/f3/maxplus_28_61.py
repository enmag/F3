...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((X (X (x_3 - x_9 > -11))) U (x_20 - x_17 > -14))
    ltl = enc.make_U(enc.make_X(enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[3], xs[9]), msat_make_number(menv, "-11")))), msat_make_gt(menv, msat_make_minus(menv, xs[20], xs[17]), msat_make_number(menv, "-14")))
