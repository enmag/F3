...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F ((X (x_17 - x_6 >= 18)) U (x_11 - x_9 >= 11)))
    ltl = enc.make_F(enc.make_U(enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[17], xs[6]), msat_make_number(menv, "18"))), msat_make_geq(menv, msat_make_minus(menv, xs[11], xs[9]), msat_make_number(menv, "11"))))
