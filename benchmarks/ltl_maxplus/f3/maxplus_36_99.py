...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr8 = msat_make_plus(menv, xs[24], n_10_0)
    ...
    expr8 = msat_make_plus(menv, xs[10], n_4_0)
    ...
    # ltl property: (X ((x_4 - x_32 > 19) | (G (x_15 - x_16 > 0))))
    ltl = enc.make_X(msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[4], xs[32]), msat_make_number(menv, "19")), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[15], xs[16]), msat_make_number(menv, "0")))))
