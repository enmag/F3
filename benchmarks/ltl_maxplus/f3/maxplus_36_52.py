...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr5 = msat_make_plus(menv, xs[20], n_7_0)
    expr6 = msat_make_plus(menv, xs[21], n_13_0)
    ...
    expr9 = msat_make_plus(menv, xs[11], n_4_0)
    expr10 = msat_make_plus(menv, xs[12], n_14_0)
    expr11 = msat_make_plus(menv, xs[13], n_9_0)
    ...
    # ltl property: (! ((! (x_7 - x_21 > 9)) U (! (G (F (x_24 - x_4 >= -6))))))
    ltl = msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[7], xs[21]), msat_make_number(menv, "9"))), msat_make_not(menv, enc.make_G(enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[24], xs[4]), msat_make_number(menv, "-6")))))))
