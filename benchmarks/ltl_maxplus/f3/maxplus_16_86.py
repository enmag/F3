...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_15 - x_13 > 13) & (G (F (x_4 - x_1 >= 7))))
    ltl = msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[15], xs[13]), msat_make_number(menv, "13")), enc.make_G(enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[4], xs[1]), msat_make_number(menv, "7")))))
