...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_5 - x_17 > -11) U ((x_17 - x_14 >= -3) | (x_4 - x_1 > 12)))
    ltl = enc.make_U(msat_make_gt(menv, msat_make_minus(menv, xs[5], xs[17]), msat_make_number(menv, "-11")), msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[17], xs[14]), msat_make_number(menv, "-3")), msat_make_gt(menv, msat_make_minus(menv, xs[4], xs[1]), msat_make_number(menv, "12"))))
