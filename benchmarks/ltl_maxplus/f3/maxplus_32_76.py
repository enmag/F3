...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (G ((x_12 - x_11 > -1) | (F (x_27 - x_19 >= 10))))
    ltl = enc.make_G(msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[12], xs[11]), msat_make_number(menv, "-1")), enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[27], xs[19]), msat_make_number(menv, "10")))))
