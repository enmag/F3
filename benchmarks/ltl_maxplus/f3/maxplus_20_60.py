...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (G ((x_8 - x_12 >= -8) | (X (x_12 - x_13 > 1))))
    ltl = enc.make_G(msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[8], xs[12]), msat_make_number(menv, "-8")), enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[12], xs[13]), msat_make_number(menv, "1")))))
