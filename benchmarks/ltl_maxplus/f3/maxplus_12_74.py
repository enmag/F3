...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_4 - x_7 >= 16) & (F (G (x_9 - x_8 >= 2))))
    ltl = msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[4], xs[7]), msat_make_number(menv, "16")), enc.make_F(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[9], xs[8]), msat_make_number(menv, "2")))))
