...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr4 = msat_make_plus(menv, xs[4], n_3_0)
    ...
    expr14 = msat_make_plus(menv, xs[23], n_5_0)
    ...
    expr17 = msat_make_plus(menv, xs[29], n_17_0)
    ...
    expr17 = msat_make_plus(menv, xs[29], n_11_0)
    ...
    expr1 = msat_make_plus(menv, xs[9], n_11_0)
    ...
    # ltl property: (X (! ((! (F (x_15 - x_24 > -8))) U (! (x_26 - x_32 >= -18)))))
    ltl = enc.make_X(msat_make_not(menv, enc.make_U(msat_make_not(menv, enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[15], xs[24]), msat_make_number(menv, "-8")))), msat_make_not(menv, msat_make_geq(menv, msat_make_minus(menv, xs[26], xs[32]), msat_make_number(menv, "-18"))))))
