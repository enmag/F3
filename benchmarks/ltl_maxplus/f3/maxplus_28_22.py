...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (G ((G (x_16 - x_25 >= 8)) U (x_8 - x_19 > 3)))
    ltl = enc.make_G(enc.make_U(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[16], xs[25]), msat_make_number(menv, "8"))), msat_make_gt(menv, msat_make_minus(menv, xs[8], xs[19]), msat_make_number(menv, "3"))))
