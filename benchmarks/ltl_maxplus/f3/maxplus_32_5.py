...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F ((x_16 - x_8 >= -17) & (G (x_18 - x_11 > -6))))
    ltl = enc.make_F(msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[16], xs[8]), msat_make_number(menv, "-17")), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[18], xs[11]), msat_make_number(menv, "-6")))))
