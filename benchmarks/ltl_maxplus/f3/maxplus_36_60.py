...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (G ((x_26 - x_7 >= -17) | (X (x_2 - x_12 >= 5))))
    ltl = enc.make_G(msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[26], xs[7]), msat_make_number(menv, "-17")), enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[2], xs[12]), msat_make_number(menv, "5")))))
