...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F ((x_18 - x_7 > 3) | (G (x_18 - x_7 > 3))))
    ltl = enc.make_F(msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[18], xs[7]), msat_make_number(menv, "3")), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[18], xs[7]), msat_make_number(menv, "3")))))
