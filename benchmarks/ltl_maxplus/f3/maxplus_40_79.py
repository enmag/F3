...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr11 = msat_make_plus(menv, xs[17], n_15_0)
    ...
    expr16 = msat_make_plus(menv, xs[25], n_2_0)
    ...
    expr5 = msat_make_plus(menv, xs[5], n_15_0)
    expr6 = msat_make_plus(menv, xs[6], n_7_0)
    expr7 = msat_make_plus(menv, xs[7], n_20_0)
    expr8 = msat_make_plus(menv, xs[9], n_15_0)
    expr9 = msat_make_plus(menv, xs[10], n_13_0)
    expr10 = msat_make_plus(menv, xs[11], n_17_0)
    expr11 = msat_make_plus(menv, xs[15], n_20_0)
    expr12 = msat_make_plus(menv, xs[19], n_8_0)
    expr13 = msat_make_plus(menv, xs[20], n_12_0)
    ...
    expr1 = msat_make_plus(menv, xs[7], n_13_0)
    ...
    expr9 = msat_make_plus(menv, xs[24], n_11_0)
    ...
    expr2 = msat_make_plus(menv, xs[11], n_1_0)
    ...
    # ltl property: (F ((x_19 - x_10 >= 8) & (G (x_4 - x_17 > -1))))
    ltl = enc.make_F(msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[19], xs[10]), msat_make_number(menv, "8")), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[4], xs[17]), msat_make_number(menv, "-1")))))
