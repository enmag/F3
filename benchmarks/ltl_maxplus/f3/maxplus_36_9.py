...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (! ((! (F (X (x_20 - x_0 >= 5)))) U (! (x_3 - x_13 > 14))))
    ltl = msat_make_not(menv, enc.make_U(msat_make_not(menv, enc.make_F(enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[20], xs[0]), msat_make_number(menv, "5"))))), msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[3], xs[13]), msat_make_number(menv, "14")))))
