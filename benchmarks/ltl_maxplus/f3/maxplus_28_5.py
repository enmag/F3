...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (F ((x_12 - x_27 > 14) & (G (x_15 - x_27 > -15))))
    ltl = enc.make_F(msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[12], xs[27]), msat_make_number(menv, "14")), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[15], xs[27]), msat_make_number(menv, "-15")))))
