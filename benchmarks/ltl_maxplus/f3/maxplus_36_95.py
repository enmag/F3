...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (((x_21 - x_20 >= 13) | (x_16 - x_25 >= -15)) U (x_8 - x_20 > 18))
    ltl = enc.make_U(msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[21], xs[20]), msat_make_number(menv, "13")), msat_make_geq(menv, msat_make_minus(menv, xs[16], xs[25]), msat_make_number(menv, "-15"))), msat_make_gt(menv, msat_make_minus(menv, xs[8], xs[20]), msat_make_number(menv, "18")))
