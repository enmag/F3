...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (! ((! (x_7 - x_11 > 11)) U (! (! ((! (x_2 - x_11 > -14)) U (! (x_1 - x_5 > -6)))))))
    ltl = msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[7], xs[11]), msat_make_number(menv, "11"))), msat_make_not(menv, msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[2], xs[11]), msat_make_number(menv, "-14"))), msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[1], xs[5]), msat_make_number(menv, "-6"))))))))
