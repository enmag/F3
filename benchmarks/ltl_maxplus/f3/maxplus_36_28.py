...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr8 = msat_make_plus(menv, xs[24], n_4_0)
    ...
    expr0 = msat_make_plus(menv, xs[6], n_15_0)
    ...
    expr1 = msat_make_plus(menv, xs[13], n_10_0)
    expr2 = msat_make_plus(menv, xs[14], n_13_0)
    expr3 = msat_make_plus(menv, xs[17], n_13_0)
    expr4 = msat_make_plus(menv, xs[18], n_14_0)
    expr5 = msat_make_plus(menv, xs[19], n_20_0)
    ...
    # ltl property: (X ((x_4 - x_35 > 6) & (G (x_7 - x_24 > -3))))
    ltl = enc.make_X(msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[4], xs[35]), msat_make_number(menv, "6")), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[7], xs[24]), msat_make_number(menv, "-3")))))
