...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr12 = msat_make_plus(menv, xs[31], n_6_0)
    ...
    expr17 = msat_make_plus(menv, xs[32], n_10_0)
    expr18 = msat_make_plus(menv, xs[33], n_3_0)
    expr19 = msat_make_plus(menv, xs[35], n_7_0)
    _t = msat_make_and(menv,
    ...
    expr6 = msat_make_plus(menv, xs[20], n_10_0)
    expr7 = msat_make_plus(menv, xs[24], n_20_0)
    expr8 = msat_make_plus(menv, xs[26], n_6_0)
    expr9 = msat_make_plus(menv, xs[27], n_7_0)
    expr10 = msat_make_plus(menv, xs[28], n_10_0)
    expr11 = msat_make_plus(menv, xs[29], n_11_0)
    expr12 = msat_make_plus(menv, xs[31], n_1_0)
    ...
    # ltl property: (F ((F (x_37 - x_20 >= 2)) U (x_17 - x_19 >= -1)))
    ltl = enc.make_F(enc.make_U(enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[37], xs[20]), msat_make_number(menv, "2"))), msat_make_geq(menv, msat_make_minus(menv, xs[17], xs[19]), msat_make_number(menv, "-1"))))
