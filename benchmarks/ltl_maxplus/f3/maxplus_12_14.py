...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (X ((G (x_0 - x_1 >= 10)) U (x_7 - x_0 >= 16)))
    ltl = enc.make_X(enc.make_U(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[0], xs[1]), msat_make_number(menv, "10"))), msat_make_geq(menv, msat_make_minus(menv, xs[7], xs[0]), msat_make_number(menv, "16"))))
