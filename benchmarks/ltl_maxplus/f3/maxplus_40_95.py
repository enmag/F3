...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr7 = msat_make_plus(menv, xs[22], n_3_0)
    expr8 = msat_make_plus(menv, xs[24], n_7_0)
    expr9 = msat_make_plus(menv, xs[27], n_15_0)
    expr10 = msat_make_plus(menv, xs[28], n_18_0)
    expr11 = msat_make_plus(menv, xs[30], n_13_0)
    ...
    expr10 = msat_make_plus(menv, xs[24], n_16_0)
    ...
    expr3 = msat_make_plus(menv, xs[9], n_17_0)
    ...
    expr9 = msat_make_plus(menv, xs[26], n_10_0)
    expr10 = msat_make_plus(menv, xs[28], n_7_0)
    expr11 = msat_make_plus(menv, xs[29], n_3_0)
    expr12 = msat_make_plus(menv, xs[31], n_3_0)
    ...
    expr12 = msat_make_plus(menv, xs[30], n_7_0)
    ...
    expr1 = msat_make_plus(menv, xs[8], n_10_0)
    ...
    expr17 = msat_make_plus(menv, xs[30], n_13_0)
    ...
    expr2 = msat_make_plus(menv, xs[12], n_20_0)
    expr3 = msat_make_plus(menv, xs[13], n_11_0)
    ...
    expr3 = msat_make_plus(menv, xs[11], n_15_0)
    expr4 = msat_make_plus(menv, xs[12], n_4_0)
    ...
    expr4 = msat_make_plus(menv, xs[17], n_4_0)
    ...
    expr18 = msat_make_plus(menv, xs[32], n_1_0)
    ...
    # ltl property: (((x_33 - x_36 > -5) | (x_14 - x_25 > 0)) U (x_32 - x_12 >= -18))
    ltl = enc.make_U(msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[33], xs[36]), msat_make_number(menv, "-5")), msat_make_gt(menv, msat_make_minus(menv, xs[14], xs[25]), msat_make_number(menv, "0"))), msat_make_geq(menv, msat_make_minus(menv, xs[32], xs[12]), msat_make_number(menv, "-18")))
