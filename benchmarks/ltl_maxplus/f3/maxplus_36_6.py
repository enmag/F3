...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (! ((! (x_17 - x_3 >= -18)) U (! (X (G (x_6 - x_18 > 8))))))
    ltl = msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_geq(menv, msat_make_minus(menv, xs[17], xs[3]), msat_make_number(menv, "-18"))), msat_make_not(menv, enc.make_X(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[6], xs[18]), msat_make_number(menv, "8")))))))
