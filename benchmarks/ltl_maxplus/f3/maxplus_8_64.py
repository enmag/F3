...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F (X ((x_3 - x_1 > 7) & (x_5 - x_1 > 11))))
    ltl = enc.make_F(enc.make_X(msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[3], xs[1]), msat_make_number(menv, "7")), msat_make_gt(menv, msat_make_minus(menv, xs[5], xs[1]), msat_make_number(menv, "11")))))
