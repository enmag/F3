...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (F (G ((x_23 - x_15 > -2) & (x_12 - x_14 >= 9))))
    ltl = enc.make_F(enc.make_G(msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[23], xs[15]), msat_make_number(menv, "-2")), msat_make_geq(menv, msat_make_minus(menv, xs[12], xs[14]), msat_make_number(menv, "9")))))
