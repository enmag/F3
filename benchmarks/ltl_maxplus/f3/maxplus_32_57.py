...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr4 = msat_make_plus(menv, xs[16], n_8_0)
    ...
    expr5 = msat_make_plus(menv, xs[19], n_3_0)
    ...
    # ltl property: (F (! ((! (X (x_24 - x_0 >= 8))) U (! (x_28 - x_22 > -5)))))
    ltl = enc.make_F(msat_make_not(menv, enc.make_U(msat_make_not(menv, enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[24], xs[0]), msat_make_number(menv, "8")))), msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[28], xs[22]), msat_make_number(menv, "-5"))))))
