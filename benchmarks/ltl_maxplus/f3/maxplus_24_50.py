...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_23 - x_3 >= -10) | ((x_8 - x_23 >= 20) & (x_19 - x_16 > -12)))
    ltl = msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[23], xs[3]), msat_make_number(menv, "-10")), msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[8], xs[23]), msat_make_number(menv, "20")), msat_make_gt(menv, msat_make_minus(menv, xs[19], xs[16]), msat_make_number(menv, "-12"))))
