...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((X (x_12 - x_21 > -13)) | (G (x_3 - x_16 >= 11)))
    ltl = msat_make_or(menv, enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[12], xs[21]), msat_make_number(menv, "-13"))), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[3], xs[16]), msat_make_number(menv, "11"))))
