...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_9 - x_11 > 11) | ((x_2 - x_17 >= -9) & (x_13 - x_16 >= 8)))
    ltl = msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[9], xs[11]), msat_make_number(menv, "11")), msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[2], xs[17]), msat_make_number(menv, "-9")), msat_make_geq(menv, msat_make_minus(menv, xs[13], xs[16]), msat_make_number(menv, "8"))))
