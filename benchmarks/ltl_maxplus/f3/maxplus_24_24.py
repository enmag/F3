...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_3 - x_11 >= -17) | ((x_16 - x_14 > 8) & (x_12 - x_23 > 11)))
    ltl = msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[3], xs[11]), msat_make_number(menv, "-17")), msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[16], xs[14]), msat_make_number(menv, "8")), msat_make_gt(menv, msat_make_minus(menv, xs[12], xs[23]), msat_make_number(menv, "11"))))
