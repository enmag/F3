...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((X (x_1 - x_10 >= 11)) | (G (x_8 - x_5 >= 8)))
    ltl = msat_make_or(menv, enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[1], xs[10]), msat_make_number(menv, "11"))), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[8], xs[5]), msat_make_number(menv, "8"))))
