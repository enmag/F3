...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (X ((x_6 - x_20 >= -20) | (X (x_22 - x_3 >= 12))))
    ltl = enc.make_X(msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[6], xs[20]), msat_make_number(menv, "-20")), enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[22], xs[3]), msat_make_number(menv, "12")))))
