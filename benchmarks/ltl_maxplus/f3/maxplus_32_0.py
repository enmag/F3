...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr0 = msat_make_plus(menv, xs[6], n_3_0)
    ...
    # ltl property: (X ((F (x_31 - x_14 > 16)) U (x_26 - x_4 >= -9)))
    ltl = enc.make_X(enc.make_U(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[31], xs[14]), msat_make_number(menv, "16"))), msat_make_geq(menv, msat_make_minus(menv, xs[26], xs[4]), msat_make_number(menv, "-9"))))
