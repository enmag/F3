...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (G ((x_6 - x_0 >= 5) | (X (x_2 - x_10 > 16))))
    ltl = enc.make_G(msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[6], xs[0]), msat_make_number(menv, "5")), enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[2], xs[10]), msat_make_number(menv, "16")))))
