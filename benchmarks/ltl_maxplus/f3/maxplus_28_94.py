...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_2 - x_16 > -18) U ((x_21 - x_24 >= -15) | (x_19 - x_15 >= -13)))
    ltl = enc.make_U(msat_make_gt(menv, msat_make_minus(menv, xs[2], xs[16]), msat_make_number(menv, "-18")), msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[21], xs[24]), msat_make_number(menv, "-15")), msat_make_geq(menv, msat_make_minus(menv, xs[19], xs[15]), msat_make_number(menv, "-13"))))
