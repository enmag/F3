...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_1 - x_19 > -1) & (F (G (x_8 - x_25 > -8))))
    ltl = msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[1], xs[19]), msat_make_number(menv, "-1")), enc.make_F(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[8], xs[25]), msat_make_number(menv, "-8")))))
