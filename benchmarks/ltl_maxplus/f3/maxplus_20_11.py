...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (F ((x_16 - x_1 > -18) U (G (x_10 - x_19 > -17))))
    ltl = enc.make_F(enc.make_U(msat_make_gt(menv, msat_make_minus(menv, xs[16], xs[1]), msat_make_number(menv, "-18")), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[10], xs[19]), msat_make_number(menv, "-17")))))
