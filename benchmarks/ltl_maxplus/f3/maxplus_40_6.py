...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr11 = msat_make_plus(menv, xs[16], n_5_0)
    expr12 = msat_make_plus(menv, xs[17], n_13_0)
    expr13 = msat_make_plus(menv, xs[21], n_11_0)
    expr14 = msat_make_plus(menv, xs[22], n_6_0)
    expr15 = msat_make_plus(menv, xs[23], n_12_0)
    expr16 = msat_make_plus(menv, xs[24], n_10_0)
    expr17 = msat_make_plus(menv, xs[26], n_20_0)
    expr18 = msat_make_plus(menv, xs[29], n_15_0)
    expr19 = msat_make_plus(menv, xs[32], n_12_0)
    _t = msat_make_and(menv,
    ...
    expr16 = msat_make_plus(menv, xs[29], n_2_0)
    ...
    expr10 = msat_make_plus(menv, xs[25], n_19_0)
    ...
    expr9 = msat_make_plus(menv, xs[13], n_20_0)
    expr10 = msat_make_plus(menv, xs[15], n_6_0)
    ...
    expr0 = msat_make_plus(menv, xs[5], n_7_0)
    expr1 = msat_make_plus(menv, xs[8], n_7_0)
    ...
    expr0 = msat_make_plus(menv, xs[6], n_4_0)
    expr1 = msat_make_plus(menv, xs[11], n_14_0)
    expr2 = msat_make_plus(menv, xs[12], n_3_0)
    expr3 = msat_make_plus(menv, xs[16], n_19_0)
    expr4 = msat_make_plus(menv, xs[19], n_14_0)
    expr5 = msat_make_plus(menv, xs[20], n_15_0)
    expr6 = msat_make_plus(menv, xs[21], n_12_0)
    expr7 = msat_make_plus(menv, xs[22], n_2_0)
    expr8 = msat_make_plus(menv, xs[23], n_15_0)
    ...
    expr11 = msat_make_plus(menv, xs[17], n_8_0)
    ...
    # ltl property: (! ((! (x_38 - x_0 > 4)) U (! (X (G (x_22 - x_31 > -7))))))
    ltl = msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[38], xs[0]), msat_make_number(menv, "4"))), msat_make_not(menv, enc.make_X(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[22], xs[31]), msat_make_number(menv, "-7")))))))
