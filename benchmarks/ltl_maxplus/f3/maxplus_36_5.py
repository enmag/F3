...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (F ((x_0 - x_13 >= -20) & (G (x_20 - x_18 > -1))))
    ltl = enc.make_F(msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[0], xs[13]), msat_make_number(menv, "-20")), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[20], xs[18]), msat_make_number(menv, "-1")))))
