...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((G (x_8 - x_1 > 2)) & (F (x_9 - x_2 >= 3)))
    ltl = msat_make_and(menv, enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[8], xs[1]), msat_make_number(menv, "2"))), enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[9], xs[2]), msat_make_number(menv, "3"))))
