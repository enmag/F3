...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr0 = msat_make_plus(menv, xs[5], n_3_0)
    expr1 = msat_make_plus(menv, xs[8], n_13_0)
    expr2 = msat_make_plus(menv, xs[10], n_5_0)
    ...
    expr13 = msat_make_plus(menv, xs[19], n_11_0)
    ...
    expr7 = msat_make_plus(menv, xs[21], n_6_0)
    ...
    expr0 = msat_make_plus(menv, xs[4], n_6_0)
    ...
    expr14 = msat_make_plus(menv, xs[34], n_14_0)
    ...
    expr4 = msat_make_plus(menv, xs[17], n_17_0)
    expr5 = msat_make_plus(menv, xs[18], n_6_0)
    ...
    expr15 = msat_make_plus(menv, xs[35], n_4_0)
    ...
    expr19 = msat_make_plus(menv, xs[34], n_8_0)
    _t = msat_make_and(menv,
    ...
    # ltl property: (F ((x_14 - x_24 >= 0) | (G (x_29 - x_34 > 19))))
    ltl = enc.make_F(msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[14], xs[24]), msat_make_number(menv, "0")), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[29], xs[34]), msat_make_number(menv, "19")))))
