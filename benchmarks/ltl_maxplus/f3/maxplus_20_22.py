...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (G ((G (x_2 - x_5 > 20)) U (x_4 - x_15 > -7)))
    ltl = enc.make_G(enc.make_U(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[2], xs[5]), msat_make_number(menv, "20"))), msat_make_gt(menv, msat_make_minus(menv, xs[4], xs[15]), msat_make_number(menv, "-7"))))
