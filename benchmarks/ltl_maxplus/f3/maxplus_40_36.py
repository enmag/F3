...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr5 = msat_make_plus(menv, xs[18], n_9_0)
    expr6 = msat_make_plus(menv, xs[20], n_14_0)
    expr7 = msat_make_plus(menv, xs[22], n_12_0)
    expr8 = msat_make_plus(menv, xs[26], n_9_0)
    expr9 = msat_make_plus(menv, xs[27], n_20_0)
    expr10 = msat_make_plus(menv, xs[28], n_11_0)
    ...
    # ltl property: ((F (x_30 - x_15 > 1)) U (G (x_36 - x_2 >= 12)))
    ltl = enc.make_U(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[30], xs[15]), msat_make_number(menv, "1"))), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[36], xs[2]), msat_make_number(menv, "12"))))
