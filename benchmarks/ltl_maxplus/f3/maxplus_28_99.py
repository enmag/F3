...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (X ((x_1 - x_9 >= 7) | (G (x_23 - x_21 > -15))))
    ltl = enc.make_X(msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[1], xs[9]), msat_make_number(menv, "7")), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[23], xs[21]), msat_make_number(menv, "-15")))))
