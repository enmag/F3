...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (((x_14 - x_12 > 12) | (x_12 - x_9 > -3)) U (x_1 - x_5 >= -19))
    ltl = enc.make_U(msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[14], xs[12]), msat_make_number(menv, "12")), msat_make_gt(menv, msat_make_minus(menv, xs[12], xs[9]), msat_make_number(menv, "-3"))), msat_make_geq(menv, msat_make_minus(menv, xs[1], xs[5]), msat_make_number(menv, "-19")))
