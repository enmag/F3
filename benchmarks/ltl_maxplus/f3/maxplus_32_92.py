...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F (! ((! (x_23 - x_14 > -12)) U (! (G (x_0 - x_16 >= -19))))))
    ltl = enc.make_F(msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[23], xs[14]), msat_make_number(menv, "-12"))), msat_make_not(menv, enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[0], xs[16]), msat_make_number(menv, "-19")))))))
