...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_5 - x_10 > 7) | (X (F (x_6 - x_7 > 8))))
    ltl = msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[5], xs[10]), msat_make_number(menv, "7")), enc.make_X(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[6], xs[7]), msat_make_number(menv, "8")))))
