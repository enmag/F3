...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (X (! ((! (x_17 - x_21 > 7)) U (! (G (x_18 - x_12 > 2))))))
    ltl = enc.make_X(msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[17], xs[21]), msat_make_number(menv, "7"))), msat_make_not(menv, enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[18], xs[12]), msat_make_number(menv, "2")))))))
