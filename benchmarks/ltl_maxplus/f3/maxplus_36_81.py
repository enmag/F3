...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr5 = msat_make_plus(menv, xs[19], n_9_0)
    expr6 = msat_make_plus(menv, xs[20], n_2_0)
    ...
    # ltl property: (! ((! (! ((! (x_10 - x_12 > -5)) U (! (x_17 - x_6 > 12))))) U (! (x_10 - x_12 > -5))))
    ltl = msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[10], xs[12]), msat_make_number(menv, "-5"))), msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[17], xs[6]), msat_make_number(menv, "12")))))), msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[10], xs[12]), msat_make_number(menv, "-5")))))
