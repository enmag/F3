...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (! ((! (X (F (x_14 - x_1 > 15)))) U (! (x_12 - x_1 > -17))))
    ltl = msat_make_not(menv, enc.make_U(msat_make_not(menv, enc.make_X(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[14], xs[1]), msat_make_number(menv, "15"))))), msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[12], xs[1]), msat_make_number(menv, "-17")))))
