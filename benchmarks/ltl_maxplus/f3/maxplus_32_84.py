...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_0 - x_16 > -4) | (! ((! (x_31 - x_24 > 11)) U (! (x_26 - x_25 > 14)))))
    ltl = msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[0], xs[16]), msat_make_number(menv, "-4")), msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[31], xs[24]), msat_make_number(menv, "11"))), msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[26], xs[25]), msat_make_number(menv, "14"))))))
