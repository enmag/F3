...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (G ((x_24 - x_9 > 1) | (F (x_6 - x_8 >= -18))))
    ltl = enc.make_G(msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[24], xs[9]), msat_make_number(menv, "1")), enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[6], xs[8]), msat_make_number(menv, "-18")))))
