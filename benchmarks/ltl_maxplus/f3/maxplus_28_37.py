...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_14 - x_19 > -18) | ((x_24 - x_10 > 13) & (x_14 - x_7 >= -10)))
    ltl = msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[14], xs[19]), msat_make_number(menv, "-18")), msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[24], xs[10]), msat_make_number(menv, "13")), msat_make_geq(menv, msat_make_minus(menv, xs[14], xs[7]), msat_make_number(menv, "-10"))))
