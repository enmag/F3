...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F ((F (x_10 - x_8 >= -4)) U (x_7 - x_4 >= -2)))
    ltl = enc.make_F(enc.make_U(enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[10], xs[8]), msat_make_number(menv, "-4"))), msat_make_geq(menv, msat_make_minus(menv, xs[7], xs[4]), msat_make_number(menv, "-2"))))
