...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr9 = msat_make_plus(menv, xs[26], n_9_0)
    ...
    # ltl property: (X ((x_12 - x_19 > 2) U (G (x_6 - x_11 >= 0))))
    ltl = enc.make_X(enc.make_U(msat_make_gt(menv, msat_make_minus(menv, xs[12], xs[19]), msat_make_number(menv, "2")), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[6], xs[11]), msat_make_number(menv, "0")))))
