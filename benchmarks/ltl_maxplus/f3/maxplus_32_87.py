...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F ((x_20 - x_25 >= 18) | (G (x_20 - x_25 >= 18))))
    ltl = enc.make_F(msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[20], xs[25]), msat_make_number(menv, "18")), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[20], xs[25]), msat_make_number(menv, "18")))))
