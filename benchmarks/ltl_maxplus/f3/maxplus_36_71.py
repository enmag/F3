...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr4 = msat_make_plus(menv, xs[16], n_19_0)
    ...
    # ltl property: ((x_14 - x_21 > 15) & (G (F (x_16 - x_14 >= -7))))
    ltl = msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[14], xs[21]), msat_make_number(menv, "15")), enc.make_G(enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[16], xs[14]), msat_make_number(menv, "-7")))))
