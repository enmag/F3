...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr0 = msat_make_plus(menv, xs[7], n_16_0)
    ...
    # ltl property: (G ((x_22 - x_2 > -1) | (X (x_9 - x_11 > -8))))
    ltl = enc.make_G(msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[22], xs[2]), msat_make_number(menv, "-1")), enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[9], xs[11]), msat_make_number(menv, "-8")))))
