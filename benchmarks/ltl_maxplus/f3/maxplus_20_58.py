...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (G ((G (x_8 - x_14 > 12)) U (x_4 - x_11 > -5)))
    ltl = enc.make_G(enc.make_U(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[8], xs[14]), msat_make_number(menv, "12"))), msat_make_gt(menv, msat_make_minus(menv, xs[4], xs[11]), msat_make_number(menv, "-5"))))
