...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr3 = msat_make_plus(menv, xs[13], n_8_0)
    expr4 = msat_make_plus(menv, xs[16], n_2_0)
    ...
    expr16 = msat_make_plus(menv, xs[26], n_10_0)
    ...
    expr15 = msat_make_plus(menv, xs[35], n_19_0)
    ...
    expr12 = msat_make_plus(menv, xs[31], n_20_0)
    ...
    # ltl property: (! ((! (F (X (x_39 - x_13 >= -18)))) U (! (x_17 - x_19 > -2))))
    ltl = msat_make_not(menv, enc.make_U(msat_make_not(menv, enc.make_F(enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[39], xs[13]), msat_make_number(menv, "-18"))))), msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[17], xs[19]), msat_make_number(menv, "-2")))))
