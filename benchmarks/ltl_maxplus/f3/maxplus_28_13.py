...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (F ((X (x_21 - x_26 >= 1)) U (x_9 - x_24 >= 5)))
    ltl = enc.make_F(enc.make_U(enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[21], xs[26]), msat_make_number(menv, "1"))), msat_make_geq(menv, msat_make_minus(menv, xs[9], xs[24]), msat_make_number(menv, "5"))))
