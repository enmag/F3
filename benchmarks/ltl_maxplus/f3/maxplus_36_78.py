...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (X (! ((! (F (x_14 - x_3 > -13))) U (! (x_23 - x_5 > -8)))))
    ltl = enc.make_X(msat_make_not(menv, enc.make_U(msat_make_not(menv, enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[14], xs[3]), msat_make_number(menv, "-13")))), msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[23], xs[5]), msat_make_number(menv, "-8"))))))
