...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((G (x_30 - x_19 > 12)) | (F (x_17 - x_27 >= -8)))
    ltl = msat_make_or(menv, enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[30], xs[19]), msat_make_number(menv, "12"))), enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[17], xs[27]), msat_make_number(menv, "-8"))))
