...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_1 - x_8 > 0) | (X (F (x_1 - x_0 > 20))))
    ltl = msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[1], xs[8]), msat_make_number(menv, "0")), enc.make_X(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[1], xs[0]), msat_make_number(menv, "20")))))
