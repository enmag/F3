...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_27 - x_5 > -1) & (X (F (x_18 - x_13 > -5))))
    ltl = msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[27], xs[5]), msat_make_number(menv, "-1")), enc.make_X(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[18], xs[13]), msat_make_number(menv, "-5")))))
