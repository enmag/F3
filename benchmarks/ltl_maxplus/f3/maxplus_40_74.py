...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr7 = msat_make_plus(menv, xs[23], n_17_0)
    expr8 = msat_make_plus(menv, xs[24], n_15_0)
    ...
    expr16 = msat_make_plus(menv, xs[27], n_17_0)
    ...
    expr15 = msat_make_plus(menv, xs[23], n_18_0)
    ...
    expr16 = msat_make_plus(menv, xs[25], n_1_0)
    ...
    expr1 = msat_make_plus(menv, xs[8], n_16_0)
    ...
    # ltl property: ((x_26 - x_27 > -15) & (F (G (x_37 - x_18 >= 4))))
    ltl = msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[26], xs[27]), msat_make_number(menv, "-15")), enc.make_F(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[37], xs[18]), msat_make_number(menv, "4")))))
