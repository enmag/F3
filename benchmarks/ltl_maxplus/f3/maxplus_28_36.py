...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((F (x_7 - x_6 >= -5)) U (G (x_1 - x_19 >= 16)))
    ltl = enc.make_U(enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[7], xs[6]), msat_make_number(menv, "-5"))), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[1], xs[19]), msat_make_number(menv, "16"))))
