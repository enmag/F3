...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (X ((G (x_7 - x_8 >= -10)) U (x_1 - x_12 > -8)))
    ltl = enc.make_X(enc.make_U(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[7], xs[8]), msat_make_number(menv, "-10"))), msat_make_gt(menv, msat_make_minus(menv, xs[1], xs[12]), msat_make_number(menv, "-8"))))
