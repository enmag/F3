...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((F (x_5 - x_9 >= 15)) & (X (x_9 - x_24 > 3)))
    ltl = msat_make_and(menv, enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[5], xs[9]), msat_make_number(menv, "15"))), enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[9], xs[24]), msat_make_number(menv, "3"))))
