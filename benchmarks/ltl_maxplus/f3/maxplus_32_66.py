...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr11 = msat_make_plus(menv, xs[15], n_9_0)
    expr12 = msat_make_plus(menv, xs[19], n_2_0)
    ...
    # ltl property: ((x_4 - x_12 > 5) | ((x_7 - x_23 >= -19) & (x_22 - x_1 > -6)))
    ltl = msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[4], xs[12]), msat_make_number(menv, "5")), msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[7], xs[23]), msat_make_number(menv, "-19")), msat_make_gt(menv, msat_make_minus(menv, xs[22], xs[1]), msat_make_number(menv, "-6"))))
