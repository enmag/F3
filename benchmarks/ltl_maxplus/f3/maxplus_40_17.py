...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr17 = msat_make_plus(menv, xs[28], n_9_0)
    expr18 = msat_make_plus(menv, xs[31], n_17_0)
    expr19 = msat_make_plus(menv, xs[32], n_19_0)
    _t = msat_make_and(menv,
    ...
    expr2 = msat_make_plus(menv, xs[13], n_1_0)
    expr3 = msat_make_plus(menv, xs[15], n_4_0)
    expr4 = msat_make_plus(menv, xs[17], n_13_0)
    ...
    expr8 = msat_make_plus(menv, xs[23], n_7_0)
    expr9 = msat_make_plus(menv, xs[24], n_16_0)
    ...
    expr15 = msat_make_plus(menv, xs[24], n_10_0)
    ...
    # ltl property: (F (X (X (G (x_3 - x_28 >= 10)))))
    ltl = enc.make_F(enc.make_X(enc.make_X(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[3], xs[28]), msat_make_number(menv, "10"))))))
