...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F (G ((x_31 - x_0 >= 7) & (x_12 - x_16 >= -17))))
    ltl = enc.make_F(enc.make_G(msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[31], xs[0]), msat_make_number(menv, "7")), msat_make_geq(menv, msat_make_minus(menv, xs[12], xs[16]), msat_make_number(menv, "-17")))))
