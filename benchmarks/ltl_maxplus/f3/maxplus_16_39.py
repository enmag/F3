...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (F (G ((x_7 - x_2 > 6) & (x_9 - x_10 > 4))))
    ltl = enc.make_F(enc.make_G(msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[7], xs[2]), msat_make_number(menv, "6")), msat_make_gt(menv, msat_make_minus(menv, xs[9], xs[10]), msat_make_number(menv, "4")))))
