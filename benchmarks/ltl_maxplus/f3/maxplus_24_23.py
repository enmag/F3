...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((G (x_12 - x_18 > 3)) U (G (x_5 - x_21 > -2)))
    ltl = enc.make_U(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[12], xs[18]), msat_make_number(menv, "3"))), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[5], xs[21]), msat_make_number(menv, "-2"))))
