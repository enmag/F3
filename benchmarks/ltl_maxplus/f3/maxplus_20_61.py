...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((X (X (x_19 - x_4 > -18))) U (x_15 - x_6 >= 13))
    ltl = enc.make_U(enc.make_X(enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[19], xs[4]), msat_make_number(menv, "-18")))), msat_make_geq(menv, msat_make_minus(menv, xs[15], xs[6]), msat_make_number(menv, "13")))
