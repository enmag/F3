...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F ((X (x_8 - x_11 >= 5)) U (x_8 - x_6 >= 14)))
    ltl = enc.make_F(enc.make_U(enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[8], xs[11]), msat_make_number(menv, "5"))), msat_make_geq(menv, msat_make_minus(menv, xs[8], xs[6]), msat_make_number(menv, "14"))))
