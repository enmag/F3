...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (F ((F (x_9 - x_1 >= 11)) U (x_26 - x_22 >= 15)))
    ltl = enc.make_F(enc.make_U(enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[9], xs[1]), msat_make_number(menv, "11"))), msat_make_geq(menv, msat_make_minus(menv, xs[26], xs[22]), msat_make_number(menv, "15"))))
