...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr0 = msat_make_plus(menv, xs[9], n_9_0)
    expr1 = msat_make_plus(menv, xs[10], n_20_0)
    ...
    # ltl property: (G ((G (x_15 - x_24 > -11)) U (x_24 - x_3 >= -9)))
    ltl = enc.make_G(enc.make_U(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[15], xs[24]), msat_make_number(menv, "-11"))), msat_make_geq(menv, msat_make_minus(menv, xs[24], xs[3]), msat_make_number(menv, "-9"))))
