...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((X (X (x_2 - x_0 > -16))) U (x_1 - x_0 > 15))
    ltl = enc.make_U(enc.make_X(enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[2], xs[0]), msat_make_number(menv, "-16")))), msat_make_gt(menv, msat_make_minus(menv, xs[1], xs[0]), msat_make_number(menv, "15")))
