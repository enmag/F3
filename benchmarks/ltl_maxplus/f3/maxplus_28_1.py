...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_21 - x_27 >= 2) | (X (G (x_22 - x_5 > 0))))
    ltl = msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[21], xs[27]), msat_make_number(menv, "2")), enc.make_X(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[22], xs[5]), msat_make_number(menv, "0")))))
