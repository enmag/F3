...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F (G ((x_1 - x_4 >= 13) & (x_1 - x_2 >= -8))))
    ltl = enc.make_F(enc.make_G(msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[1], xs[4]), msat_make_number(menv, "13")), msat_make_geq(menv, msat_make_minus(menv, xs[1], xs[2]), msat_make_number(menv, "-8")))))
