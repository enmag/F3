...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (F ((F (x_7 - x_8 >= -18)) U (x_11 - x_12 >= 3)))
    ltl = enc.make_F(enc.make_U(enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[7], xs[8]), msat_make_number(menv, "-18"))), msat_make_geq(menv, msat_make_minus(menv, xs[11], xs[12]), msat_make_number(menv, "3"))))
