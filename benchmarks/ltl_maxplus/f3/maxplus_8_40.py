...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((X (x_6 - x_5 > -17)) | (X (x_3 - x_5 >= 14)))
    ltl = msat_make_or(menv, enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[6], xs[5]), msat_make_number(menv, "-17"))), enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[3], xs[5]), msat_make_number(menv, "14"))))
