...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_2 - x_3 > -7) | ((x_0 - x_3 > 9) & (x_0 - x_1 > -5)))
    ltl = msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[2], xs[3]), msat_make_number(menv, "-7")), msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[0], xs[3]), msat_make_number(menv, "9")), msat_make_gt(menv, msat_make_minus(menv, xs[0], xs[1]), msat_make_number(menv, "-5"))))
