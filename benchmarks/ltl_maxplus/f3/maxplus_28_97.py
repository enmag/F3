...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (G ((X (x_2 - x_18 > -2)) U (x_16 - x_26 > -16)))
    ltl = enc.make_G(enc.make_U(enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[2], xs[18]), msat_make_number(menv, "-2"))), msat_make_gt(menv, msat_make_minus(menv, xs[16], xs[26]), msat_make_number(menv, "-16"))))
