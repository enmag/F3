...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr17 = msat_make_plus(menv, xs[29], n_19_0)
    ...
    expr12 = msat_make_plus(menv, xs[31], n_5_0)
    ...
    expr6 = msat_make_plus(menv, xs[6], n_3_0)
    ...
    expr3 = msat_make_plus(menv, xs[12], n_4_0)
    expr4 = msat_make_plus(menv, xs[14], n_19_0)
    expr5 = msat_make_plus(menv, xs[18], n_4_0)
    expr6 = msat_make_plus(menv, xs[20], n_1_0)
    ...
    expr14 = msat_make_plus(menv, xs[24], n_9_0)
    ...
    expr5 = msat_make_plus(menv, xs[17], n_2_0)
    ...
    expr13 = msat_make_plus(menv, xs[20], n_5_0)
    expr14 = msat_make_plus(menv, xs[22], n_18_0)
    expr15 = msat_make_plus(menv, xs[23], n_11_0)
    expr16 = msat_make_plus(menv, xs[24], n_9_0)
    expr17 = msat_make_plus(menv, xs[25], n_3_0)
    ...
    # ltl property: (! ((! ((x_30 - x_23 > 5) & (x_6 - x_30 >= 12))) U (! (x_10 - x_4 >= -15))))
    ltl = msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[30], xs[23]), msat_make_number(menv, "5")), msat_make_geq(menv, msat_make_minus(menv, xs[6], xs[30]), msat_make_number(menv, "12")))), msat_make_not(menv, msat_make_geq(menv, msat_make_minus(menv, xs[10], xs[4]), msat_make_number(menv, "-15")))))
