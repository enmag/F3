...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((X (X (x_22 - x_20 >= -4))) U (x_26 - x_13 > 17))
    ltl = enc.make_U(enc.make_X(enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[22], xs[20]), msat_make_number(menv, "-4")))), msat_make_gt(menv, msat_make_minus(menv, xs[26], xs[13]), msat_make_number(menv, "17")))
