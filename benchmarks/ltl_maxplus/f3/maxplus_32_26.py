...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr7 = msat_make_plus(menv, xs[7], n_14_0)
    expr8 = msat_make_plus(menv, xs[8], n_17_0)
    expr9 = msat_make_plus(menv, xs[9], n_16_0)
    expr10 = msat_make_plus(menv, xs[12], n_6_0)
    expr11 = msat_make_plus(menv, xs[14], n_18_0)
    ...
    expr9 = msat_make_plus(menv, xs[11], n_18_0)
    ...
    # ltl property: ((x_0 - x_2 >= -6) | ((x_18 - x_31 > 15) & (x_11 - x_20 >= -19)))
    ltl = msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[0], xs[2]), msat_make_number(menv, "-6")), msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[18], xs[31]), msat_make_number(menv, "15")), msat_make_geq(menv, msat_make_minus(menv, xs[11], xs[20]), msat_make_number(menv, "-19"))))
