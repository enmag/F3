...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr3 = msat_make_plus(menv, xs[14], n_16_0)
    expr4 = msat_make_plus(menv, xs[16], n_3_0)
    expr5 = msat_make_plus(menv, xs[17], n_16_0)
    expr6 = msat_make_plus(menv, xs[21], n_14_0)
    expr7 = msat_make_plus(menv, xs[23], n_18_0)
    expr8 = msat_make_plus(menv, xs[25], n_17_0)
    ...
    # ltl property: ((G (x_34 - x_28 >= 4)) & (F (x_5 - x_21 >= 10)))
    ltl = msat_make_and(menv, enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[34], xs[28]), msat_make_number(menv, "4"))), enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[5], xs[21]), msat_make_number(menv, "10"))))
