...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F (! ((! (x_7 - x_13 >= 0)) U (! (G (x_5 - x_16 > 7))))))
    ltl = enc.make_F(msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_geq(menv, msat_make_minus(menv, xs[7], xs[13]), msat_make_number(menv, "0"))), msat_make_not(menv, enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[5], xs[16]), msat_make_number(menv, "7")))))))
