...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_1 - x_6 > -15) & (F (G (x_0 - x_5 >= 0))))
    ltl = msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[1], xs[6]), msat_make_number(menv, "-15")), enc.make_F(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[0], xs[5]), msat_make_number(menv, "0")))))
