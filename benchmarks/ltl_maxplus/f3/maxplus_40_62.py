...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr17 = msat_make_plus(menv, xs[28], n_19_0)
    ...
    expr12 = msat_make_plus(menv, xs[18], n_2_0)
    ...
    expr18 = msat_make_plus(menv, xs[31], n_11_0)
    ...
    expr13 = msat_make_plus(menv, xs[32], n_9_0)
    ...
    # ltl property: ((X (X (x_24 - x_13 > 20))) U (x_24 - x_15 > 9))
    ltl = enc.make_U(enc.make_X(enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[24], xs[13]), msat_make_number(menv, "20")))), msat_make_gt(menv, msat_make_minus(menv, xs[24], xs[15]), msat_make_number(menv, "9")))
