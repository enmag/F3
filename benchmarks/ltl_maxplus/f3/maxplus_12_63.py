...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_5 - x_7 > -10) | (! ((! (x_3 - x_0 > -11)) U (! (x_8 - x_1 > 20)))))
    ltl = msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[5], xs[7]), msat_make_number(menv, "-10")), msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[3], xs[0]), msat_make_number(menv, "-11"))), msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[8], xs[1]), msat_make_number(menv, "20"))))))
