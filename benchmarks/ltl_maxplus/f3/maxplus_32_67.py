...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr13 = msat_make_plus(menv, xs[19], n_8_0)
    ...
    # ltl property: (X ((x_9 - x_29 >= 8) & (X (x_16 - x_3 > -4))))
    ltl = enc.make_X(msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[9], xs[29]), msat_make_number(menv, "8")), enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[16], xs[3]), msat_make_number(menv, "-4")))))
