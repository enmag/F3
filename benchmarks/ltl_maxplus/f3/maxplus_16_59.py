...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_2 - x_4 > -8) | (X (F (x_8 - x_1 > 16))))
    ltl = msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[2], xs[4]), msat_make_number(menv, "-8")), enc.make_X(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[8], xs[1]), msat_make_number(menv, "16")))))
