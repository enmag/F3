...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (X ((G (x_16 - x_3 >= -8)) U (x_19 - x_12 >= -17)))
    ltl = enc.make_X(enc.make_U(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[16], xs[3]), msat_make_number(menv, "-8"))), msat_make_geq(menv, msat_make_minus(menv, xs[19], xs[12]), msat_make_number(menv, "-17"))))
