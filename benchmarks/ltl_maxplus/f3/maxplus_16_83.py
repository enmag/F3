...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_8 - x_2 >= -6) & ((x_2 - x_6 >= 0) U (x_9 - x_2 > -6)))
    ltl = msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[8], xs[2]), msat_make_number(menv, "-6")), enc.make_U(msat_make_geq(menv, msat_make_minus(menv, xs[2], xs[6]), msat_make_number(menv, "0")), msat_make_gt(menv, msat_make_minus(menv, xs[9], xs[2]), msat_make_number(menv, "-6"))))
