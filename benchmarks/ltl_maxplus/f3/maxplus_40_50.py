...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr13 = msat_make_plus(menv, xs[20], n_4_0)
    ...
    expr12 = msat_make_plus(menv, xs[16], n_4_0)
    expr13 = msat_make_plus(menv, xs[17], n_4_0)
    ...
    expr2 = msat_make_plus(menv, xs[11], n_19_0)
    ...
    expr17 = msat_make_plus(menv, xs[27], n_5_0)
    ...
    # ltl property: ((x_0 - x_22 >= 9) | ((x_7 - x_15 >= 8) & (x_31 - x_22 >= 3)))
    ltl = msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[0], xs[22]), msat_make_number(menv, "9")), msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[7], xs[15]), msat_make_number(menv, "8")), msat_make_geq(menv, msat_make_minus(menv, xs[31], xs[22]), msat_make_number(menv, "3"))))
