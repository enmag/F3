...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (X ((x_23 - x_15 >= 6) U (G (x_6 - x_3 > -4))))
    ltl = enc.make_X(enc.make_U(msat_make_geq(menv, msat_make_minus(menv, xs[23], xs[15]), msat_make_number(menv, "6")), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[6], xs[3]), msat_make_number(menv, "-4")))))
