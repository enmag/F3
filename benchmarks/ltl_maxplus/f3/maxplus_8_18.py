...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (X ((x_2 - x_1 > -6) | (X (x_6 - x_1 >= -4))))
    ltl = enc.make_X(msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[2], xs[1]), msat_make_number(menv, "-6")), enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[6], xs[1]), msat_make_number(menv, "-4")))))
