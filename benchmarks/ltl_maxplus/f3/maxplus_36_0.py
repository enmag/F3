...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr3 = msat_make_plus(menv, xs[14], n_20_0)
    ...
    expr0 = msat_make_plus(menv, xs[5], n_9_0)
    ...
    expr2 = msat_make_plus(menv, xs[12], n_12_0)
    ...
    expr6 = msat_make_plus(menv, xs[6], n_10_0)
    ...
    expr11 = msat_make_plus(menv, xs[14], n_5_0)
    ...
    # ltl property: (X ((F (x_26 - x_7 >= -11)) U (x_30 - x_18 >= -3)))
    ltl = enc.make_X(enc.make_U(enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[26], xs[7]), msat_make_number(menv, "-11"))), msat_make_geq(menv, msat_make_minus(menv, xs[30], xs[18]), msat_make_number(menv, "-3"))))
