...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (G ((X (x_17 - x_18 > 9)) U (x_26 - x_7 >= -11)))
    ltl = enc.make_G(enc.make_U(enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[17], xs[18]), msat_make_number(menv, "9"))), msat_make_geq(menv, msat_make_minus(menv, xs[26], xs[7]), msat_make_number(menv, "-11"))))
