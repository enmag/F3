...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F ((x_1 - x_18 >= 15) | (G (x_1 - x_18 >= 15))))
    ltl = enc.make_F(msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[1], xs[18]), msat_make_number(menv, "15")), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[1], xs[18]), msat_make_number(menv, "15")))))
