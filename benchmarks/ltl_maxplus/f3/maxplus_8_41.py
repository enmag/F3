...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_0 - x_1 >= -4) U ((x_1 - x_0 > 16) U (x_4 - x_0 >= 17)))
    ltl = enc.make_U(msat_make_geq(menv, msat_make_minus(menv, xs[0], xs[1]), msat_make_number(menv, "-4")), enc.make_U(msat_make_gt(menv, msat_make_minus(menv, xs[1], xs[0]), msat_make_number(menv, "16")), msat_make_geq(menv, msat_make_minus(menv, xs[4], xs[0]), msat_make_number(menv, "17"))))
