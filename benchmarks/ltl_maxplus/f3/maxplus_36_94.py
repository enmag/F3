...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_27 - x_7 > -6) U ((x_19 - x_20 >= -19) | (x_24 - x_11 >= 19)))
    ltl = enc.make_U(msat_make_gt(menv, msat_make_minus(menv, xs[27], xs[7]), msat_make_number(menv, "-6")), msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[19], xs[20]), msat_make_number(menv, "-19")), msat_make_geq(menv, msat_make_minus(menv, xs[24], xs[11]), msat_make_number(menv, "19"))))
