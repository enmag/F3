...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr0 = msat_make_plus(menv, xs[8], n_14_0)
    ...
    # ltl property: (F (G ((x_9 - x_3 > 18) & (x_28 - x_20 >= -10))))
    ltl = enc.make_F(enc.make_G(msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[9], xs[3]), msat_make_number(menv, "18")), msat_make_geq(menv, msat_make_minus(menv, xs[28], xs[20]), msat_make_number(menv, "-10")))))
