...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr8 = msat_make_plus(menv, xs[9], n_7_0)
    expr9 = msat_make_plus(menv, xs[10], n_4_0)
    ...
    expr15 = msat_make_plus(menv, xs[22], n_10_0)
    expr16 = msat_make_plus(menv, xs[24], n_7_0)
    ...
    # ltl property: ((G (x_17 - x_30 >= 19)) U (G (x_3 - x_31 >= 3)))
    ltl = enc.make_U(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[17], xs[30]), msat_make_number(menv, "19"))), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[3], xs[31]), msat_make_number(menv, "3"))))
