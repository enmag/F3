...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F ((x_27 - x_19 > -13) U (G (x_4 - x_23 > 12))))
    ltl = enc.make_F(enc.make_U(msat_make_gt(menv, msat_make_minus(menv, xs[27], xs[19]), msat_make_number(menv, "-13")), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[4], xs[23]), msat_make_number(menv, "12")))))
