...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((G (x_17 - x_15 > 7)) U (X (x_7 - x_11 >= 16)))
    ltl = enc.make_U(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[17], xs[15]), msat_make_number(menv, "7"))), enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[7], xs[11]), msat_make_number(menv, "16"))))
