...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((X (x_4 - x_10 > 12)) | (G (x_4 - x_1 > 2)))
    ltl = msat_make_or(menv, enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[4], xs[10]), msat_make_number(menv, "12"))), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[4], xs[1]), msat_make_number(menv, "2"))))
