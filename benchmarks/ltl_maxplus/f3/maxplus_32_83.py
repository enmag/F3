...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr13 = msat_make_plus(menv, xs[17], n_11_0)
    ...
    expr13 = msat_make_plus(menv, xs[17], n_5_0)
    ...
    expr13 = msat_make_plus(menv, xs[18], n_17_0)
    ...
    # ltl property: ((x_21 - x_30 >= -15) & ((x_0 - x_17 >= 3) U (x_10 - x_17 > 17)))
    ltl = msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[21], xs[30]), msat_make_number(menv, "-15")), enc.make_U(msat_make_geq(menv, msat_make_minus(menv, xs[0], xs[17]), msat_make_number(menv, "3")), msat_make_gt(menv, msat_make_minus(menv, xs[10], xs[17]), msat_make_number(menv, "17"))))
