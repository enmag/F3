...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_15 - x_24 >= 8) & (G (F (x_28 - x_24 >= -14))))
    ltl = msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[15], xs[24]), msat_make_number(menv, "8")), enc.make_G(enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[28], xs[24]), msat_make_number(menv, "-14")))))
