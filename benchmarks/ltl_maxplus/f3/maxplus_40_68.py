...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr11 = msat_make_plus(menv, xs[16], n_9_0)
    expr12 = msat_make_plus(menv, xs[17], n_9_0)
    expr13 = msat_make_plus(menv, xs[20], n_19_0)
    expr14 = msat_make_plus(menv, xs[21], n_1_0)
    expr15 = msat_make_plus(menv, xs[22], n_7_0)
    ...
    expr8 = msat_make_plus(menv, xs[9], n_19_0)
    ...
    expr8 = msat_make_plus(menv, xs[11], n_19_0)
    ...
    expr8 = msat_make_plus(menv, xs[23], n_10_0)
    ...
    expr4 = msat_make_plus(menv, xs[16], n_6_0)
    ...
    # ltl property: ((x_28 - x_30 >= -8) & (F (G (x_2 - x_32 > 6))))
    ltl = msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[28], xs[30]), msat_make_number(menv, "-8")), enc.make_F(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[2], xs[32]), msat_make_number(menv, "6")))))
