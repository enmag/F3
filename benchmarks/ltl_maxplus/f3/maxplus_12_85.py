...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((G (x_0 - x_1 > 6)) | (F (x_11 - x_4 > 16)))
    ltl = msat_make_or(menv, enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[0], xs[1]), msat_make_number(menv, "6"))), enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[11], xs[4]), msat_make_number(menv, "16"))))
