...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_3 - x_22 > 6) | ((x_11 - x_14 >= -20) & (x_4 - x_18 > 17)))
    ltl = msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[3], xs[22]), msat_make_number(menv, "6")), msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[11], xs[14]), msat_make_number(menv, "-20")), msat_make_gt(menv, msat_make_minus(menv, xs[4], xs[18]), msat_make_number(menv, "17"))))
