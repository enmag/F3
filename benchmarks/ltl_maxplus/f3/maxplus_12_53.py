...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (F ((F (x_2 - x_10 > -15)) U (x_1 - x_5 > 12)))
    ltl = enc.make_F(enc.make_U(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[2], xs[10]), msat_make_number(menv, "-15"))), msat_make_gt(menv, msat_make_minus(menv, xs[1], xs[5]), msat_make_number(menv, "12"))))
