...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_1 - x_2 >= -1) & (X (F (x_1 - x_3 > 2))))
    ltl = msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[1], xs[2]), msat_make_number(menv, "-1")), enc.make_X(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[1], xs[3]), msat_make_number(menv, "2")))))
