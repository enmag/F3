...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F (X ((x_16 - x_6 >= -4) & (x_14 - x_12 > -9))))
    ltl = enc.make_F(enc.make_X(msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[16], xs[6]), msat_make_number(menv, "-4")), msat_make_gt(menv, msat_make_minus(menv, xs[14], xs[12]), msat_make_number(menv, "-9")))))
