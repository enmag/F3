...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr2 = msat_make_plus(menv, xs[9], n_9_0)
    ...
    expr7 = msat_make_plus(menv, xs[8], n_10_0)
    expr8 = msat_make_plus(menv, xs[9], n_4_0)
    expr9 = msat_make_plus(menv, xs[11], n_2_0)
    expr10 = msat_make_plus(menv, xs[12], n_3_0)
    expr11 = msat_make_plus(menv, xs[13], n_14_0)
    expr12 = msat_make_plus(menv, xs[16], n_7_0)
    expr13 = msat_make_plus(menv, xs[17], n_8_0)
    expr14 = msat_make_plus(menv, xs[20], n_7_0)
    expr15 = msat_make_plus(menv, xs[23], n_16_0)
    ...
    expr3 = msat_make_plus(menv, xs[6], n_9_0)
    expr4 = msat_make_plus(menv, xs[15], n_3_0)
    ...
    expr13 = msat_make_plus(menv, xs[32], n_14_0)
    ...
    expr4 = msat_make_plus(menv, xs[13], n_1_0)
    expr5 = msat_make_plus(menv, xs[17], n_3_0)
    expr6 = msat_make_plus(menv, xs[18], n_7_0)
    ...
    expr7 = msat_make_plus(menv, xs[8], n_7_0)
    expr8 = msat_make_plus(menv, xs[10], n_14_0)
    expr9 = msat_make_plus(menv, xs[12], n_20_0)
    expr10 = msat_make_plus(menv, xs[14], n_4_0)
    expr11 = msat_make_plus(menv, xs[15], n_4_0)
    expr12 = msat_make_plus(menv, xs[17], n_8_0)
    expr13 = msat_make_plus(menv, xs[20], n_17_0)
    expr14 = msat_make_plus(menv, xs[22], n_20_0)
    expr15 = msat_make_plus(menv, xs[23], n_1_0)
    expr16 = msat_make_plus(menv, xs[24], n_4_0)
    ...
    expr9 = msat_make_plus(menv, xs[22], n_3_0)
    ...
    expr10 = msat_make_plus(menv, xs[14], n_7_0)
    expr11 = msat_make_plus(menv, xs[16], n_3_0)
    expr12 = msat_make_plus(menv, xs[18], n_17_0)
    expr13 = msat_make_plus(menv, xs[19], n_4_0)
    expr14 = msat_make_plus(menv, xs[22], n_16_0)
    expr15 = msat_make_plus(menv, xs[24], n_17_0)
    expr16 = msat_make_plus(menv, xs[26], n_8_0)
    expr17 = msat_make_plus(menv, xs[28], n_4_0)
    expr18 = msat_make_plus(menv, xs[30], n_2_0)
    ...
    # ltl property: ((X (x_7 - x_13 >= 16)) | (G (x_31 - x_9 > -14)))
    ltl = msat_make_or(menv, enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[7], xs[13]), msat_make_number(menv, "16"))), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[31], xs[9]), msat_make_number(menv, "-14"))))
