...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (G ((G (x_22 - x_18 > 2)) U (x_12 - x_17 > 17)))
    ltl = enc.make_G(enc.make_U(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[22], xs[18]), msat_make_number(menv, "2"))), msat_make_gt(menv, msat_make_minus(menv, xs[12], xs[17]), msat_make_number(menv, "17"))))
