...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (G ((x_2 - x_7 > 16) | (G (x_3 - x_5 > -13))))
    ltl = enc.make_G(msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[2], xs[7]), msat_make_number(menv, "16")), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[3], xs[5]), msat_make_number(menv, "-13")))))
