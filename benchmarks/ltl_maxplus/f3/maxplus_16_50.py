...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_8 - x_14 >= 15) | ((x_12 - x_6 >= 1) & (x_8 - x_12 >= 14)))
    ltl = msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[8], xs[14]), msat_make_number(menv, "15")), msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[12], xs[6]), msat_make_number(menv, "1")), msat_make_geq(menv, msat_make_minus(menv, xs[8], xs[12]), msat_make_number(menv, "14"))))
