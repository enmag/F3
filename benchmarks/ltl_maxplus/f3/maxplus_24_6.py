...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (! ((! (x_11 - x_15 > -11)) U (! (X (G (x_2 - x_8 > -1))))))
    ltl = msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[11], xs[15]), msat_make_number(menv, "-11"))), msat_make_not(menv, enc.make_X(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[2], xs[8]), msat_make_number(menv, "-1")))))))
