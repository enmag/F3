...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F (G ((x_2 - x_0 > -2) & (x_0 - x_2 > -16))))
    ltl = enc.make_F(enc.make_G(msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[2], xs[0]), msat_make_number(menv, "-2")), msat_make_gt(menv, msat_make_minus(menv, xs[0], xs[2]), msat_make_number(menv, "-16")))))
