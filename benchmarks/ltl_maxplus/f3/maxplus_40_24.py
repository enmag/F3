...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr0 = msat_make_plus(menv, xs[6], n_11_0)
    ...
    expr1 = msat_make_plus(menv, xs[9], n_12_0)
    expr2 = msat_make_plus(menv, xs[10], n_7_0)
    expr3 = msat_make_plus(menv, xs[13], n_20_0)
    expr4 = msat_make_plus(menv, xs[14], n_3_0)
    expr5 = msat_make_plus(menv, xs[16], n_14_0)
    ...
    expr16 = msat_make_plus(menv, xs[28], n_19_0)
    ...
    expr9 = msat_make_plus(menv, xs[23], n_1_0)
    ...
    expr1 = msat_make_plus(menv, xs[8], n_1_0)
    expr2 = msat_make_plus(menv, xs[11], n_13_0)
    expr3 = msat_make_plus(menv, xs[13], n_2_0)
    ...
    expr18 = msat_make_plus(menv, xs[31], n_15_0)
    ...
    expr2 = msat_make_plus(menv, xs[13], n_15_0)
    expr3 = msat_make_plus(menv, xs[15], n_14_0)
    expr4 = msat_make_plus(menv, xs[17], n_16_0)
    ...
    expr16 = msat_make_plus(menv, xs[28], n_12_0)
    ...
    expr14 = msat_make_plus(menv, xs[21], n_4_0)
    expr15 = msat_make_plus(menv, xs[23], n_4_0)
    expr16 = msat_make_plus(menv, xs[24], n_10_0)
    expr17 = msat_make_plus(menv, xs[27], n_13_0)
    ...
    expr0 = msat_make_plus(menv, xs[8], n_15_0)
    expr1 = msat_make_plus(menv, xs[9], n_4_0)
    expr2 = msat_make_plus(menv, xs[10], n_8_0)
    expr3 = msat_make_plus(menv, xs[13], n_19_0)
    expr4 = msat_make_plus(menv, xs[14], n_12_0)
    expr5 = msat_make_plus(menv, xs[16], n_5_0)
    expr6 = msat_make_plus(menv, xs[19], n_3_0)
    expr7 = msat_make_plus(menv, xs[20], n_10_0)
    expr8 = msat_make_plus(menv, xs[22], n_12_0)
    expr9 = msat_make_plus(menv, xs[23], n_17_0)
    expr10 = msat_make_plus(menv, xs[27], n_16_0)
    expr11 = msat_make_plus(menv, xs[28], n_19_0)
    expr12 = msat_make_plus(menv, xs[29], n_13_0)
    ...
    expr16 = msat_make_plus(menv, xs[27], n_12_0)
    ...
    # ltl property: ((x_2 - x_39 > -7) | ((x_12 - x_30 >= -9) & (x_18 - x_1 > -20)))
    ltl = msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[2], xs[39]), msat_make_number(menv, "-7")), msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[12], xs[30]), msat_make_number(menv, "-9")), msat_make_gt(menv, msat_make_minus(menv, xs[18], xs[1]), msat_make_number(menv, "-20"))))
