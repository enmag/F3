...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((G (x_9 - x_16 >= -15)) U (X (x_15 - x_9 > -20)))
    ltl = enc.make_U(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[9], xs[16]), msat_make_number(menv, "-15"))), enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[15], xs[9]), msat_make_number(menv, "-20"))))
