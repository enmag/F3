...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr3 = msat_make_plus(menv, xs[14], n_1_0)
    ...
    expr9 = msat_make_plus(menv, xs[25], n_6_0)
    ...
    expr16 = msat_make_plus(menv, xs[26], n_5_0)
    expr17 = msat_make_plus(menv, xs[28], n_15_0)
    expr18 = msat_make_plus(menv, xs[30], n_3_0)
    expr19 = msat_make_plus(menv, xs[32], n_9_0)
    _t = msat_make_and(menv,
    ...
    expr17 = msat_make_plus(menv, xs[30], n_5_0)
    expr18 = msat_make_plus(menv, xs[31], n_17_0)
    ...
    expr1 = msat_make_plus(menv, xs[9], n_9_0)
    ...
    expr13 = msat_make_plus(menv, xs[19], n_10_0)
    expr14 = msat_make_plus(menv, xs[21], n_6_0)
    expr15 = msat_make_plus(menv, xs[22], n_14_0)
    expr16 = msat_make_plus(menv, xs[23], n_2_0)
    expr17 = msat_make_plus(menv, xs[24], n_6_0)
    ...
    expr0 = msat_make_plus(menv, xs[5], n_6_0)
    ...
    # ltl property: ((x_24 - x_18 >= 11) | (! ((! (x_36 - x_1 > 15)) U (! (x_33 - x_38 >= -14)))))
    ltl = msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[24], xs[18]), msat_make_number(menv, "11")), msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[36], xs[1]), msat_make_number(menv, "15"))), msat_make_not(menv, msat_make_geq(menv, msat_make_minus(menv, xs[33], xs[38]), msat_make_number(menv, "-14"))))))
