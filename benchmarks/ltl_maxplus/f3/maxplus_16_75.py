...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_3 - x_7 > -19) & (X (F (x_7 - x_13 >= 7))))
    ltl = msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[3], xs[7]), msat_make_number(menv, "-19")), enc.make_X(enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[7], xs[13]), msat_make_number(menv, "7")))))
