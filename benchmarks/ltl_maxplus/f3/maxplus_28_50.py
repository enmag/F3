...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_3 - x_16 >= 5) | ((x_3 - x_16 >= -16) & (x_8 - x_17 >= -15)))
    ltl = msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[3], xs[16]), msat_make_number(menv, "5")), msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[3], xs[16]), msat_make_number(menv, "-16")), msat_make_geq(menv, msat_make_minus(menv, xs[8], xs[17]), msat_make_number(menv, "-15"))))
