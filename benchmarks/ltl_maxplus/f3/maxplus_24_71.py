...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_9 - x_16 >= 4) & (G (F (x_22 - x_18 >= 9))))
    ltl = msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[9], xs[16]), msat_make_number(menv, "4")), enc.make_G(enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[22], xs[18]), msat_make_number(menv, "9")))))
