...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_16 - x_18 > -4) & ((x_8 - x_11 > -20) | (x_10 - x_3 >= 20)))
    ltl = msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[16], xs[18]), msat_make_number(menv, "-4")), msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[8], xs[11]), msat_make_number(menv, "-20")), msat_make_geq(menv, msat_make_minus(menv, xs[10], xs[3]), msat_make_number(menv, "20"))))
