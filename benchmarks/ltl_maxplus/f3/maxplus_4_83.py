...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_2 - x_3 >= -15) & ((x_1 - x_3 >= -3) U (x_0 - x_2 > 11)))
    ltl = msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[2], xs[3]), msat_make_number(menv, "-15")), enc.make_U(msat_make_geq(menv, msat_make_minus(menv, xs[1], xs[3]), msat_make_number(menv, "-3")), msat_make_gt(menv, msat_make_minus(menv, xs[0], xs[2]), msat_make_number(menv, "11"))))
