...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr8 = msat_make_plus(menv, xs[9], n_1_0)
    expr9 = msat_make_plus(menv, xs[10], n_11_0)
    ...
    # ltl property: (X ((x_24 - x_0 > -15) U (G (x_6 - x_2 >= 7))))
    ltl = enc.make_X(enc.make_U(msat_make_gt(menv, msat_make_minus(menv, xs[24], xs[0]), msat_make_number(menv, "-15")), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[6], xs[2]), msat_make_number(menv, "7")))))
