...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((X (x_26 - x_0 > -13)) U (X (x_1 - x_7 >= 14)))
    ltl = enc.make_U(enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[26], xs[0]), msat_make_number(menv, "-13"))), enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[1], xs[7]), msat_make_number(menv, "14"))))
