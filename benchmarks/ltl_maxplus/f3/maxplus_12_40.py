...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((X (x_9 - x_4 >= 6)) | (X (x_6 - x_4 >= -5)))
    ltl = msat_make_or(menv, enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[9], xs[4]), msat_make_number(menv, "6"))), enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[6], xs[4]), msat_make_number(menv, "-5"))))
