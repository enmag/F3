...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((F (x_7 - x_24 > 3)) & (X (x_20 - x_8 > -9)))
    ltl = msat_make_and(menv, enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[7], xs[24]), msat_make_number(menv, "3"))), enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[20], xs[8]), msat_make_number(menv, "-9"))))
