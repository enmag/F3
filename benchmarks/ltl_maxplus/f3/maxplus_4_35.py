...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((G (x_1 - x_2 > -9)) & (F (x_2 - x_1 > -6)))
    ltl = msat_make_and(menv, enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[1], xs[2]), msat_make_number(menv, "-9"))), enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[2], xs[1]), msat_make_number(menv, "-6"))))
