...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((X (x_24 - x_29 >= -14)) U (X (x_11 - x_22 > 3)))
    ltl = enc.make_U(enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[24], xs[29]), msat_make_number(menv, "-14"))), enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[11], xs[22]), msat_make_number(menv, "3"))))
