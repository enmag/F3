...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F ((x_6 - x_0 > -4) U (G (x_0 - x_11 > 8))))
    ltl = enc.make_F(enc.make_U(msat_make_gt(menv, msat_make_minus(menv, xs[6], xs[0]), msat_make_number(menv, "-4")), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[0], xs[11]), msat_make_number(menv, "8")))))
