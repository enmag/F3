...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((X (x_21 - x_25 >= 20)) U (G (x_21 - x_31 > -9)))
    ltl = enc.make_U(enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[21], xs[25]), msat_make_number(menv, "20"))), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[21], xs[31]), msat_make_number(menv, "-9"))))
