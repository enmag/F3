...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr9 = msat_make_plus(menv, xs[11], n_3_0)
    expr10 = msat_make_plus(menv, xs[14], n_10_0)
    expr11 = msat_make_plus(menv, xs[15], n_16_0)
    expr12 = msat_make_plus(menv, xs[16], n_16_0)
    expr13 = msat_make_plus(menv, xs[17], n_14_0)
    expr14 = msat_make_plus(menv, xs[19], n_19_0)
    ...
    # ltl property: ((x_12 - x_28 > -10) U ((x_3 - x_24 >= 16) U (x_25 - x_28 >= 1)))
    ltl = enc.make_U(msat_make_gt(menv, msat_make_minus(menv, xs[12], xs[28]), msat_make_number(menv, "-10")), enc.make_U(msat_make_geq(menv, msat_make_minus(menv, xs[3], xs[24]), msat_make_number(menv, "16")), msat_make_geq(menv, msat_make_minus(menv, xs[25], xs[28]), msat_make_number(menv, "1"))))
