...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((G (x_3 - x_6 > 3)) U (G (x_2 - x_7 >= 2)))
    ltl = enc.make_U(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[3], xs[6]), msat_make_number(menv, "3"))), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[2], xs[7]), msat_make_number(menv, "2"))))
