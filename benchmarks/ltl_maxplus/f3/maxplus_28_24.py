...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_17 - x_5 >= 3) | ((x_2 - x_15 > 18) & (x_22 - x_9 > 17)))
    ltl = msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[17], xs[5]), msat_make_number(menv, "3")), msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[2], xs[15]), msat_make_number(menv, "18")), msat_make_gt(menv, msat_make_minus(menv, xs[22], xs[9]), msat_make_number(menv, "17"))))
