...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (X ((x_24 - x_20 > -6) & (G (x_7 - x_22 > 19))))
    ltl = enc.make_X(msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[24], xs[20]), msat_make_number(menv, "-6")), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[7], xs[22]), msat_make_number(menv, "19")))))
