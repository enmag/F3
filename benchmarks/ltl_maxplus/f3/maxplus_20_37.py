...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_8 - x_6 >= -14) | ((x_1 - x_4 >= -12) & (x_18 - x_15 > 13)))
    ltl = msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[8], xs[6]), msat_make_number(menv, "-14")), msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[1], xs[4]), msat_make_number(menv, "-12")), msat_make_gt(menv, msat_make_minus(menv, xs[18], xs[15]), msat_make_number(menv, "13"))))
