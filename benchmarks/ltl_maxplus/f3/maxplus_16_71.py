...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_0 - x_4 >= -10) & (G (F (x_0 - x_6 > 19))))
    ltl = msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[0], xs[4]), msat_make_number(menv, "-10")), enc.make_G(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[0], xs[6]), msat_make_number(menv, "19")))))
