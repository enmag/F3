...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_12 - x_7 > -10) | (G (F (x_10 - x_8 >= -10))))
    ltl = msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[12], xs[7]), msat_make_number(menv, "-10")), enc.make_G(enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[10], xs[8]), msat_make_number(menv, "-10")))))
