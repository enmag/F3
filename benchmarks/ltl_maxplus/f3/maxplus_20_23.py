...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((G (x_19 - x_2 >= -13)) U (G (x_5 - x_0 >= 3)))
    ltl = enc.make_U(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[19], xs[2]), msat_make_number(menv, "-13"))), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[5], xs[0]), msat_make_number(menv, "3"))))
