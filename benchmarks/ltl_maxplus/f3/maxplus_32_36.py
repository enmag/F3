...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((F (x_28 - x_9 > 0)) U (G (x_16 - x_21 >= 13)))
    ltl = enc.make_U(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[28], xs[9]), msat_make_number(menv, "0"))), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[16], xs[21]), msat_make_number(menv, "13"))))
