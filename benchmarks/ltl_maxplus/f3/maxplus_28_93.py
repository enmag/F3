...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (F (X (F (G (x_19 - x_12 >= 16)))))
    ltl = enc.make_F(enc.make_X(enc.make_F(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[19], xs[12]), msat_make_number(menv, "16"))))))
