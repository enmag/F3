...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((G (x_29 - x_28 > -20)) U (X (x_35 - x_3 >= -14)))
    ltl = enc.make_U(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[29], xs[28]), msat_make_number(menv, "-20"))), enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[35], xs[3]), msat_make_number(menv, "-14"))))
