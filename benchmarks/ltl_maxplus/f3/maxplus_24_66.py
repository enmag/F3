...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_0 - x_3 >= 17) | ((x_6 - x_20 > -10) & (x_16 - x_9 >= -12)))
    ltl = msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[0], xs[3]), msat_make_number(menv, "17")), msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[6], xs[20]), msat_make_number(menv, "-10")), msat_make_geq(menv, msat_make_minus(menv, xs[16], xs[9]), msat_make_number(menv, "-12"))))
