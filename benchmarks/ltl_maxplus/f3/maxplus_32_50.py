...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr11 = msat_make_plus(menv, xs[14], n_7_0)
    ...
    # ltl property: ((x_28 - x_17 >= -15) | ((x_26 - x_23 > -12) & (x_27 - x_29 > 10)))
    ltl = msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[28], xs[17]), msat_make_number(menv, "-15")), msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[26], xs[23]), msat_make_number(menv, "-12")), msat_make_gt(menv, msat_make_minus(menv, xs[27], xs[29]), msat_make_number(menv, "10"))))
