...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((G (x_6 - x_3 > -4)) & (F (x_4 - x_2 > -7)))
    ltl = msat_make_and(menv, enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[6], xs[3]), msat_make_number(menv, "-4"))), enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[4], xs[2]), msat_make_number(menv, "-7"))))
