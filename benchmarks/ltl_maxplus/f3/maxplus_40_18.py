...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr7 = msat_make_plus(menv, xs[23], n_19_0)
    ...
    expr0 = msat_make_plus(menv, xs[6], n_10_0)
    ...
    expr4 = msat_make_plus(menv, xs[14], n_5_0)
    ...
    # ltl property: (X ((x_22 - x_9 >= -13) | (X (x_37 - x_27 > 1))))
    ltl = enc.make_X(msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[22], xs[9]), msat_make_number(menv, "-13")), enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[37], xs[27]), msat_make_number(menv, "1")))))
