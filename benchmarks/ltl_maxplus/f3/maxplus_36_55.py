...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr0 = msat_make_plus(menv, xs[7], n_12_0)
    ...
    expr0 = msat_make_plus(menv, xs[2], n_9_0)
    expr1 = msat_make_plus(menv, xs[9], n_17_0)
    ...
    # ltl property: (! ((! (x_22 - x_8 >= -11)) U (! (X (X (x_19 - x_35 >= -19))))))
    ltl = msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_geq(menv, msat_make_minus(menv, xs[22], xs[8]), msat_make_number(menv, "-11"))), msat_make_not(menv, enc.make_X(enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[19], xs[35]), msat_make_number(menv, "-19")))))))
