...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_23 - x_16 > 9) | (X (F (x_21 - x_9 > 15))))
    ltl = msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[23], xs[16]), msat_make_number(menv, "9")), enc.make_X(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[21], xs[9]), msat_make_number(menv, "15")))))
