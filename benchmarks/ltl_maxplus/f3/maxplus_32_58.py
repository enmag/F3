...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (G ((G (x_28 - x_2 >= 0)) U (x_4 - x_2 > 15)))
    ltl = enc.make_G(enc.make_U(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[28], xs[2]), msat_make_number(menv, "0"))), msat_make_gt(menv, msat_make_minus(menv, xs[4], xs[2]), msat_make_number(menv, "15"))))
