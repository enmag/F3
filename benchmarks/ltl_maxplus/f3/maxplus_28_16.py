...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr9 = msat_make_plus(menv, xs[10], n_10_0)
    ...
    # ltl property: ((G (x_24 - x_8 > 12)) U (X (x_6 - x_25 >= 1)))
    ltl = enc.make_U(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[24], xs[8]), msat_make_number(menv, "12"))), enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[6], xs[25]), msat_make_number(menv, "1"))))
