...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr4 = msat_make_plus(menv, xs[16], n_7_0)
    ...
    expr1 = msat_make_plus(menv, xs[9], n_14_0)
    ...
    # ltl property: (! ((! (G (x_6 - x_3 > -13))) U (! (X (x_26 - x_30 >= -18)))))
    ltl = msat_make_not(menv, enc.make_U(msat_make_not(menv, enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[6], xs[3]), msat_make_number(menv, "-13")))), msat_make_not(menv, enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[26], xs[30]), msat_make_number(menv, "-18"))))))
