...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_0 - x_2 > 0) U ((x_2 - x_0 > -10) U (x_1 - x_2 >= -6)))
    ltl = enc.make_U(msat_make_gt(menv, msat_make_minus(menv, xs[0], xs[2]), msat_make_number(menv, "0")), enc.make_U(msat_make_gt(menv, msat_make_minus(menv, xs[2], xs[0]), msat_make_number(menv, "-10")), msat_make_geq(menv, msat_make_minus(menv, xs[1], xs[2]), msat_make_number(menv, "-6"))))
