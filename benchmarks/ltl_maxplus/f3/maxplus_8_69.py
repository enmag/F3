...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F (G (F (X (x_7 - x_0 > 19)))))
    ltl = enc.make_F(enc.make_G(enc.make_F(enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[7], xs[0]), msat_make_number(menv, "19"))))))
