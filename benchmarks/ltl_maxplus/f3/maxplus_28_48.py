...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_23 - x_14 > -14) U ((x_5 - x_6 >= -18) & (x_8 - x_16 >= -11)))
    ltl = enc.make_U(msat_make_gt(menv, msat_make_minus(menv, xs[23], xs[14]), msat_make_number(menv, "-14")), msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[5], xs[6]), msat_make_number(menv, "-18")), msat_make_geq(menv, msat_make_minus(menv, xs[8], xs[16]), msat_make_number(menv, "-11"))))
