...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (G ((G (x_5 - x_2 > -15)) U (x_1 - x_2 > 3)))
    ltl = enc.make_G(enc.make_U(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[5], xs[2]), msat_make_number(menv, "-15"))), msat_make_gt(menv, msat_make_minus(menv, xs[1], xs[2]), msat_make_number(menv, "3"))))
