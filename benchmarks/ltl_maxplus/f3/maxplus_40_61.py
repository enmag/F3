...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr11 = msat_make_plus(menv, xs[14], n_2_0)
    ...
    # ltl property: ((X (X (x_18 - x_9 > -18))) U (x_13 - x_15 >= 0))
    ltl = enc.make_U(enc.make_X(enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[18], xs[9]), msat_make_number(menv, "-18")))), msat_make_geq(menv, msat_make_minus(menv, xs[13], xs[15]), msat_make_number(menv, "0")))
