...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr5 = msat_make_plus(menv, xs[19], n_12_0)
    ...
    # ltl property: ((G (x_4 - x_17 > 3)) U (G (x_13 - x_16 > -5)))
    ltl = enc.make_U(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[4], xs[17]), msat_make_number(menv, "3"))), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[13], xs[16]), msat_make_number(menv, "-5"))))
