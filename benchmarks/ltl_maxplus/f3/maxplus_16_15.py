...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (F ((x_11 - x_12 > 4) | (G (x_2 - x_9 >= -1))))
    ltl = enc.make_F(msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[11], xs[12]), msat_make_number(menv, "4")), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[2], xs[9]), msat_make_number(menv, "-1")))))
