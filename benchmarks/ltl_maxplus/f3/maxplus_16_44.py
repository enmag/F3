...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (X ((x_11 - x_6 >= 14) U (G (x_14 - x_6 > 12))))
    ltl = enc.make_X(enc.make_U(msat_make_geq(menv, msat_make_minus(menv, xs[11], xs[6]), msat_make_number(menv, "14")), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[14], xs[6]), msat_make_number(menv, "12")))))
