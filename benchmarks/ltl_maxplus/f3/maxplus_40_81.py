...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr9 = msat_make_plus(menv, xs[25], n_3_0)
    ...
    expr2 = msat_make_plus(menv, xs[10], n_17_0)
    ...
    expr3 = msat_make_plus(menv, xs[12], n_12_0)
    ...
    expr10 = msat_make_plus(menv, xs[27], n_20_0)
    expr11 = msat_make_plus(menv, xs[29], n_8_0)
    expr12 = msat_make_plus(menv, xs[32], n_18_0)
    expr13 = msat_make_plus(menv, xs[33], n_8_0)
    ...
    expr3 = msat_make_plus(menv, xs[14], n_13_0)
    expr4 = msat_make_plus(menv, xs[15], n_9_0)
    expr5 = msat_make_plus(menv, xs[19], n_4_0)
    expr6 = msat_make_plus(menv, xs[20], n_13_0)
    ...
    expr3 = msat_make_plus(menv, xs[12], n_7_0)
    ...
    # ltl property: (! ((! (! ((! (x_18 - x_25 >= 5)) U (! (x_38 - x_19 >= 10))))) U (! (x_18 - x_25 >= 5))))
    ltl = msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_geq(menv, msat_make_minus(menv, xs[18], xs[25]), msat_make_number(menv, "5"))), msat_make_not(menv, msat_make_geq(menv, msat_make_minus(menv, xs[38], xs[19]), msat_make_number(menv, "10")))))), msat_make_not(menv, msat_make_geq(menv, msat_make_minus(menv, xs[18], xs[25]), msat_make_number(menv, "5")))))
