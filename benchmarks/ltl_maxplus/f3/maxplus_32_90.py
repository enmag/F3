...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (F ((F (x_19 - x_27 > 17)) U (x_14 - x_3 >= 11)))
    ltl = enc.make_F(enc.make_U(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[19], xs[27]), msat_make_number(menv, "17"))), msat_make_geq(menv, msat_make_minus(menv, xs[14], xs[3]), msat_make_number(menv, "11"))))
