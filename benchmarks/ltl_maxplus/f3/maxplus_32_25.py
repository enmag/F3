...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr4 = msat_make_plus(menv, xs[17], n_9_0)
    expr5 = msat_make_plus(menv, xs[18], n_4_0)
    expr6 = msat_make_plus(menv, xs[21], n_1_0)
    ...
    # ltl property: ((G (x_13 - x_14 > 19)) & (F (x_14 - x_22 > -3)))
    ltl = msat_make_and(menv, enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[13], xs[14]), msat_make_number(menv, "19"))), enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[14], xs[22]), msat_make_number(menv, "-3"))))
