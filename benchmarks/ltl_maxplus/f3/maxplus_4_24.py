...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_3 - x_2 >= -12) | ((x_0 - x_3 > -10) & (x_2 - x_3 > 14)))
    ltl = msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[3], xs[2]), msat_make_number(menv, "-12")), msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[0], xs[3]), msat_make_number(menv, "-10")), msat_make_gt(menv, msat_make_minus(menv, xs[2], xs[3]), msat_make_number(menv, "14"))))
