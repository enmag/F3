...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr17 = msat_make_plus(menv, xs[28], n_11_0)
    expr18 = msat_make_plus(menv, xs[29], n_10_0)
    ...
    expr6 = msat_make_plus(menv, xs[7], n_14_0)
    ...
    # ltl property: (F (X ((x_38 - x_18 >= 18) & (x_7 - x_4 >= 3))))
    ltl = enc.make_F(enc.make_X(msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[38], xs[18]), msat_make_number(menv, "18")), msat_make_geq(menv, msat_make_minus(menv, xs[7], xs[4]), msat_make_number(menv, "3")))))
