...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_1 - x_7 >= -6) | (X (F (x_0 - x_2 > 9))))
    ltl = msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[1], xs[7]), msat_make_number(menv, "-6")), enc.make_X(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[0], xs[2]), msat_make_number(menv, "9")))))
