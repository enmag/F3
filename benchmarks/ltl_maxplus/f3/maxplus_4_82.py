...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((X (x_0 - x_2 >= -3)) | (G (x_0 - x_1 > 8)))
    ltl = msat_make_or(menv, enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[0], xs[2]), msat_make_number(menv, "-3"))), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[0], xs[1]), msat_make_number(menv, "8"))))
