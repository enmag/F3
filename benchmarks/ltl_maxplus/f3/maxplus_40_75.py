...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr8 = msat_make_plus(menv, xs[24], n_17_0)
    ...
    expr16 = msat_make_plus(menv, xs[25], n_13_0)
    ...
    # ltl property: ((x_35 - x_30 > 2) & (X (F (x_37 - x_33 > 11))))
    ltl = msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[35], xs[30]), msat_make_number(menv, "2")), enc.make_X(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[37], xs[33]), msat_make_number(menv, "11")))))
