...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr8 = msat_make_plus(menv, xs[10], n_10_0)
    expr9 = msat_make_plus(menv, xs[12], n_3_0)
    expr10 = msat_make_plus(menv, xs[13], n_20_0)
    expr11 = msat_make_plus(menv, xs[14], n_4_0)
    ...
    # ltl property: ((G (x_18 - x_9 >= -19)) U (X (x_13 - x_1 > -10)))
    ltl = enc.make_U(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[18], xs[9]), msat_make_number(menv, "-19"))), enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[13], xs[1]), msat_make_number(menv, "-10"))))
