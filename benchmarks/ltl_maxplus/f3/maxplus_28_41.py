...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_11 - x_15 >= -12) U ((x_24 - x_21 > -6) U (x_2 - x_24 >= 10)))
    ltl = enc.make_U(msat_make_geq(menv, msat_make_minus(menv, xs[11], xs[15]), msat_make_number(menv, "-12")), enc.make_U(msat_make_gt(menv, msat_make_minus(menv, xs[24], xs[21]), msat_make_number(menv, "-6")), msat_make_geq(menv, msat_make_minus(menv, xs[2], xs[24]), msat_make_number(menv, "10"))))
