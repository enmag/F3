...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr0 = msat_make_plus(menv, xs[7], n_2_0)
    ...
    # ltl property: (F (X ((x_14 - x_23 >= 5) & (x_15 - x_1 >= 13))))
    ltl = enc.make_F(enc.make_X(msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[14], xs[23]), msat_make_number(menv, "5")), msat_make_geq(menv, msat_make_minus(menv, xs[15], xs[1]), msat_make_number(menv, "13")))))
