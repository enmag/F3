...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((F (x_1 - x_10 > -5)) & (X (x_11 - x_8 > 16)))
    ltl = msat_make_and(menv, enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[1], xs[10]), msat_make_number(menv, "-5"))), enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[11], xs[8]), msat_make_number(menv, "16"))))
