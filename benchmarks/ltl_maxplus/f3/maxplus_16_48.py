...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_9 - x_1 > 14) U ((x_11 - x_14 > -9) & (x_11 - x_10 >= 19)))
    ltl = enc.make_U(msat_make_gt(menv, msat_make_minus(menv, xs[9], xs[1]), msat_make_number(menv, "14")), msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[11], xs[14]), msat_make_number(menv, "-9")), msat_make_geq(menv, msat_make_minus(menv, xs[11], xs[10]), msat_make_number(menv, "19"))))
