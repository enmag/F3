...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr1 = msat_make_plus(menv, xs[7], n_14_0)
    ...
    expr18 = msat_make_plus(menv, xs[34], n_5_0)
    ...
    expr0 = msat_make_plus(menv, xs[7], n_6_0)
    expr1 = msat_make_plus(menv, xs[8], n_7_0)
    expr2 = msat_make_plus(menv, xs[10], n_9_0)
    expr3 = msat_make_plus(menv, xs[11], n_5_0)
    ...
    expr13 = msat_make_plus(menv, xs[20], n_11_0)
    ...
    expr10 = msat_make_plus(menv, xs[27], n_18_0)
    expr11 = msat_make_plus(menv, xs[28], n_18_0)
    ...
    expr1 = msat_make_plus(menv, xs[7], n_10_0)
    expr2 = msat_make_plus(menv, xs[10], n_19_0)
    expr3 = msat_make_plus(menv, xs[12], n_15_0)
    expr4 = msat_make_plus(menv, xs[13], n_8_0)
    expr5 = msat_make_plus(menv, xs[14], n_16_0)
    expr6 = msat_make_plus(menv, xs[22], n_19_0)
    expr7 = msat_make_plus(menv, xs[23], n_5_0)
    ...
    expr13 = msat_make_plus(menv, xs[21], n_8_0)
    expr14 = msat_make_plus(menv, xs[22], n_15_0)
    expr15 = msat_make_plus(menv, xs[24], n_5_0)
    expr16 = msat_make_plus(menv, xs[26], n_4_0)
    expr17 = msat_make_plus(menv, xs[30], n_10_0)
    expr18 = msat_make_plus(menv, xs[34], n_2_0)
    expr19 = msat_make_plus(menv, xs[35], n_4_0)
    _t = msat_make_and(menv,
    ...
    expr4 = msat_make_plus(menv, xs[15], n_20_0)
    ...
    expr2 = msat_make_plus(menv, xs[12], n_6_0)
    expr3 = msat_make_plus(menv, xs[15], n_8_0)
    expr4 = msat_make_plus(menv, xs[16], n_9_0)
    ...
    expr11 = msat_make_plus(menv, xs[29], n_18_0)
    ...
    expr10 = msat_make_plus(menv, xs[16], n_12_0)
    ...
    expr17 = msat_make_plus(menv, xs[29], n_16_0)
    ...
    expr17 = msat_make_plus(menv, xs[28], n_2_0)
    ...
    expr6 = msat_make_plus(menv, xs[21], n_2_0)
    expr7 = msat_make_plus(menv, xs[23], n_6_0)
    expr8 = msat_make_plus(menv, xs[24], n_16_0)
    expr9 = msat_make_plus(menv, xs[25], n_7_0)
    expr10 = msat_make_plus(menv, xs[26], n_12_0)
    expr11 = msat_make_plus(menv, xs[28], n_17_0)
    expr12 = msat_make_plus(menv, xs[29], n_9_0)
    expr13 = msat_make_plus(menv, xs[30], n_4_0)
    ...
    # ltl property: ((G (x_11 - x_31 > -4)) U (G (x_31 - x_32 > 14)))
    ltl = enc.make_U(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[11], xs[31]), msat_make_number(menv, "-4"))), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[31], xs[32]), msat_make_number(menv, "14"))))
