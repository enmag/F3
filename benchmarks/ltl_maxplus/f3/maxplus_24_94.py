...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_21 - x_0 >= 14) U ((x_3 - x_7 > 0) | (x_12 - x_21 >= -9)))
    ltl = enc.make_U(msat_make_geq(menv, msat_make_minus(menv, xs[21], xs[0]), msat_make_number(menv, "14")), msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[3], xs[7]), msat_make_number(menv, "0")), msat_make_geq(menv, msat_make_minus(menv, xs[12], xs[21]), msat_make_number(menv, "-9"))))
