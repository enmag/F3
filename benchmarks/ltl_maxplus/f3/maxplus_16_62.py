...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((X (X (x_7 - x_4 > -6))) U (x_12 - x_3 >= 20))
    ltl = enc.make_U(enc.make_X(enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[7], xs[4]), msat_make_number(menv, "-6")))), msat_make_geq(menv, msat_make_minus(menv, xs[12], xs[3]), msat_make_number(menv, "20")))
