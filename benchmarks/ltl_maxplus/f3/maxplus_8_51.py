...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F ((x_4 - x_1 > -19) U (F (x_5 - x_3 > 16))))
    ltl = enc.make_F(enc.make_U(msat_make_gt(menv, msat_make_minus(menv, xs[4], xs[1]), msat_make_number(menv, "-19")), enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[5], xs[3]), msat_make_number(menv, "16")))))
