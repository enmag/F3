...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((X (x_22 - x_5 >= 12)) & (G (x_9 - x_5 >= 10)))
    ltl = msat_make_and(menv, enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[22], xs[5]), msat_make_number(menv, "12"))), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[9], xs[5]), msat_make_number(menv, "10"))))
