...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr17 = msat_make_plus(menv, xs[28], n_18_0)
    ...
    # ltl property: ((G (x_29 - x_21 > 8)) U (X (x_17 - x_1 > -8)))
    ltl = enc.make_U(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[29], xs[21]), msat_make_number(menv, "8"))), enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[17], xs[1]), msat_make_number(menv, "-8"))))
