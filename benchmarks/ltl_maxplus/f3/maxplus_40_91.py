...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr12 = msat_make_plus(menv, xs[19], n_17_0)
    ...
    expr18 = msat_make_plus(menv, xs[31], n_2_0)
    ...
    expr6 = msat_make_plus(menv, xs[22], n_12_0)
    expr7 = msat_make_plus(menv, xs[23], n_15_0)
    ...
    expr11 = msat_make_plus(menv, xs[29], n_14_0)
    ...
    # ltl property: (X (F (G (F (x_7 - x_26 >= 3)))))
    ltl = enc.make_X(enc.make_F(enc.make_G(enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[7], xs[26]), msat_make_number(menv, "3"))))))
