...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (! ((! (x_3 - x_12 > 19)) U (! (! ((! (x_10 - x_16 > -2)) U (! (x_13 - x_0 > -12)))))))
    ltl = msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[3], xs[12]), msat_make_number(menv, "19"))), msat_make_not(menv, msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[10], xs[16]), msat_make_number(menv, "-2"))), msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[13], xs[0]), msat_make_number(menv, "-12"))))))))
