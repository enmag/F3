...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((G (x_4 - x_9 >= 0)) U (X (x_10 - x_5 >= -19)))
    ltl = enc.make_U(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[4], xs[9]), msat_make_number(menv, "0"))), enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[10], xs[5]), msat_make_number(menv, "-19"))))
