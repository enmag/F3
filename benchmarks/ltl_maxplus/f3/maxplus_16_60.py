...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (G ((x_1 - x_9 > 6) | (X (x_13 - x_0 >= 0))))
    ltl = enc.make_G(msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[1], xs[9]), msat_make_number(menv, "6")), enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[13], xs[0]), msat_make_number(menv, "0")))))
