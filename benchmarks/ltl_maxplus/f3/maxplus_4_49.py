...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_0 - x_3 >= -12) & ((x_0 - x_3 >= 6) | (x_0 - x_3 >= -12)))
    ltl = msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[0], xs[3]), msat_make_number(menv, "-12")), msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[0], xs[3]), msat_make_number(menv, "6")), msat_make_geq(menv, msat_make_minus(menv, xs[0], xs[3]), msat_make_number(menv, "-12"))))
