...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_2 - x_1 >= -19) & (F (G (x_1 - x_0 > -17))))
    ltl = msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[2], xs[1]), msat_make_number(menv, "-19")), enc.make_F(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[1], xs[0]), msat_make_number(menv, "-17")))))
