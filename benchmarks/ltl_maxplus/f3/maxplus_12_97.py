...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (G ((X (x_5 - x_9 > -7)) U (x_0 - x_7 > -17)))
    ltl = enc.make_G(enc.make_U(enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[5], xs[9]), msat_make_number(menv, "-7"))), msat_make_gt(menv, msat_make_minus(menv, xs[0], xs[7]), msat_make_number(menv, "-17"))))
