...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_7 - x_18 >= 3) | ((x_12 - x_15 >= 7) & (x_5 - x_13 > 11)))
    ltl = msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[7], xs[18]), msat_make_number(menv, "3")), msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[12], xs[15]), msat_make_number(menv, "7")), msat_make_gt(menv, msat_make_minus(menv, xs[5], xs[13]), msat_make_number(menv, "11"))))
