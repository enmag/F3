...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr13 = msat_make_plus(menv, xs[16], n_15_0)
    ...
    expr12 = msat_make_plus(menv, xs[17], n_16_0)
    ...
    # ltl property: (X (X (! ((! (x_7 - x_14 > -11)) U (! (x_18 - x_13 > -19))))))
    ltl = enc.make_X(enc.make_X(msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[7], xs[14]), msat_make_number(menv, "-11"))), msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[18], xs[13]), msat_make_number(menv, "-19")))))))
