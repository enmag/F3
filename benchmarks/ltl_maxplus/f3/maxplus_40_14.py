...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr12 = msat_make_plus(menv, xs[18], n_9_0)
    expr13 = msat_make_plus(menv, xs[20], n_2_0)
    expr14 = msat_make_plus(menv, xs[21], n_14_0)
    expr15 = msat_make_plus(menv, xs[22], n_9_0)
    expr16 = msat_make_plus(menv, xs[25], n_8_0)
    expr17 = msat_make_plus(menv, xs[29], n_16_0)
    expr18 = msat_make_plus(menv, xs[31], n_3_0)
    ...
    expr13 = msat_make_plus(menv, xs[23], n_14_0)
    ...
    expr6 = msat_make_plus(menv, xs[20], n_4_0)
    expr7 = msat_make_plus(menv, xs[21], n_14_0)
    ...
    expr16 = msat_make_plus(menv, xs[27], n_5_0)
    expr17 = msat_make_plus(menv, xs[31], n_5_0)
    expr18 = msat_make_plus(menv, xs[32], n_7_0)
    ...
    expr6 = msat_make_plus(menv, xs[22], n_20_0)
    expr7 = msat_make_plus(menv, xs[23], n_4_0)
    expr8 = msat_make_plus(menv, xs[24], n_3_0)
    expr9 = msat_make_plus(menv, xs[25], n_17_0)
    expr10 = msat_make_plus(menv, xs[26], n_20_0)
    expr11 = msat_make_plus(menv, xs[28], n_15_0)
    expr12 = msat_make_plus(menv, xs[31], n_18_0)
    expr13 = msat_make_plus(menv, xs[33], n_18_0)
    expr14 = msat_make_plus(menv, xs[34], n_13_0)
    ...
    expr15 = msat_make_plus(menv, xs[35], n_6_0)
    ...
    expr6 = msat_make_plus(menv, xs[19], n_15_0)
    ...
    expr11 = msat_make_plus(menv, xs[18], n_12_0)
    ...
    # ltl property: (X ((G (x_34 - x_36 >= -6)) U (x_19 - x_30 > -17)))
    ltl = enc.make_X(enc.make_U(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[34], xs[36]), msat_make_number(menv, "-6"))), msat_make_gt(menv, msat_make_minus(menv, xs[19], xs[30]), msat_make_number(menv, "-17"))))
