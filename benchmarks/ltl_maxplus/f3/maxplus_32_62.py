...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((X (X (x_13 - x_28 > -10))) U (x_12 - x_30 > -20))
    ltl = enc.make_U(enc.make_X(enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[13], xs[28]), msat_make_number(menv, "-10")))), msat_make_gt(menv, msat_make_minus(menv, xs[12], xs[30]), msat_make_number(menv, "-20")))
