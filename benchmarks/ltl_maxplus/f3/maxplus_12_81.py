...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (! ((! (! ((! (x_1 - x_10 >= 15)) U (! (x_10 - x_0 > -12))))) U (! (x_1 - x_10 >= 15))))
    ltl = msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_geq(menv, msat_make_minus(menv, xs[1], xs[10]), msat_make_number(menv, "15"))), msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[10], xs[0]), msat_make_number(menv, "-12")))))), msat_make_not(menv, msat_make_geq(menv, msat_make_minus(menv, xs[1], xs[10]), msat_make_number(menv, "15")))))
