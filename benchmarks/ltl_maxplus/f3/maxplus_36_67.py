...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr8 = msat_make_plus(menv, xs[10], n_5_0)
    ...
    expr17 = msat_make_plus(menv, xs[29], n_9_0)
    _t = msat_make_and(menv,
    ...
    expr16 = msat_make_plus(menv, xs[24], n_8_0)
    ...
    # ltl property: (X ((x_32 - x_25 >= -18) & (X (x_27 - x_24 > -20))))
    ltl = enc.make_X(msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[32], xs[25]), msat_make_number(menv, "-18")), enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[27], xs[24]), msat_make_number(menv, "-20")))))
