...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F (X ((x_20 - x_14 > -19) & (x_23 - x_15 >= 9))))
    ltl = enc.make_F(enc.make_X(msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[20], xs[14]), msat_make_number(menv, "-19")), msat_make_geq(menv, msat_make_minus(menv, xs[23], xs[15]), msat_make_number(menv, "9")))))
