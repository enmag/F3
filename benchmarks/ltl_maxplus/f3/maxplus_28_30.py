...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((X (x_27 - x_6 >= -6)) U (G (x_6 - x_0 >= 10)))
    ltl = enc.make_U(enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[27], xs[6]), msat_make_number(menv, "-6"))), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[6], xs[0]), msat_make_number(menv, "10"))))
