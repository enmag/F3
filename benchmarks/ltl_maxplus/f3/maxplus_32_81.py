...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (! ((! (! ((! (x_24 - x_17 >= 7)) U (! (x_24 - x_27 >= 10))))) U (! (x_24 - x_17 >= 7))))
    ltl = msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_geq(menv, msat_make_minus(menv, xs[24], xs[17]), msat_make_number(menv, "7"))), msat_make_not(menv, msat_make_geq(menv, msat_make_minus(menv, xs[24], xs[27]), msat_make_number(menv, "10")))))), msat_make_not(menv, msat_make_geq(menv, msat_make_minus(menv, xs[24], xs[17]), msat_make_number(menv, "7")))))
