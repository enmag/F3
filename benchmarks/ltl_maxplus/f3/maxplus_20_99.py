...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (X ((x_11 - x_10 > 2) | (G (x_14 - x_1 > 20))))
    ltl = enc.make_X(msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[11], xs[10]), msat_make_number(menv, "2")), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[14], xs[1]), msat_make_number(menv, "20")))))
