...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((G (x_11 - x_6 >= -15)) U (X (x_5 - x_4 > 6)))
    ltl = enc.make_U(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[11], xs[6]), msat_make_number(menv, "-15"))), enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[5], xs[4]), msat_make_number(menv, "6"))))
