...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr15 = msat_make_plus(menv, xs[23], n_5_0)
    ...
    expr15 = msat_make_plus(menv, xs[23], n_17_0)
    ...
    expr11 = msat_make_plus(menv, xs[15], n_17_0)
    expr12 = msat_make_plus(menv, xs[16], n_4_0)
    expr13 = msat_make_plus(menv, xs[17], n_2_0)
    ...
    expr2 = msat_make_plus(menv, xs[11], n_3_0)
    ...
    expr8 = msat_make_plus(menv, xs[25], n_9_0)
    expr9 = msat_make_plus(menv, xs[27], n_7_0)
    expr10 = msat_make_plus(menv, xs[28], n_9_0)
    ...
    expr7 = msat_make_plus(menv, xs[8], n_1_0)
    ...
    # ltl property: (X (X (! ((! (x_14 - x_1 > 18)) U (! (x_34 - x_4 >= 20))))))
    ltl = enc.make_X(enc.make_X(msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[14], xs[1]), msat_make_number(menv, "18"))), msat_make_not(menv, msat_make_geq(menv, msat_make_minus(menv, xs[34], xs[4]), msat_make_number(menv, "20")))))))
