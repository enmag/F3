...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (F (G ((x_10 - x_9 >= -9) & (x_6 - x_9 >= 6))))
    ltl = enc.make_F(enc.make_G(msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[10], xs[9]), msat_make_number(menv, "-9")), msat_make_geq(menv, msat_make_minus(menv, xs[6], xs[9]), msat_make_number(menv, "6")))))
