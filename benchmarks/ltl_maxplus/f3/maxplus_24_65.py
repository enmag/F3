...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (G ((x_16 - x_17 > 14) | (G (x_10 - x_21 > -7))))
    ltl = enc.make_G(msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[16], xs[17]), msat_make_number(menv, "14")), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[10], xs[21]), msat_make_number(menv, "-7")))))
