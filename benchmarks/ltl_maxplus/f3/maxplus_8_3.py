...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F (X ((x_1 - x_3 > 8) & (x_6 - x_2 >= 5))))
    ltl = enc.make_F(enc.make_X(msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[1], xs[3]), msat_make_number(menv, "8")), msat_make_geq(menv, msat_make_minus(menv, xs[6], xs[2]), msat_make_number(menv, "5")))))
