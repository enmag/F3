...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F ((x_8 - x_1 >= 10) & (G (x_6 - x_1 > -9))))
    ltl = enc.make_F(msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[8], xs[1]), msat_make_number(menv, "10")), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[6], xs[1]), msat_make_number(menv, "-9")))))
