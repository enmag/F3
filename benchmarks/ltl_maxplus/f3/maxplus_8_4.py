...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((X (x_1 - x_5 >= -5)) | (G (x_6 - x_3 > 17)))
    ltl = msat_make_or(menv, enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[1], xs[5]), msat_make_number(menv, "-5"))), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[6], xs[3]), msat_make_number(menv, "17"))))
