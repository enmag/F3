...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_5 - x_10 > -17) U ((x_2 - x_10 >= 13) | (x_5 - x_15 > -9)))
    ltl = enc.make_U(msat_make_gt(menv, msat_make_minus(menv, xs[5], xs[10]), msat_make_number(menv, "-17")), msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[2], xs[10]), msat_make_number(menv, "13")), msat_make_gt(menv, msat_make_minus(menv, xs[5], xs[15]), msat_make_number(menv, "-9"))))
