...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr18 = msat_make_plus(menv, xs[30], n_12_0)
    expr19 = msat_make_plus(menv, xs[31], n_18_0)
    _t = msat_make_and(menv,
    ...
    expr0 = msat_make_plus(menv, xs[5], n_4_0)
    expr1 = msat_make_plus(menv, xs[11], n_10_0)
    expr2 = msat_make_plus(menv, xs[12], n_2_0)
    expr3 = msat_make_plus(menv, xs[14], n_7_0)
    ...
    expr7 = msat_make_plus(menv, xs[7], n_19_0)
    ...
    expr10 = msat_make_plus(menv, xs[25], n_14_0)
    ...
    # ltl property: ((x_17 - x_15 > 11) | (X (G (x_34 - x_1 >= -15))))
    ltl = msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[17], xs[15]), msat_make_number(menv, "11")), enc.make_X(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[34], xs[1]), msat_make_number(menv, "-15")))))
