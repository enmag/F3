...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((X (X (x_9 - x_14 >= -8))) U (x_13 - x_19 > 6))
    ltl = enc.make_U(enc.make_X(enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[9], xs[14]), msat_make_number(menv, "-8")))), msat_make_gt(menv, msat_make_minus(menv, xs[13], xs[19]), msat_make_number(menv, "6")))
