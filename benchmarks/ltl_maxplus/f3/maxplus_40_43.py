...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr12 = msat_make_plus(menv, xs[17], n_17_0)
    expr13 = msat_make_plus(menv, xs[19], n_5_0)
    ...
    expr10 = msat_make_plus(menv, xs[13], n_14_0)
    ...
    expr12 = msat_make_plus(menv, xs[17], n_15_0)
    expr13 = msat_make_plus(menv, xs[18], n_2_0)
    expr14 = msat_make_plus(menv, xs[19], n_16_0)
    expr15 = msat_make_plus(menv, xs[24], n_15_0)
    expr16 = msat_make_plus(menv, xs[25], n_7_0)
    expr17 = msat_make_plus(menv, xs[29], n_1_0)
    ...
    # ltl property: ((X (x_21 - x_10 >= 8)) & (G (x_20 - x_17 > -15)))
    ltl = msat_make_and(menv, enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[21], xs[10]), msat_make_number(menv, "8"))), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[20], xs[17]), msat_make_number(menv, "-15"))))
