...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_3 - x_0 >= 14) U ((x_1 - x_0 >= -9) | (x_5 - x_7 >= -10)))
    ltl = enc.make_U(msat_make_geq(menv, msat_make_minus(menv, xs[3], xs[0]), msat_make_number(menv, "14")), msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[1], xs[0]), msat_make_number(menv, "-9")), msat_make_geq(menv, msat_make_minus(menv, xs[5], xs[7]), msat_make_number(menv, "-10"))))
