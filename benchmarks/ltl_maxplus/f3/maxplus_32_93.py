...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (F (X (F (G (x_26 - x_28 > -8)))))
    ltl = enc.make_F(enc.make_X(enc.make_F(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[26], xs[28]), msat_make_number(menv, "-8"))))))
