...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((G (x_10 - x_9 >= -5)) & (F (x_9 - x_14 > 9)))
    ltl = msat_make_and(menv, enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[10], xs[9]), msat_make_number(menv, "-5"))), enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[9], xs[14]), msat_make_number(menv, "9"))))
