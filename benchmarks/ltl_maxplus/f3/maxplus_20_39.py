...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F (G ((x_11 - x_8 > -14) & (x_3 - x_12 >= -11))))
    ltl = enc.make_F(enc.make_G(msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[11], xs[8]), msat_make_number(menv, "-14")), msat_make_geq(menv, msat_make_minus(menv, xs[3], xs[12]), msat_make_number(menv, "-11")))))
