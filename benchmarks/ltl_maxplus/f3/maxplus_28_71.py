...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_22 - x_27 >= -20) & (G (F (x_2 - x_24 >= 20))))
    ltl = msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[22], xs[27]), msat_make_number(menv, "-20")), enc.make_G(enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[2], xs[24]), msat_make_number(menv, "20")))))
