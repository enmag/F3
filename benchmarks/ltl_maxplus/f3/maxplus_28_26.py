...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_5 - x_2 > -12) | ((x_9 - x_20 > -10) & (x_7 - x_6 > -17)))
    ltl = msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[5], xs[2]), msat_make_number(menv, "-12")), msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[9], xs[20]), msat_make_number(menv, "-10")), msat_make_gt(menv, msat_make_minus(menv, xs[7], xs[6]), msat_make_number(menv, "-17"))))
