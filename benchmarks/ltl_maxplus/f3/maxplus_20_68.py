...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_13 - x_19 >= 5) & (F (G (x_18 - x_16 > 4))))
    ltl = msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[13], xs[19]), msat_make_number(menv, "5")), enc.make_F(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[18], xs[16]), msat_make_number(menv, "4")))))
