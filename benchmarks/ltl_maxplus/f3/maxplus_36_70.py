...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr4 = msat_make_plus(menv, xs[15], n_17_0)
    ...
    expr0 = msat_make_plus(menv, xs[6], n_20_0)
    ...
    expr2 = msat_make_plus(menv, xs[15], n_19_0)
    expr3 = msat_make_plus(menv, xs[16], n_19_0)
    expr4 = msat_make_plus(menv, xs[17], n_11_0)
    expr5 = msat_make_plus(menv, xs[20], n_6_0)
    expr6 = msat_make_plus(menv, xs[21], n_6_0)
    ...
    # ltl property: (G (! ((! (x_26 - x_18 > -18)) U (! (X (x_31 - x_16 >= 13))))))
    ltl = enc.make_G(msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[26], xs[18]), msat_make_number(menv, "-18"))), msat_make_not(menv, enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[31], xs[16]), msat_make_number(menv, "13")))))))
