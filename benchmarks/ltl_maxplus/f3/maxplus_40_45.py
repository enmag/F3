...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr9 = msat_make_plus(menv, xs[11], n_13_0)
    expr10 = msat_make_plus(menv, xs[12], n_19_0)
    ...
    expr11 = msat_make_plus(menv, xs[29], n_20_0)
    ...
    expr19 = msat_make_plus(menv, xs[34], n_11_0)
    _t = msat_make_and(menv,
    ...
    expr5 = msat_make_plus(menv, xs[19], n_17_0)
    expr6 = msat_make_plus(menv, xs[21], n_10_0)
    expr7 = msat_make_plus(menv, xs[22], n_4_0)
    expr8 = msat_make_plus(menv, xs[23], n_14_0)
    ...
    expr19 = msat_make_plus(menv, xs[33], n_17_0)
    _t = msat_make_and(menv,
    ...
    # ltl property: ((G (x_20 - x_14 >= 6)) U (G (x_14 - x_5 >= 11)))
    ltl = enc.make_U(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[20], xs[14]), msat_make_number(menv, "6"))), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[14], xs[5]), msat_make_number(menv, "11"))))
