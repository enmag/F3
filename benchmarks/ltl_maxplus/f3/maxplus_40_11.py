...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr1 = msat_make_plus(menv, xs[8], n_6_0)
    ...
    expr14 = msat_make_plus(menv, xs[21], n_5_0)
    expr15 = msat_make_plus(menv, xs[22], n_3_0)
    expr16 = msat_make_plus(menv, xs[25], n_10_0)
    expr17 = msat_make_plus(menv, xs[26], n_5_0)
    ...
    expr16 = msat_make_plus(menv, xs[26], n_7_0)
    expr17 = msat_make_plus(menv, xs[28], n_17_0)
    expr18 = msat_make_plus(menv, xs[30], n_15_0)
    expr19 = msat_make_plus(menv, xs[34], n_2_0)
    _t = msat_make_and(menv,
    ...
    # ltl property: (F ((x_35 - x_2 > 3) U (G (x_6 - x_23 >= 5))))
    ltl = enc.make_F(enc.make_U(msat_make_gt(menv, msat_make_minus(menv, xs[35], xs[2]), msat_make_number(menv, "3")), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[6], xs[23]), msat_make_number(menv, "5")))))
