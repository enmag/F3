...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((G (x_11 - x_4 >= 5)) U (G (x_16 - x_22 >= 19)))
    ltl = enc.make_U(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[11], xs[4]), msat_make_number(menv, "5"))), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[16], xs[22]), msat_make_number(menv, "19"))))
