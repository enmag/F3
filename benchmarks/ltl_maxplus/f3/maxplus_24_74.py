...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_21 - x_10 > 16) & (F (G (x_3 - x_17 >= -4))))
    ltl = msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[21], xs[10]), msat_make_number(menv, "16")), enc.make_F(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[3], xs[17]), msat_make_number(menv, "-4")))))
