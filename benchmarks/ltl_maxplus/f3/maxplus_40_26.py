...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr1 = msat_make_plus(menv, xs[10], n_11_0)
    ...
    # ltl property: ((x_27 - x_21 > 7) | ((x_35 - x_28 > -17) & (x_35 - x_21 >= 8)))
    ltl = msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[27], xs[21]), msat_make_number(menv, "7")), msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[35], xs[28]), msat_make_number(menv, "-17")), msat_make_geq(menv, msat_make_minus(menv, xs[35], xs[21]), msat_make_number(menv, "8"))))
