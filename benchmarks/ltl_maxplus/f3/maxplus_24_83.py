...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_20 - x_12 >= 2) & ((x_14 - x_13 >= 1) U (x_1 - x_12 > -2)))
    ltl = msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[20], xs[12]), msat_make_number(menv, "2")), enc.make_U(msat_make_geq(menv, msat_make_minus(menv, xs[14], xs[13]), msat_make_number(menv, "1")), msat_make_gt(menv, msat_make_minus(menv, xs[1], xs[12]), msat_make_number(menv, "-2"))))
