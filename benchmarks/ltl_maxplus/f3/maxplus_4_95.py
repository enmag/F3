...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (((x_2 - x_1 >= 13) | (x_3 - x_0 >= 8)) U (x_3 - x_1 > -20))
    ltl = enc.make_U(msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[2], xs[1]), msat_make_number(menv, "13")), msat_make_geq(menv, msat_make_minus(menv, xs[3], xs[0]), msat_make_number(menv, "8"))), msat_make_gt(menv, msat_make_minus(menv, xs[3], xs[1]), msat_make_number(menv, "-20")))
