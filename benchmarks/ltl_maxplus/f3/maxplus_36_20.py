...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_32 - x_14 >= -5) | (X (F (x_0 - x_3 > 10))))
    ltl = msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[32], xs[14]), msat_make_number(menv, "-5")), enc.make_X(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[0], xs[3]), msat_make_number(menv, "10")))))
