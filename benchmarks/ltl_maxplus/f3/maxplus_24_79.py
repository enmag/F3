...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F ((x_7 - x_22 >= 17) & (G (x_10 - x_13 >= 20))))
    ltl = enc.make_F(msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[7], xs[22]), msat_make_number(menv, "17")), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[10], xs[13]), msat_make_number(menv, "20")))))
