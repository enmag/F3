...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr13 = msat_make_plus(menv, xs[19], n_16_0)
    expr14 = msat_make_plus(menv, xs[20], n_10_0)
    expr15 = msat_make_plus(menv, xs[21], n_10_0)
    ...
    expr0 = msat_make_plus(menv, xs[11], n_6_0)
    expr1 = msat_make_plus(menv, xs[12], n_3_0)
    expr2 = msat_make_plus(menv, xs[13], n_6_0)
    expr3 = msat_make_plus(menv, xs[14], n_3_0)
    ...
    expr12 = msat_make_plus(menv, xs[16], n_12_0)
    ...
    # ltl property: (F (G ((x_22 - x_20 > -1) & (x_16 - x_19 > -20))))
    ltl = enc.make_F(enc.make_G(msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[22], xs[20]), msat_make_number(menv, "-1")), msat_make_gt(menv, msat_make_minus(menv, xs[16], xs[19]), msat_make_number(menv, "-20")))))
