...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (X ((F (x_3 - x_6 >= 12)) U (x_2 - x_5 > -12)))
    ltl = enc.make_X(enc.make_U(enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[3], xs[6]), msat_make_number(menv, "12"))), msat_make_gt(menv, msat_make_minus(menv, xs[2], xs[5]), msat_make_number(menv, "-12"))))
