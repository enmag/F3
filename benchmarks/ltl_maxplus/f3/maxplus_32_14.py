...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (X ((G (x_3 - x_10 > 2)) U (x_28 - x_7 > 10)))
    ltl = enc.make_X(enc.make_U(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[3], xs[10]), msat_make_number(menv, "2"))), msat_make_gt(menv, msat_make_minus(menv, xs[28], xs[7]), msat_make_number(menv, "10"))))
