...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((F (x_6 - x_2 > 16)) U (G (x_2 - x_5 >= 0)))
    ltl = enc.make_U(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[6], xs[2]), msat_make_number(menv, "16"))), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[2], xs[5]), msat_make_number(menv, "0"))))
