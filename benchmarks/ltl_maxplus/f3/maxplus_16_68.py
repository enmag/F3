...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_15 - x_9 > 20) & (F (G (x_3 - x_8 > 14))))
    ltl = msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[15], xs[9]), msat_make_number(menv, "20")), enc.make_F(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[3], xs[8]), msat_make_number(menv, "14")))))
