...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_0 - x_4 > 4) | ((x_2 - x_3 >= 6) & (x_2 - x_7 >= 2)))
    ltl = msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[0], xs[4]), msat_make_number(menv, "4")), msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[2], xs[3]), msat_make_number(menv, "6")), msat_make_geq(menv, msat_make_minus(menv, xs[2], xs[7]), msat_make_number(menv, "2"))))
