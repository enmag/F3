...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_1 - x_3 > -16) U ((x_3 - x_1 > 13) & (x_2 - x_0 >= 18)))
    ltl = enc.make_U(msat_make_gt(menv, msat_make_minus(menv, xs[1], xs[3]), msat_make_number(menv, "-16")), msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[3], xs[1]), msat_make_number(menv, "13")), msat_make_geq(menv, msat_make_minus(menv, xs[2], xs[0]), msat_make_number(menv, "18"))))
