...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr5 = msat_make_plus(menv, xs[20], n_11_0)
    expr6 = msat_make_plus(menv, xs[22], n_8_0)
    expr7 = msat_make_plus(menv, xs[23], n_10_0)
    expr8 = msat_make_plus(menv, xs[25], n_13_0)
    expr9 = msat_make_plus(menv, xs[27], n_20_0)
    expr10 = msat_make_plus(menv, xs[28], n_16_0)
    ...
    expr0 = msat_make_plus(menv, xs[2], n_19_0)
    expr1 = msat_make_plus(menv, xs[9], n_18_0)
    ...
    # ltl property: (G ((G (x_28 - x_27 >= 14)) U (x_4 - x_29 >= -20)))
    ltl = enc.make_G(enc.make_U(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[28], xs[27]), msat_make_number(menv, "14"))), msat_make_geq(menv, msat_make_minus(menv, xs[4], xs[29]), msat_make_number(menv, "-20"))))
