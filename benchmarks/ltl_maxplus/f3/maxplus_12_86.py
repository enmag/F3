...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_4 - x_3 >= 8) & (G (F (x_8 - x_6 > -13))))
    ltl = msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[4], xs[3]), msat_make_number(menv, "8")), enc.make_G(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[8], xs[6]), msat_make_number(menv, "-13")))))
