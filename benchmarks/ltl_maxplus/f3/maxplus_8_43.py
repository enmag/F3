...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((X (x_7 - x_4 > 20)) & (G (x_7 - x_4 > -11)))
    ltl = msat_make_and(menv, enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[7], xs[4]), msat_make_number(menv, "20"))), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[7], xs[4]), msat_make_number(menv, "-11"))))
