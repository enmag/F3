...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr15 = msat_make_plus(menv, xs[25], n_2_0)
    ...
    expr0 = msat_make_plus(menv, xs[4], n_19_0)
    expr1 = msat_make_plus(menv, xs[8], n_11_0)
    ...
    expr7 = msat_make_plus(menv, xs[23], n_1_0)
    expr8 = msat_make_plus(menv, xs[24], n_11_0)
    expr9 = msat_make_plus(menv, xs[25], n_9_0)
    ...
    # ltl property: (F (G ((x_34 - x_8 >= 5) & (x_36 - x_35 >= -1))))
    ltl = enc.make_F(enc.make_G(msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[34], xs[8]), msat_make_number(menv, "5")), msat_make_geq(menv, msat_make_minus(menv, xs[36], xs[35]), msat_make_number(menv, "-1")))))
