...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_0 - x_22 > 9) | (G (F (x_23 - x_2 >= 10))))
    ltl = msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[0], xs[22]), msat_make_number(menv, "9")), enc.make_G(enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[23], xs[2]), msat_make_number(menv, "10")))))
