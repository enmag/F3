...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (F ((x_25 - x_14 >= -13) | (G (x_29 - x_2 > -3))))
    ltl = enc.make_F(msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[25], xs[14]), msat_make_number(menv, "-13")), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[29], xs[2]), msat_make_number(menv, "-3")))))
