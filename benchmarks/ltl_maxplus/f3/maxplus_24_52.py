...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (! ((! (x_9 - x_7 > 10)) U (! (G (F (x_4 - x_6 >= 14))))))
    ltl = msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[9], xs[7]), msat_make_number(menv, "10"))), msat_make_not(menv, enc.make_G(enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[4], xs[6]), msat_make_number(menv, "14")))))))
