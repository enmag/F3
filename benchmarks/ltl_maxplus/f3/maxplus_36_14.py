...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr12 = msat_make_plus(menv, xs[18], n_19_0)
    ...
    # ltl property: (X ((G (x_28 - x_8 > -7)) U (x_12 - x_35 >= 3)))
    ltl = enc.make_X(enc.make_U(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[28], xs[8]), msat_make_number(menv, "-7"))), msat_make_geq(menv, msat_make_minus(menv, xs[12], xs[35]), msat_make_number(menv, "3"))))
