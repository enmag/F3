...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr15 = msat_make_plus(menv, xs[23], n_7_0)
    ...
    expr9 = msat_make_plus(menv, xs[11], n_14_0)
    ...
    expr14 = msat_make_plus(menv, xs[21], n_2_0)
    ...
    # ltl property: ((X (x_33 - x_14 >= -3)) & (G (x_18 - x_22 > -14)))
    ltl = msat_make_and(menv, enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[33], xs[14]), msat_make_number(menv, "-3"))), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[18], xs[22]), msat_make_number(menv, "-14"))))
