...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr18 = msat_make_plus(menv, xs[31], n_18_0)
    ...
    expr9 = msat_make_plus(menv, xs[26], n_2_0)
    expr10 = msat_make_plus(menv, xs[27], n_6_0)
    expr11 = msat_make_plus(menv, xs[29], n_7_0)
    expr12 = msat_make_plus(menv, xs[30], n_1_0)
    expr13 = msat_make_plus(menv, xs[31], n_19_0)
    ...
    expr12 = msat_make_plus(menv, xs[17], n_10_0)
    expr13 = msat_make_plus(menv, xs[18], n_19_0)
    expr14 = msat_make_plus(menv, xs[20], n_20_0)
    expr15 = msat_make_plus(menv, xs[25], n_10_0)
    ...
    expr7 = msat_make_plus(menv, xs[24], n_11_0)
    expr8 = msat_make_plus(menv, xs[25], n_3_0)
    ...
    expr8 = msat_make_plus(menv, xs[25], n_16_0)
    expr9 = msat_make_plus(menv, xs[26], n_16_0)
    expr10 = msat_make_plus(menv, xs[30], n_18_0)
    expr11 = msat_make_plus(menv, xs[31], n_19_0)
    expr12 = msat_make_plus(menv, xs[32], n_17_0)
    expr13 = msat_make_plus(menv, xs[33], n_6_0)
    expr14 = msat_make_plus(menv, xs[34], n_15_0)
    expr15 = msat_make_plus(menv, xs[35], n_7_0)
    ...
    expr3 = msat_make_plus(menv, xs[12], n_18_0)
    ...
    expr9 = msat_make_plus(menv, xs[12], n_2_0)
    ...
    expr0 = msat_make_plus(menv, xs[7], n_13_0)
    ...
    expr8 = msat_make_plus(menv, xs[9], n_20_0)
    expr9 = msat_make_plus(menv, xs[11], n_1_0)
    ...
    # ltl property: (! ((! (x_35 - x_30 >= -18)) U (! (X (X (x_17 - x_19 >= -3))))))
    ltl = msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_geq(menv, msat_make_minus(menv, xs[35], xs[30]), msat_make_number(menv, "-18"))), msat_make_not(menv, enc.make_X(enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[17], xs[19]), msat_make_number(menv, "-3")))))))
