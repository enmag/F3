...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (G ((x_2 - x_0 > -18) | (G (x_2 - x_0 >= -1))))
    ltl = enc.make_G(msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[2], xs[0]), msat_make_number(menv, "-18")), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[2], xs[0]), msat_make_number(menv, "-1")))))
