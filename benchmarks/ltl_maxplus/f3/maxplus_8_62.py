...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((X (X (x_2 - x_3 >= 7))) U (x_3 - x_0 > 19))
    ltl = enc.make_U(enc.make_X(enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[2], xs[3]), msat_make_number(menv, "7")))), msat_make_gt(menv, msat_make_minus(menv, xs[3], xs[0]), msat_make_number(menv, "19")))
