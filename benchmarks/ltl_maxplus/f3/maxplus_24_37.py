...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_1 - x_0 > -15) | ((x_21 - x_13 >= -9) & (x_12 - x_0 > -4)))
    ltl = msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[1], xs[0]), msat_make_number(menv, "-15")), msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[21], xs[13]), msat_make_number(menv, "-9")), msat_make_gt(menv, msat_make_minus(menv, xs[12], xs[0]), msat_make_number(menv, "-4"))))
