...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_11 - x_4 > -17) & (G (F (x_7 - x_9 > 3))))
    ltl = msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[11], xs[4]), msat_make_number(menv, "-17")), enc.make_G(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[7], xs[9]), msat_make_number(menv, "3")))))
