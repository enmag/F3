...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr0 = msat_make_plus(menv, xs[8], n_13_0)
    ...
    # ltl property: (((x_13 - x_6 >= -10) | (x_7 - x_22 > -11)) U (x_0 - x_19 > -11))
    ltl = enc.make_U(msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[13], xs[6]), msat_make_number(menv, "-10")), msat_make_gt(menv, msat_make_minus(menv, xs[7], xs[22]), msat_make_number(menv, "-11"))), msat_make_gt(menv, msat_make_minus(menv, xs[0], xs[19]), msat_make_number(menv, "-11")))
