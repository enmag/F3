...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (F ((X (x_0 - x_3 >= 15)) U (x_12 - x_17 > -2)))
    ltl = enc.make_F(enc.make_U(enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[0], xs[3]), msat_make_number(menv, "15"))), msat_make_gt(menv, msat_make_minus(menv, xs[12], xs[17]), msat_make_number(menv, "-2"))))
