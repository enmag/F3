...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr7 = msat_make_plus(menv, xs[8], n_4_0)
    ...
    # ltl property: ((x_28 - x_16 >= -1) U ((x_0 - x_3 >= 10) & (x_27 - x_12 > 10)))
    ltl = enc.make_U(msat_make_geq(menv, msat_make_minus(menv, xs[28], xs[16]), msat_make_number(menv, "-1")), msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[0], xs[3]), msat_make_number(menv, "10")), msat_make_gt(menv, msat_make_minus(menv, xs[27], xs[12]), msat_make_number(menv, "10"))))
