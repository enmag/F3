...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F ((F (x_12 - x_7 > 8)) U (x_22 - x_20 > -8)))
    ltl = enc.make_F(enc.make_U(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[12], xs[7]), msat_make_number(menv, "8"))), msat_make_gt(menv, msat_make_minus(menv, xs[22], xs[20]), msat_make_number(menv, "-8"))))
