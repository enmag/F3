...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F (! ((! (x_12 - x_6 > -4)) U (! (X (x_2 - x_18 > -10))))))
    ltl = enc.make_F(msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[12], xs[6]), msat_make_number(menv, "-4"))), msat_make_not(menv, enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[2], xs[18]), msat_make_number(menv, "-10")))))))
