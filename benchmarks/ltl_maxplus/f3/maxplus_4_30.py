...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((X (x_3 - x_1 >= -20)) U (G (x_2 - x_1 >= 10)))
    ltl = enc.make_U(enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[3], xs[1]), msat_make_number(menv, "-20"))), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[2], xs[1]), msat_make_number(menv, "10"))))
