...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((X (X (x_9 - x_11 >= 0))) U (x_4 - x_8 > 20))
    ltl = enc.make_U(enc.make_X(enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[9], xs[11]), msat_make_number(menv, "0")))), msat_make_gt(menv, msat_make_minus(menv, xs[4], xs[8]), msat_make_number(menv, "20")))
