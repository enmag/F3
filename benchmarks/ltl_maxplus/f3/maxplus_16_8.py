...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((G (x_0 - x_10 >= -4)) U (X (x_9 - x_0 >= -20)))
    ltl = enc.make_U(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[0], xs[10]), msat_make_number(menv, "-4"))), enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[9], xs[0]), msat_make_number(menv, "-20"))))
