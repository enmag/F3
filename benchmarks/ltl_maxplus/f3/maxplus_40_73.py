...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr0 = msat_make_plus(menv, xs[4], n_11_0)
    expr1 = msat_make_plus(menv, xs[5], n_3_0)
    ...
    expr17 = msat_make_plus(menv, xs[29], n_7_0)
    ...
    expr9 = msat_make_plus(menv, xs[12], n_4_0)
    expr10 = msat_make_plus(menv, xs[13], n_7_0)
    ...
    expr18 = msat_make_plus(menv, xs[30], n_14_0)
    ...
    expr0 = msat_make_plus(menv, xs[7], n_20_0)
    ...
    expr11 = msat_make_plus(menv, xs[28], n_6_0)
    expr12 = msat_make_plus(menv, xs[31], n_10_0)
    ...
    expr12 = msat_make_plus(menv, xs[27], n_9_0)
    expr13 = msat_make_plus(menv, xs[33], n_17_0)
    ...
    # ltl property: ((X (X (x_17 - x_38 >= -1))) U (x_16 - x_29 > -14))
    ltl = enc.make_U(enc.make_X(enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[17], xs[38]), msat_make_number(menv, "-1")))), msat_make_gt(menv, msat_make_minus(menv, xs[16], xs[29]), msat_make_number(menv, "-14")))
