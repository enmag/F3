...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (G ((G (x_14 - x_4 >= 14)) U (x_5 - x_7 >= 12)))
    ltl = enc.make_G(enc.make_U(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[14], xs[4]), msat_make_number(menv, "14"))), msat_make_geq(menv, msat_make_minus(menv, xs[5], xs[7]), msat_make_number(menv, "12"))))
