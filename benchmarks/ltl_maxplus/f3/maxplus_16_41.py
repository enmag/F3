...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_15 - x_12 > 13) U ((x_15 - x_0 > -20) U (x_10 - x_5 > 7)))
    ltl = enc.make_U(msat_make_gt(menv, msat_make_minus(menv, xs[15], xs[12]), msat_make_number(menv, "13")), enc.make_U(msat_make_gt(menv, msat_make_minus(menv, xs[15], xs[0]), msat_make_number(menv, "-20")), msat_make_gt(menv, msat_make_minus(menv, xs[10], xs[5]), msat_make_number(menv, "7"))))
