...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_3 - x_1 >= -9) | (X (F (x_2 - x_0 > 18))))
    ltl = msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[3], xs[1]), msat_make_number(menv, "-9")), enc.make_X(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[2], xs[0]), msat_make_number(menv, "18")))))
