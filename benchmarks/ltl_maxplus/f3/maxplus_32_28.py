...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr9 = msat_make_plus(menv, xs[10], n_14_0)
    expr10 = msat_make_plus(menv, xs[11], n_19_0)
    ...
    # ltl property: (X ((x_27 - x_29 > 5) & (G (x_17 - x_15 >= -3))))
    ltl = enc.make_X(msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[27], xs[29]), msat_make_number(menv, "5")), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[17], xs[15]), msat_make_number(menv, "-3")))))
