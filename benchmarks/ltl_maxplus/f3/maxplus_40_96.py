...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr7 = msat_make_plus(menv, xs[22], n_8_0)
    expr8 = msat_make_plus(menv, xs[24], n_18_0)
    expr9 = msat_make_plus(menv, xs[27], n_5_0)
    expr10 = msat_make_plus(menv, xs[28], n_20_0)
    ...
    expr1 = msat_make_plus(menv, xs[9], n_8_0)
    ...
    expr14 = msat_make_plus(menv, xs[20], n_13_0)
    expr15 = msat_make_plus(menv, xs[21], n_14_0)
    ...
    expr16 = msat_make_plus(menv, xs[28], n_11_0)
    ...
    expr11 = msat_make_plus(menv, xs[15], n_2_0)
    expr12 = msat_make_plus(menv, xs[18], n_4_0)
    expr13 = msat_make_plus(menv, xs[19], n_7_0)
    expr14 = msat_make_plus(menv, xs[21], n_20_0)
    expr15 = msat_make_plus(menv, xs[22], n_16_0)
    expr16 = msat_make_plus(menv, xs[23], n_11_0)
    expr17 = msat_make_plus(menv, xs[24], n_8_0)
    expr18 = msat_make_plus(menv, xs[28], n_14_0)
    expr19 = msat_make_plus(menv, xs[38], n_18_0)
    _t = msat_make_and(menv,
    ...
    expr17 = msat_make_plus(menv, xs[29], n_12_0)
    ...
    expr12 = msat_make_plus(menv, xs[17], n_11_0)
    ...
    # ltl property: (X (F (G (X (x_20 - x_35 >= -13)))))
    ltl = enc.make_X(enc.make_F(enc.make_G(enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[20], xs[35]), msat_make_number(menv, "-13"))))))
