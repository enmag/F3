...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_11 - x_8 > 1) & ((x_11 - x_7 >= -7) U (x_4 - x_7 >= -13)))
    ltl = msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[11], xs[8]), msat_make_number(menv, "1")), enc.make_U(msat_make_geq(menv, msat_make_minus(menv, xs[11], xs[7]), msat_make_number(menv, "-7")), msat_make_geq(menv, msat_make_minus(menv, xs[4], xs[7]), msat_make_number(menv, "-13"))))
