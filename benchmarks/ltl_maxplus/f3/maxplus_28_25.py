...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((G (x_13 - x_5 > 15)) & (F (x_18 - x_2 > 1)))
    ltl = msat_make_and(menv, enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[13], xs[5]), msat_make_number(menv, "15"))), enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[18], xs[2]), msat_make_number(menv, "1"))))
