...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F ((x_25 - x_5 > 10) & (G (x_1 - x_4 >= -7))))
    ltl = enc.make_F(msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[25], xs[5]), msat_make_number(menv, "10")), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[1], xs[4]), msat_make_number(menv, "-7")))))
