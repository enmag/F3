...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_8 - x_20 >= -6) | ((x_5 - x_23 > -10) & (x_22 - x_17 >= -18)))
    ltl = msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[8], xs[20]), msat_make_number(menv, "-6")), msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[5], xs[23]), msat_make_number(menv, "-10")), msat_make_geq(menv, msat_make_minus(menv, xs[22], xs[17]), msat_make_number(menv, "-18"))))
