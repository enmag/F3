...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F (X ((x_13 - x_6 >= -1) | (x_14 - x_7 >= 2))))
    ltl = enc.make_F(enc.make_X(msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[13], xs[6]), msat_make_number(menv, "-1")), msat_make_geq(menv, msat_make_minus(menv, xs[14], xs[7]), msat_make_number(menv, "2")))))
