...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr10 = msat_make_plus(menv, xs[13], n_2_0)
    ...
    # ltl property: (F (X ((x_14 - x_11 >= 8) | (x_30 - x_11 > 17))))
    ltl = enc.make_F(enc.make_X(msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[14], xs[11]), msat_make_number(menv, "8")), msat_make_gt(menv, msat_make_minus(menv, xs[30], xs[11]), msat_make_number(menv, "17")))))
