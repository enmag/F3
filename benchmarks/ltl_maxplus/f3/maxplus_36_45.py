...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr5 = msat_make_plus(menv, xs[5], n_19_0)
    expr6 = msat_make_plus(menv, xs[6], n_11_0)
    ...
    # ltl property: ((G (x_19 - x_8 >= 8)) U (G (x_19 - x_7 >= 15)))
    ltl = enc.make_U(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[19], xs[8]), msat_make_number(menv, "8"))), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[19], xs[7]), msat_make_number(menv, "15"))))
