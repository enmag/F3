...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_6 - x_5 > -12) & (X (F (x_5 - x_0 >= 7))))
    ltl = msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[6], xs[5]), msat_make_number(menv, "-12")), enc.make_X(enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[5], xs[0]), msat_make_number(menv, "7")))))
