...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (X ((x_1 - x_3 > -10) & (X (x_1 - x_3 > 16))))
    ltl = enc.make_X(msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[1], xs[3]), msat_make_number(menv, "-10")), enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[1], xs[3]), msat_make_number(menv, "16")))))
