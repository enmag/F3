...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((X (X (x_1 - x_2 >= 11))) U (x_1 - x_2 > 15))
    ltl = enc.make_U(enc.make_X(enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[1], xs[2]), msat_make_number(menv, "11")))), msat_make_gt(menv, msat_make_minus(menv, xs[1], xs[2]), msat_make_number(menv, "15")))
