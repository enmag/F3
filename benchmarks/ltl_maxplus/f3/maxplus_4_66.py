...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_1 - x_0 >= -19) | ((x_3 - x_0 >= 13) & (x_2 - x_1 >= -17)))
    ltl = msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[1], xs[0]), msat_make_number(menv, "-19")), msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[3], xs[0]), msat_make_number(menv, "13")), msat_make_geq(menv, msat_make_minus(menv, xs[2], xs[1]), msat_make_number(menv, "-17"))))
