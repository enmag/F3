...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr15 = msat_make_plus(menv, xs[23], n_8_0)
    expr16 = msat_make_plus(menv, xs[25], n_6_0)
    expr17 = msat_make_plus(menv, xs[26], n_1_0)
    _t = msat_make_and(menv,
    ...
    expr1 = msat_make_plus(menv, xs[10], n_13_0)
    ...
    expr9 = msat_make_plus(menv, xs[26], n_3_0)
    ...
    # ltl property: (X (F (G (X (x_34 - x_22 >= -4)))))
    ltl = enc.make_X(enc.make_F(enc.make_G(enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[34], xs[22]), msat_make_number(menv, "-4"))))))
