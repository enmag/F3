...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (X ((x_10 - x_4 > 13) | (X (x_2 - x_4 >= 2))))
    ltl = enc.make_X(msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[10], xs[4]), msat_make_number(menv, "13")), enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[2], xs[4]), msat_make_number(menv, "2")))))
