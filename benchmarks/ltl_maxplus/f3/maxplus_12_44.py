...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (X ((x_9 - x_6 > 13) U (G (x_4 - x_1 > -11))))
    ltl = enc.make_X(enc.make_U(msat_make_gt(menv, msat_make_minus(menv, xs[9], xs[6]), msat_make_number(menv, "13")), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[4], xs[1]), msat_make_number(menv, "-11")))))
