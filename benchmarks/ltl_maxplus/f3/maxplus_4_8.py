...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((G (x_0 - x_3 >= 5)) U (X (x_0 - x_2 >= -13)))
    ltl = enc.make_U(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[0], xs[3]), msat_make_number(menv, "5"))), enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[0], xs[2]), msat_make_number(menv, "-13"))))
