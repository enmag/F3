...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (((x_18 - x_11 >= -14) | (x_27 - x_24 > 5)) U (x_7 - x_15 >= 15))
    ltl = enc.make_U(msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[18], xs[11]), msat_make_number(menv, "-14")), msat_make_gt(menv, msat_make_minus(menv, xs[27], xs[24]), msat_make_number(menv, "5"))), msat_make_geq(menv, msat_make_minus(menv, xs[7], xs[15]), msat_make_number(menv, "15")))
