...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_19 - x_1 >= 17) | ((x_27 - x_15 >= 17) & (x_20 - x_6 >= -12)))
    ltl = msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[19], xs[1]), msat_make_number(menv, "17")), msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[27], xs[15]), msat_make_number(menv, "17")), msat_make_geq(menv, msat_make_minus(menv, xs[20], xs[6]), msat_make_number(menv, "-12"))))
