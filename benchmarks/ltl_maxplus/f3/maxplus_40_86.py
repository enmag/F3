...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr7 = msat_make_plus(menv, xs[9], n_15_0)
    ...
    # ltl property: ((x_24 - x_36 > 0) & (G (F (x_27 - x_26 > -6))))
    ltl = msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[24], xs[36]), msat_make_number(menv, "0")), enc.make_G(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[27], xs[26]), msat_make_number(menv, "-6")))))
