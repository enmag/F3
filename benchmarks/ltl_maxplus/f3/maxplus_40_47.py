...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr9 = msat_make_plus(menv, xs[14], n_4_0)
    ...
    expr14 = msat_make_plus(menv, xs[21], n_17_0)
    expr15 = msat_make_plus(menv, xs[23], n_2_0)
    ...
    expr1 = msat_make_plus(menv, xs[8], n_14_0)
    ...
    expr14 = msat_make_plus(menv, xs[22], n_17_0)
    ...
    expr4 = msat_make_plus(menv, xs[4], n_6_0)
    expr5 = msat_make_plus(menv, xs[6], n_5_0)
    ...
    expr7 = msat_make_plus(menv, xs[23], n_8_0)
    expr8 = msat_make_plus(menv, xs[25], n_7_0)
    expr9 = msat_make_plus(menv, xs[26], n_6_0)
    expr10 = msat_make_plus(menv, xs[27], n_1_0)
    expr11 = msat_make_plus(menv, xs[28], n_3_0)
    expr12 = msat_make_plus(menv, xs[30], n_14_0)
    expr13 = msat_make_plus(menv, xs[32], n_11_0)
    expr14 = msat_make_plus(menv, xs[34], n_10_0)
    expr15 = msat_make_plus(menv, xs[35], n_8_0)
    ...
    expr4 = msat_make_plus(menv, xs[13], n_18_0)
    expr5 = msat_make_plus(menv, xs[14], n_20_0)
    expr6 = msat_make_plus(menv, xs[19], n_14_0)
    ...
    expr3 = msat_make_plus(menv, xs[11], n_14_0)
    ...
    expr8 = msat_make_plus(menv, xs[21], n_20_0)
    ...
    expr10 = msat_make_plus(menv, xs[14], n_3_0)
    ...
    expr19 = msat_make_plus(menv, xs[33], n_5_0)
    _t = msat_make_and(menv,
    ...
    expr2 = msat_make_plus(menv, xs[13], n_9_0)
    expr3 = msat_make_plus(menv, xs[14], n_19_0)
    expr4 = msat_make_plus(menv, xs[15], n_5_0)
    ...
    expr0 = msat_make_plus(menv, xs[4], n_3_0)
    ...
    expr5 = msat_make_plus(menv, xs[5], n_8_0)
    ...
    expr12 = msat_make_plus(menv, xs[28], n_17_0)
    expr13 = msat_make_plus(menv, xs[29], n_18_0)
    expr14 = msat_make_plus(menv, xs[34], n_6_0)
    expr15 = msat_make_plus(menv, xs[35], n_3_0)
    ...
    expr14 = msat_make_plus(menv, xs[21], n_18_0)
    expr15 = msat_make_plus(menv, xs[23], n_14_0)
    expr16 = msat_make_plus(menv, xs[26], n_16_0)
    expr17 = msat_make_plus(menv, xs[27], n_11_0)
    expr18 = msat_make_plus(menv, xs[29], n_13_0)
    ...
    # ltl property: (F (G ((x_11 - x_2 > -17) & (x_0 - x_11 > 10))))
    ltl = enc.make_F(enc.make_G(msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[11], xs[2]), msat_make_number(menv, "-17")), msat_make_gt(menv, msat_make_minus(menv, xs[0], xs[11]), msat_make_number(menv, "10")))))
