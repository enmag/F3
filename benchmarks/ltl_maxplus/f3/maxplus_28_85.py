...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((G (x_24 - x_16 >= 7)) | (F (x_13 - x_17 > 6)))
    ltl = msat_make_or(menv, enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[24], xs[16]), msat_make_number(menv, "7"))), enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[13], xs[17]), msat_make_number(menv, "6"))))
