...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr10 = msat_make_plus(menv, xs[12], n_7_0)
    expr11 = msat_make_plus(menv, xs[13], n_1_0)
    ...
    # ltl property: ((x_2 - x_24 > -16) & (G (F (x_16 - x_9 > 12))))
    ltl = msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[2], xs[24]), msat_make_number(menv, "-16")), enc.make_G(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[16], xs[9]), msat_make_number(menv, "12")))))
