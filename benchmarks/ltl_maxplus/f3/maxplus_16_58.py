...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (G ((G (x_13 - x_0 > 18)) U (x_10 - x_15 >= -11)))
    ltl = enc.make_G(enc.make_U(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[13], xs[0]), msat_make_number(menv, "18"))), msat_make_geq(menv, msat_make_minus(menv, xs[10], xs[15]), msat_make_number(menv, "-11"))))
