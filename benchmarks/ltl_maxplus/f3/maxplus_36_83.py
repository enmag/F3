...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_34 - x_19 >= -16) & ((x_7 - x_0 > -3) U (x_33 - x_18 > -16)))
    ltl = msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[34], xs[19]), msat_make_number(menv, "-16")), enc.make_U(msat_make_gt(menv, msat_make_minus(menv, xs[7], xs[0]), msat_make_number(menv, "-3")), msat_make_gt(menv, msat_make_minus(menv, xs[33], xs[18]), msat_make_number(menv, "-16"))))
