...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr4 = msat_make_plus(menv, xs[16], n_11_0)
    ...
    expr10 = msat_make_plus(menv, xs[14], n_20_0)
    expr11 = msat_make_plus(menv, xs[15], n_5_0)
    ...
    expr3 = msat_make_plus(menv, xs[15], n_18_0)
    expr4 = msat_make_plus(menv, xs[16], n_5_0)
    ...
    expr10 = msat_make_plus(menv, xs[27], n_5_0)
    ...
    expr10 = msat_make_plus(menv, xs[27], n_3_0)
    expr11 = msat_make_plus(menv, xs[28], n_13_0)
    expr12 = msat_make_plus(menv, xs[31], n_7_0)
    expr13 = msat_make_plus(menv, xs[33], n_20_0)
    expr14 = msat_make_plus(menv, xs[34], n_8_0)
    ...
    # ltl property: (! ((! (x_4 - x_18 > 20)) U (! (G (F (x_18 - x_29 > 7))))))
    ltl = msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[4], xs[18]), msat_make_number(menv, "20"))), msat_make_not(menv, enc.make_G(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[18], xs[29]), msat_make_number(menv, "7")))))))
