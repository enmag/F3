...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr6 = msat_make_plus(menv, xs[21], n_17_0)
    ...
    # ltl property: (F ((x_9 - x_32 > 6) U (G (x_28 - x_10 > -3))))
    ltl = enc.make_F(enc.make_U(msat_make_gt(menv, msat_make_minus(menv, xs[9], xs[32]), msat_make_number(menv, "6")), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[28], xs[10]), msat_make_number(menv, "-3")))))
