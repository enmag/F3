...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr9 = msat_make_plus(menv, xs[10], n_20_0)
    ...
    # ltl property: (F ((F (x_17 - x_14 >= 4)) U (x_12 - x_27 > -11)))
    ltl = enc.make_F(enc.make_U(enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[17], xs[14]), msat_make_number(menv, "4"))), msat_make_gt(menv, msat_make_minus(menv, xs[12], xs[27]), msat_make_number(menv, "-11"))))
