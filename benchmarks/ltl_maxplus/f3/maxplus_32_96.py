...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr11 = msat_make_plus(menv, xs[13], n_4_0)
    ...
    # ltl property: (X (F (G (X (x_13 - x_29 > 14)))))
    ltl = enc.make_X(enc.make_F(enc.make_G(enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[13], xs[29]), msat_make_number(menv, "14"))))))
