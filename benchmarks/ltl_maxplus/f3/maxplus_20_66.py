...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_10 - x_15 >= 6) | ((x_15 - x_16 >= -8) & (x_10 - x_1 >= -3)))
    ltl = msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[10], xs[15]), msat_make_number(menv, "6")), msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[15], xs[16]), msat_make_number(menv, "-8")), msat_make_geq(menv, msat_make_minus(menv, xs[10], xs[1]), msat_make_number(menv, "-3"))))
