...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr19 = msat_make_plus(menv, xs[34], n_19_0)
    _t = msat_make_and(menv,
    ...
    expr7 = msat_make_plus(menv, xs[9], n_2_0)
    ...
    expr4 = msat_make_plus(menv, xs[17], n_3_0)
    expr5 = msat_make_plus(menv, xs[18], n_20_0)
    ...
    expr13 = msat_make_plus(menv, xs[21], n_20_0)
    ...
    expr13 = msat_make_plus(menv, xs[19], n_15_0)
    ...
    expr18 = msat_make_plus(menv, xs[32], n_11_0)
    expr19 = msat_make_plus(menv, xs[34], n_12_0)
    _t = msat_make_and(menv,
    ...
    expr17 = msat_make_plus(menv, xs[30], n_17_0)
    ...
    expr8 = msat_make_plus(menv, xs[10], n_3_0)
    expr9 = msat_make_plus(menv, xs[11], n_16_0)
    expr10 = msat_make_plus(menv, xs[13], n_6_0)
    expr11 = msat_make_plus(menv, xs[15], n_14_0)
    expr12 = msat_make_plus(menv, xs[17], n_19_0)
    expr13 = msat_make_plus(menv, xs[18], n_5_0)
    expr14 = msat_make_plus(menv, xs[19], n_4_0)
    ...
    # ltl property: (G ((G (x_33 - x_0 >= 0)) U (x_2 - x_25 >= 9)))
    ltl = enc.make_G(enc.make_U(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[33], xs[0]), msat_make_number(menv, "0"))), msat_make_geq(menv, msat_make_minus(menv, xs[2], xs[25]), msat_make_number(menv, "9"))))
