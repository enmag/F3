...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (F (G (F (X (x_4 - x_10 >= 13)))))
    ltl = enc.make_F(enc.make_G(enc.make_F(enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[4], xs[10]), msat_make_number(menv, "13"))))))
