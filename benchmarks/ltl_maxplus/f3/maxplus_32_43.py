...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr0 = msat_make_plus(menv, xs[8], n_20_0)
    ...
    # ltl property: ((X (x_8 - x_2 >= -5)) & (G (x_1 - x_27 > 8)))
    ltl = msat_make_and(menv, enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[8], xs[2]), msat_make_number(menv, "-5"))), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[1], xs[27]), msat_make_number(menv, "8"))))
