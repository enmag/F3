...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr12 = msat_make_plus(menv, xs[16], n_19_0)
    expr13 = msat_make_plus(menv, xs[17], n_8_0)
    expr14 = msat_make_plus(menv, xs[21], n_11_0)
    ...
    expr7 = msat_make_plus(menv, xs[22], n_14_0)
    ...
    expr1 = msat_make_plus(menv, xs[9], n_13_0)
    ...
    expr1 = msat_make_plus(menv, xs[12], n_13_0)
    expr2 = msat_make_plus(menv, xs[15], n_11_0)
    expr3 = msat_make_plus(menv, xs[17], n_7_0)
    expr4 = msat_make_plus(menv, xs[19], n_17_0)
    expr5 = msat_make_plus(menv, xs[20], n_2_0)
    expr6 = msat_make_plus(menv, xs[22], n_10_0)
    expr7 = msat_make_plus(menv, xs[25], n_7_0)
    expr8 = msat_make_plus(menv, xs[26], n_12_0)
    expr9 = msat_make_plus(menv, xs[27], n_16_0)
    expr10 = msat_make_plus(menv, xs[28], n_4_0)
    ...
    expr8 = msat_make_plus(menv, xs[10], n_11_0)
    ...
    # ltl property: ((x_3 - x_35 > -4) | (X (G (x_2 - x_28 > 20))))
    ltl = msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[3], xs[35]), msat_make_number(menv, "-4")), enc.make_X(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[2], xs[28]), msat_make_number(menv, "20")))))
