...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_5 - x_19 >= 18) U ((x_2 - x_16 >= 18) & (x_11 - x_0 > 19)))
    ltl = enc.make_U(msat_make_geq(menv, msat_make_minus(menv, xs[5], xs[19]), msat_make_number(menv, "18")), msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[2], xs[16]), msat_make_number(menv, "18")), msat_make_gt(menv, msat_make_minus(menv, xs[11], xs[0]), msat_make_number(menv, "19"))))
