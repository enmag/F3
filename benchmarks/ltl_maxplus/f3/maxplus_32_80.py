...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr10 = msat_make_plus(menv, xs[12], n_9_0)
    ...
    # ltl property: ((x_26 - x_13 >= 19) | (G (F (x_9 - x_12 > -9))))
    ltl = msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[26], xs[13]), msat_make_number(menv, "19")), enc.make_G(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[9], xs[12]), msat_make_number(menv, "-9")))))
