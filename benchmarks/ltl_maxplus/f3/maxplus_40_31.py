...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr15 = msat_make_plus(menv, xs[24], n_19_0)
    ...
    expr0 = msat_make_plus(menv, xs[6], n_5_0)
    ...
    expr19 = msat_make_plus(menv, xs[32], n_6_0)
    _t = msat_make_and(menv,
    ...
    # ltl property: (! ((! (x_22 - x_28 >= 12)) U (! ((x_39 - x_7 > 9) | (x_25 - x_38 >= 17)))))
    ltl = msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_geq(menv, msat_make_minus(menv, xs[22], xs[28]), msat_make_number(menv, "12"))), msat_make_not(menv, msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[39], xs[7]), msat_make_number(menv, "9")), msat_make_geq(menv, msat_make_minus(menv, xs[25], xs[38]), msat_make_number(menv, "17"))))))
