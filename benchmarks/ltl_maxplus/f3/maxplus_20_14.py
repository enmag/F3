...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (X ((G (x_5 - x_4 > 9)) U (x_1 - x_10 >= 1)))
    ltl = enc.make_X(enc.make_U(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[5], xs[4]), msat_make_number(menv, "9"))), msat_make_geq(menv, msat_make_minus(menv, xs[1], xs[10]), msat_make_number(menv, "1"))))
