...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_3 - x_1 > 3) | ((x_0 - x_1 >= -15) & (x_0 - x_1 > 8)))
    ltl = msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[3], xs[1]), msat_make_number(menv, "3")), msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[0], xs[1]), msat_make_number(menv, "-15")), msat_make_gt(menv, msat_make_minus(menv, xs[0], xs[1]), msat_make_number(menv, "8"))))
