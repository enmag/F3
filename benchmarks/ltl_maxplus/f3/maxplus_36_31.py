...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr9 = msat_make_plus(menv, xs[11], n_12_0)
    ...
    # ltl property: (! ((! (x_31 - x_0 > -8)) U (! ((x_34 - x_27 >= 0) | (x_5 - x_9 > -12)))))
    ltl = msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[31], xs[0]), msat_make_number(menv, "-8"))), msat_make_not(menv, msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[34], xs[27]), msat_make_number(menv, "0")), msat_make_gt(menv, msat_make_minus(menv, xs[5], xs[9]), msat_make_number(menv, "-12"))))))
