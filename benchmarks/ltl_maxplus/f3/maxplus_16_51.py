...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F ((x_6 - x_8 > -15) U (F (x_5 - x_2 >= 0))))
    ltl = enc.make_F(enc.make_U(msat_make_gt(menv, msat_make_minus(menv, xs[6], xs[8]), msat_make_number(menv, "-15")), enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[5], xs[2]), msat_make_number(menv, "0")))))
