...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (X ((x_21 - x_7 >= 3) & (X (x_11 - x_1 > 9))))
    ltl = enc.make_X(msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[21], xs[7]), msat_make_number(menv, "3")), enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[11], xs[1]), msat_make_number(menv, "9")))))
