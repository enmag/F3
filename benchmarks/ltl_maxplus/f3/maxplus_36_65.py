...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr7 = msat_make_plus(menv, xs[7], n_7_0)
    expr8 = msat_make_plus(menv, xs[8], n_17_0)
    expr9 = msat_make_plus(menv, xs[10], n_6_0)
    ...
    expr7 = msat_make_plus(menv, xs[22], n_5_0)
    ...
    expr2 = msat_make_plus(menv, xs[12], n_10_0)
    ...
    expr2 = msat_make_plus(menv, xs[13], n_20_0)
    ...
    # ltl property: (G ((x_16 - x_18 > -15) | (G (x_29 - x_11 > 1))))
    ltl = enc.make_G(msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[16], xs[18]), msat_make_number(menv, "-15")), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[29], xs[11]), msat_make_number(menv, "1")))))
