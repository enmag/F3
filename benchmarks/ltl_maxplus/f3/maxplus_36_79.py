...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr8 = msat_make_plus(menv, xs[24], n_13_0)
    expr9 = msat_make_plus(menv, xs[26], n_12_0)
    ...
    expr6 = msat_make_plus(menv, xs[20], n_15_0)
    ...
    expr0 = msat_make_plus(menv, xs[7], n_3_0)
    ...
    # ltl property: (F ((x_22 - x_23 >= 10) & (G (x_20 - x_28 > -5))))
    ltl = enc.make_F(msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[22], xs[23]), msat_make_number(menv, "10")), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[20], xs[28]), msat_make_number(menv, "-5")))))
