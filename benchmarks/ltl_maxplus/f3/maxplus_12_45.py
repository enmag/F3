...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((G (x_4 - x_5 > -20)) U (G (x_9 - x_8 > 18)))
    ltl = enc.make_U(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[4], xs[5]), msat_make_number(menv, "-20"))), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[9], xs[8]), msat_make_number(menv, "18"))))
