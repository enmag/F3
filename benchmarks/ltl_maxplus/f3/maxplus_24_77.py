...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (F ((x_5 - x_12 >= -15) & (G (x_21 - x_5 >= 6))))
    ltl = enc.make_F(msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[5], xs[12]), msat_make_number(menv, "-15")), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[21], xs[5]), msat_make_number(menv, "6")))))
