...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr6 = msat_make_plus(menv, xs[6], n_12_0)
    expr7 = msat_make_plus(menv, xs[7], n_13_0)
    expr8 = msat_make_plus(menv, xs[8], n_2_0)
    ...
    expr10 = msat_make_plus(menv, xs[13], n_8_0)
    ...
    expr13 = msat_make_plus(menv, xs[19], n_19_0)
    expr14 = msat_make_plus(menv, xs[20], n_16_0)
    ...
    # ltl property: ((X (X (x_27 - x_5 > 6))) U (x_31 - x_11 >= 11))
    ltl = enc.make_U(enc.make_X(enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[27], xs[5]), msat_make_number(menv, "6")))), msat_make_geq(menv, msat_make_minus(menv, xs[31], xs[11]), msat_make_number(menv, "11")))
