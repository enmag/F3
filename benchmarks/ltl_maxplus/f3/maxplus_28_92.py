...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr10 = msat_make_plus(menv, xs[13], n_5_0)
    ...
    # ltl property: (F (! ((! (x_6 - x_5 > -5)) U (! (G (x_25 - x_14 > -7))))))
    ltl = enc.make_F(msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[6], xs[5]), msat_make_number(menv, "-5"))), msat_make_not(menv, enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[25], xs[14]), msat_make_number(menv, "-7")))))))
