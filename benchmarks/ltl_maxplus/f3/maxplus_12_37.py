...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_7 - x_10 > 6) | ((x_6 - x_11 >= -18) & (x_6 - x_10 >= 10)))
    ltl = msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[7], xs[10]), msat_make_number(menv, "6")), msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[6], xs[11]), msat_make_number(menv, "-18")), msat_make_geq(menv, msat_make_minus(menv, xs[6], xs[10]), msat_make_number(menv, "10"))))
