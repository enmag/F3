...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_13 - x_23 >= -19) | (X (F (x_3 - x_9 > 12))))
    ltl = msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[13], xs[23]), msat_make_number(menv, "-19")), enc.make_X(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[3], xs[9]), msat_make_number(menv, "12")))))
