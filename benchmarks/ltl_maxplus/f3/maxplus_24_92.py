...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F (! ((! (x_10 - x_2 > -13)) U (! (G (x_19 - x_12 >= -10))))))
    ltl = enc.make_F(msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[10], xs[2]), msat_make_number(menv, "-13"))), msat_make_not(menv, enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[19], xs[12]), msat_make_number(menv, "-10")))))))
