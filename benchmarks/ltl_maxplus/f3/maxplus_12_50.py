...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_6 - x_9 > -15) | ((x_1 - x_5 > 15) & (x_4 - x_0 > 1)))
    ltl = msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[6], xs[9]), msat_make_number(menv, "-15")), msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[1], xs[5]), msat_make_number(menv, "15")), msat_make_gt(menv, msat_make_minus(menv, xs[4], xs[0]), msat_make_number(menv, "1"))))
