...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_2 - x_7 >= 18) & (F (G (x_3 - x_20 >= 10))))
    ltl = msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[2], xs[7]), msat_make_number(menv, "18")), enc.make_F(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[3], xs[20]), msat_make_number(menv, "10")))))
