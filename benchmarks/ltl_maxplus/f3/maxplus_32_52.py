...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr2 = msat_make_plus(menv, xs[11], n_20_0)
    ...
    # ltl property: (! ((! (x_28 - x_17 > 20)) U (! (G (F (x_20 - x_10 >= -8))))))
    ltl = msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[28], xs[17]), msat_make_number(menv, "20"))), msat_make_not(menv, enc.make_G(enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[20], xs[10]), msat_make_number(menv, "-8")))))))
