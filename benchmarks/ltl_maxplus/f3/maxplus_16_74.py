...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_8 - x_1 > 18) & (F (G (x_7 - x_10 > -16))))
    ltl = msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[8], xs[1]), msat_make_number(menv, "18")), enc.make_F(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[7], xs[10]), msat_make_number(menv, "-16")))))
