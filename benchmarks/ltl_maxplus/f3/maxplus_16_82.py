...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((X (x_15 - x_0 > 7)) | (G (x_5 - x_6 > -17)))
    ltl = msat_make_or(menv, enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[15], xs[0]), msat_make_number(menv, "7"))), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[5], xs[6]), msat_make_number(menv, "-17"))))
