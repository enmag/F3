...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((X (x_11 - x_1 >= 18)) U (X (x_5 - x_13 > -14)))
    ltl = enc.make_U(enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[11], xs[1]), msat_make_number(menv, "18"))), enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[5], xs[13]), msat_make_number(menv, "-14"))))
