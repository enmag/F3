...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((X (x_10 - x_26 >= -18)) | (G (x_11 - x_16 > 17)))
    ltl = msat_make_or(menv, enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[10], xs[26]), msat_make_number(menv, "-18"))), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[11], xs[16]), msat_make_number(menv, "17"))))
