...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((F (x_6 - x_10 >= -16)) U (G (x_35 - x_10 >= 20)))
    ltl = enc.make_U(enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[6], xs[10]), msat_make_number(menv, "-16"))), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[35], xs[10]), msat_make_number(menv, "20"))))
