...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((X (x_11 - x_7 > -18)) U (G (x_0 - x_8 >= -1)))
    ltl = enc.make_U(enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[11], xs[7]), msat_make_number(menv, "-18"))), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[0], xs[8]), msat_make_number(menv, "-1"))))
