...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (! ((! (! ((! (x_15 - x_10 > -4)) U (! (x_15 - x_4 > -5))))) U (! (x_15 - x_10 > -4))))
    ltl = msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[15], xs[10]), msat_make_number(menv, "-4"))), msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[15], xs[4]), msat_make_number(menv, "-5")))))), msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[15], xs[10]), msat_make_number(menv, "-4")))))
