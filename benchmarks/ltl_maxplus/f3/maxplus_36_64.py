...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F (X ((x_8 - x_23 >= 17) & (x_15 - x_21 > 6))))
    ltl = enc.make_F(enc.make_X(msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[8], xs[23]), msat_make_number(menv, "17")), msat_make_gt(menv, msat_make_minus(menv, xs[15], xs[21]), msat_make_number(menv, "6")))))
