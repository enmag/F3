...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr10 = msat_make_plus(menv, xs[11], n_7_0)
    ...
    # ltl property: ((X (x_11 - x_10 > -15)) | (X (x_6 - x_5 > -15)))
    ltl = msat_make_or(menv, enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[11], xs[10]), msat_make_number(menv, "-15"))), enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[6], xs[5]), msat_make_number(menv, "-15"))))
