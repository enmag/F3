...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_5 - x_8 >= 3) U ((x_10 - x_3 >= 19) U (x_11 - x_3 >= -13)))
    ltl = enc.make_U(msat_make_geq(menv, msat_make_minus(menv, xs[5], xs[8]), msat_make_number(menv, "3")), enc.make_U(msat_make_geq(menv, msat_make_minus(menv, xs[10], xs[3]), msat_make_number(menv, "19")), msat_make_geq(menv, msat_make_minus(menv, xs[11], xs[3]), msat_make_number(menv, "-13"))))
