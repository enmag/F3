...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (F ((F (x_10 - x_21 > -8)) U (x_15 - x_13 >= 7)))
    ltl = enc.make_F(enc.make_U(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[10], xs[21]), msat_make_number(menv, "-8"))), msat_make_geq(menv, msat_make_minus(menv, xs[15], xs[13]), msat_make_number(menv, "7"))))
