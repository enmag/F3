...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((X (x_8 - x_1 >= 7)) U (G (x_13 - x_17 > -12)))
    ltl = enc.make_U(enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[8], xs[1]), msat_make_number(menv, "7"))), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[13], xs[17]), msat_make_number(menv, "-12"))))
