...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_12 - x_2 >= 4) | ((x_13 - x_1 > -20) & (x_3 - x_1 > 13)))
    ltl = msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[12], xs[2]), msat_make_number(menv, "4")), msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[13], xs[1]), msat_make_number(menv, "-20")), msat_make_gt(menv, msat_make_minus(menv, xs[3], xs[1]), msat_make_number(menv, "13"))))
