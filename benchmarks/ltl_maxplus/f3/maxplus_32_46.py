...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((X (x_27 - x_6 > 2)) | (F (x_4 - x_6 >= 7)))
    ltl = msat_make_or(menv, enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[27], xs[6]), msat_make_number(menv, "2"))), enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[4], xs[6]), msat_make_number(menv, "7"))))
