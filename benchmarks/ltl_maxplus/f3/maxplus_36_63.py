...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr2 = msat_make_plus(menv, xs[11], n_17_0)
    ...
    # ltl property: ((x_21 - x_2 >= -3) | (! ((! (x_19 - x_9 >= -15)) U (! (x_24 - x_27 > 13)))))
    ltl = msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[21], xs[2]), msat_make_number(menv, "-3")), msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_geq(menv, msat_make_minus(menv, xs[19], xs[9]), msat_make_number(menv, "-15"))), msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[24], xs[27]), msat_make_number(menv, "13"))))))
