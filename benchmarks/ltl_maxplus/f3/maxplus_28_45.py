...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((G (x_10 - x_26 >= 7)) U (G (x_2 - x_6 >= -18)))
    ltl = enc.make_U(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[10], xs[26]), msat_make_number(menv, "7"))), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[2], xs[6]), msat_make_number(menv, "-18"))))
