...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((G (x_14 - x_8 > -9)) U (X (x_7 - x_11 > 17)))
    ltl = enc.make_U(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[14], xs[8]), msat_make_number(menv, "-9"))), enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[7], xs[11]), msat_make_number(menv, "17"))))
