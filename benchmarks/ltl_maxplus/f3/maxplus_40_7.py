...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr10 = msat_make_plus(menv, xs[29], n_1_0)
    expr11 = msat_make_plus(menv, xs[30], n_12_0)
    expr12 = msat_make_plus(menv, xs[31], n_1_0)
    expr13 = msat_make_plus(menv, xs[32], n_5_0)
    ...
    expr14 = msat_make_plus(menv, xs[22], n_13_0)
    ...
    expr1 = msat_make_plus(menv, xs[11], n_2_0)
    expr2 = msat_make_plus(menv, xs[13], n_16_0)
    expr3 = msat_make_plus(menv, xs[14], n_5_0)
    expr4 = msat_make_plus(menv, xs[16], n_6_0)
    expr5 = msat_make_plus(menv, xs[17], n_17_0)
    expr6 = msat_make_plus(menv, xs[18], n_15_0)
    ...
    # ltl property: (! ((! (x_13 - x_22 >= 11)) U (! (! ((! (x_8 - x_38 >= 16)) U (! (x_36 - x_39 > 7)))))))
    ltl = msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_geq(menv, msat_make_minus(menv, xs[13], xs[22]), msat_make_number(menv, "11"))), msat_make_not(menv, msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_geq(menv, msat_make_minus(menv, xs[8], xs[38]), msat_make_number(menv, "16"))), msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[36], xs[39]), msat_make_number(menv, "7"))))))))
