...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_20 - x_7 >= 9) & (X (F (x_2 - x_17 >= 4))))
    ltl = msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[20], xs[7]), msat_make_number(menv, "9")), enc.make_X(enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[2], xs[17]), msat_make_number(menv, "4")))))
