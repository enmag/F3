...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((X (x_1 - x_18 > -17)) | (G (x_10 - x_15 > -18)))
    ltl = msat_make_or(menv, enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[1], xs[18]), msat_make_number(menv, "-17"))), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[10], xs[15]), msat_make_number(menv, "-18"))))
