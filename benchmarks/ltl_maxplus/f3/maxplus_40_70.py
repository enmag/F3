...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr12 = msat_make_plus(menv, xs[18], n_15_0)
    expr13 = msat_make_plus(menv, xs[19], n_9_0)
    expr14 = msat_make_plus(menv, xs[20], n_6_0)
    expr15 = msat_make_plus(menv, xs[22], n_6_0)
    ...
    expr4 = msat_make_plus(menv, xs[15], n_6_0)
    ...
    expr1 = msat_make_plus(menv, xs[9], n_10_0)
    expr2 = msat_make_plus(menv, xs[13], n_19_0)
    ...
    expr9 = msat_make_plus(menv, xs[26], n_11_0)
    ...
    # ltl property: (G (! ((! (x_14 - x_12 > 0)) U (! (X (x_37 - x_20 >= -15))))))
    ltl = enc.make_G(msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[14], xs[12]), msat_make_number(menv, "0"))), msat_make_not(menv, enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[37], xs[20]), msat_make_number(menv, "-15")))))))
