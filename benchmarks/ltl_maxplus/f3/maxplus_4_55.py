...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (! ((! (x_0 - x_3 > 17)) U (! (X (X (x_3 - x_1 > -16))))))
    ltl = msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[0], xs[3]), msat_make_number(menv, "17"))), msat_make_not(menv, enc.make_X(enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[3], xs[1]), msat_make_number(menv, "-16")))))))
