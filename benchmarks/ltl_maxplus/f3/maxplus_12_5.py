...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F ((x_6 - x_1 >= -15) & (G (x_9 - x_1 >= -6))))
    ltl = enc.make_F(msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[6], xs[1]), msat_make_number(menv, "-15")), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[9], xs[1]), msat_make_number(menv, "-6")))))
