...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (G ((G (x_2 - x_0 > -19)) U (x_2 - x_3 >= 16)))
    ltl = enc.make_G(enc.make_U(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[2], xs[0]), msat_make_number(menv, "-19"))), msat_make_geq(menv, msat_make_minus(menv, xs[2], xs[3]), msat_make_number(menv, "16"))))
