...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((X (x_14 - x_7 > -9)) | (G (x_2 - x_21 >= -2)))
    ltl = msat_make_or(menv, enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[14], xs[7]), msat_make_number(menv, "-9"))), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[2], xs[21]), msat_make_number(menv, "-2"))))
