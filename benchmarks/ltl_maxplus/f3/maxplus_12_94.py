...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_9 - x_3 > -11) U ((x_8 - x_3 > 10) | (x_10 - x_11 > -8)))
    ltl = enc.make_U(msat_make_gt(menv, msat_make_minus(menv, xs[9], xs[3]), msat_make_number(menv, "-11")), msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[8], xs[3]), msat_make_number(menv, "10")), msat_make_gt(menv, msat_make_minus(menv, xs[10], xs[11]), msat_make_number(menv, "-8"))))
