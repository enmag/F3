...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (X (! ((! (F (x_21 - x_27 > -5))) U (! (x_21 - x_27 > -5)))))
    ltl = enc.make_X(msat_make_not(menv, enc.make_U(msat_make_not(menv, enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[21], xs[27]), msat_make_number(menv, "-5")))), msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[21], xs[27]), msat_make_number(menv, "-5"))))))
