...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((G (x_16 - x_3 >= 13)) U (X (x_20 - x_15 > 11)))
    ltl = enc.make_U(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[16], xs[3]), msat_make_number(menv, "13"))), enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[20], xs[15]), msat_make_number(menv, "11"))))
