...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((G (x_1 - x_0 > 14)) U (G (x_3 - x_2 >= -17)))
    ltl = enc.make_U(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[1], xs[0]), msat_make_number(menv, "14"))), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[3], xs[2]), msat_make_number(menv, "-17"))))
