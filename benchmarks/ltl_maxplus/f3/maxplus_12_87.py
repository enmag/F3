...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F ((x_3 - x_9 > -7) | (G (x_3 - x_9 > -7))))
    ltl = enc.make_F(msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[3], xs[9]), msat_make_number(menv, "-7")), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[3], xs[9]), msat_make_number(menv, "-7")))))
