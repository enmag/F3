...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((X (x_3 - x_13 >= 18)) | (X (x_10 - x_15 >= 18)))
    ltl = msat_make_or(menv, enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[3], xs[13]), msat_make_number(menv, "18"))), enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[10], xs[15]), msat_make_number(menv, "18"))))
