...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((X (x_5 - x_7 > -14)) U (G (x_5 - x_3 >= -6)))
    ltl = enc.make_U(enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[5], xs[7]), msat_make_number(menv, "-14"))), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[5], xs[3]), msat_make_number(menv, "-6"))))
