...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F (X (F (G (x_18 - x_13 >= 2)))))
    ltl = enc.make_F(enc.make_X(enc.make_F(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[18], xs[13]), msat_make_number(menv, "2"))))))
