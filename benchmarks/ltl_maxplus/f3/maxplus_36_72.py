...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr15 = msat_make_plus(menv, xs[21], n_19_0)
    expr16 = msat_make_plus(menv, xs[22], n_18_0)
    ...
    # ltl property: (X (! ((! (x_22 - x_19 >= -2)) U (! (G (x_13 - x_14 > -19))))))
    ltl = enc.make_X(msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_geq(menv, msat_make_minus(menv, xs[22], xs[19]), msat_make_number(menv, "-2"))), msat_make_not(menv, enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[13], xs[14]), msat_make_number(menv, "-19")))))))
