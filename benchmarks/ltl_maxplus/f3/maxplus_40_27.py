...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr7 = msat_make_plus(menv, xs[8], n_20_0)
    ...
    expr17 = msat_make_plus(menv, xs[29], n_3_0)
    ...
    expr12 = msat_make_plus(menv, xs[17], n_12_0)
    ...
    # ltl property: ((G (x_0 - x_36 >= 15)) U (G (x_18 - x_5 >= 3)))
    ltl = enc.make_U(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[0], xs[36]), msat_make_number(menv, "15"))), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[18], xs[5]), msat_make_number(menv, "3"))))
