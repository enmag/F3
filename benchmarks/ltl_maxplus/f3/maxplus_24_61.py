...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((X (X (x_16 - x_17 > 16))) U (x_3 - x_12 >= -13))
    ltl = enc.make_U(enc.make_X(enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[16], xs[17]), msat_make_number(menv, "16")))), msat_make_geq(menv, msat_make_minus(menv, xs[3], xs[12]), msat_make_number(menv, "-13")))
