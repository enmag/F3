...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (G ((x_14 - x_0 > 12) | (G (x_4 - x_5 >= -10))))
    ltl = enc.make_G(msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[14], xs[0]), msat_make_number(menv, "12")), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[4], xs[5]), msat_make_number(menv, "-10")))))
