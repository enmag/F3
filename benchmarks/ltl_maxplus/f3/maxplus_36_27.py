...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((G (x_29 - x_19 >= -1)) U (G (x_33 - x_34 >= 0)))
    ltl = enc.make_U(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[29], xs[19]), msat_make_number(menv, "-1"))), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[33], xs[34]), msat_make_number(menv, "0"))))
