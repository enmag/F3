...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr6 = msat_make_plus(menv, xs[6], n_5_0)
    ...
    # ltl property: ((x_10 - x_2 >= -2) | (X (G (x_21 - x_2 >= 13))))
    ltl = msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[10], xs[2]), msat_make_number(menv, "-2")), enc.make_X(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[21], xs[2]), msat_make_number(menv, "13")))))
