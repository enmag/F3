...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_0 - x_22 > -9) & ((x_6 - x_27 > -3) U (x_9 - x_0 > -17)))
    ltl = msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[0], xs[22]), msat_make_number(menv, "-9")), enc.make_U(msat_make_gt(menv, msat_make_minus(menv, xs[6], xs[27]), msat_make_number(menv, "-3")), msat_make_gt(menv, msat_make_minus(menv, xs[9], xs[0]), msat_make_number(menv, "-17"))))
