...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr12 = msat_make_plus(menv, xs[30], n_3_0)
    expr13 = msat_make_plus(menv, xs[31], n_3_0)
    ...
    expr0 = msat_make_plus(menv, xs[5], n_18_0)
    ...
    expr1 = msat_make_plus(menv, xs[10], n_6_0)
    expr2 = msat_make_plus(menv, xs[11], n_14_0)
    ...
    expr13 = msat_make_plus(menv, xs[32], n_6_0)
    ...
    expr9 = msat_make_plus(menv, xs[13], n_14_0)
    ...
    expr16 = msat_make_plus(menv, xs[28], n_5_0)
    ...
    expr5 = msat_make_plus(menv, xs[18], n_18_0)
    ...
    expr15 = msat_make_plus(menv, xs[35], n_12_0)
    ...
    expr1 = msat_make_plus(menv, xs[7], n_3_0)
    ...
    # ltl property: (X (! ((! (x_27 - x_34 >= -18)) U (! (G (x_29 - x_3 > -3))))))
    ltl = enc.make_X(msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_geq(menv, msat_make_minus(menv, xs[27], xs[34]), msat_make_number(menv, "-18"))), msat_make_not(menv, enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[29], xs[3]), msat_make_number(menv, "-3")))))))
