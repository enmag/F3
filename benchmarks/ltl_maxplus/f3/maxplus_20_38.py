...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (G (X (! ((! (x_19 - x_3 > -5)) U (! (x_14 - x_19 > -6))))))
    ltl = enc.make_G(enc.make_X(msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[19], xs[3]), msat_make_number(menv, "-5"))), msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[14], xs[19]), msat_make_number(menv, "-6")))))))
