...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr2 = msat_make_plus(menv, xs[12], n_1_0)
    ...
    # ltl property: ((x_29 - x_5 > -19) | ((x_2 - x_4 > -6) & (x_18 - x_1 >= 14)))
    ltl = msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[29], xs[5]), msat_make_number(menv, "-19")), msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[2], xs[4]), msat_make_number(menv, "-6")), msat_make_geq(menv, msat_make_minus(menv, xs[18], xs[1]), msat_make_number(menv, "14"))))
