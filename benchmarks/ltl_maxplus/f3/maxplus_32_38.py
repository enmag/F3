...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr10 = msat_make_plus(menv, xs[12], n_10_0)
    ...
    expr8 = msat_make_plus(menv, xs[9], n_11_0)
    ...
    expr1 = msat_make_plus(menv, xs[11], n_20_0)
    expr2 = msat_make_plus(menv, xs[12], n_18_0)
    ...
    # ltl property: (G (X (! ((! (x_24 - x_13 >= 17)) U (! (x_30 - x_16 > 6))))))
    ltl = enc.make_G(enc.make_X(msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_geq(menv, msat_make_minus(menv, xs[24], xs[13]), msat_make_number(menv, "17"))), msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[30], xs[16]), msat_make_number(menv, "6")))))))
