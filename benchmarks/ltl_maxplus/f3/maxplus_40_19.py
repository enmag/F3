...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr6 = msat_make_plus(menv, xs[19], n_9_0)
    ...
    expr15 = msat_make_plus(menv, xs[26], n_20_0)
    expr16 = msat_make_plus(menv, xs[27], n_11_0)
    ...
    expr12 = msat_make_plus(menv, xs[15], n_8_0)
    expr13 = msat_make_plus(menv, xs[18], n_13_0)
    expr14 = msat_make_plus(menv, xs[20], n_19_0)
    expr15 = msat_make_plus(menv, xs[23], n_9_0)
    expr16 = msat_make_plus(menv, xs[26], n_10_0)
    expr17 = msat_make_plus(menv, xs[27], n_8_0)
    expr18 = msat_make_plus(menv, xs[35], n_4_0)
    ...
    expr18 = msat_make_plus(menv, xs[31], n_20_0)
    expr19 = msat_make_plus(menv, xs[32], n_5_0)
    _t = msat_make_and(menv,
    ...
    expr14 = msat_make_plus(menv, xs[22], n_12_0)
    ...
    expr0 = msat_make_plus(menv, xs[8], n_5_0)
    expr1 = msat_make_plus(menv, xs[9], n_9_0)
    expr2 = msat_make_plus(menv, xs[12], n_8_0)
    ...
    # ltl property: (! ((! (! ((! (x_3 - x_2 > 17)) U (! (x_12 - x_21 > -13))))) U (! (x_4 - x_5 >= 19))))
    ltl = msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[3], xs[2]), msat_make_number(menv, "17"))), msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[12], xs[21]), msat_make_number(menv, "-13")))))), msat_make_not(menv, msat_make_geq(menv, msat_make_minus(menv, xs[4], xs[5]), msat_make_number(menv, "19")))))
