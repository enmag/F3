...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr10 = msat_make_plus(menv, xs[12], n_11_0)
    expr11 = msat_make_plus(menv, xs[13], n_5_0)
    expr12 = msat_make_plus(menv, xs[15], n_11_0)
    ...
    expr1 = msat_make_plus(menv, xs[6], n_14_0)
    ...
    expr16 = msat_make_plus(menv, xs[25], n_17_0)
    ...
    expr8 = msat_make_plus(menv, xs[23], n_4_0)
    ...
    # ltl property: (F (X (F (G (x_34 - x_26 >= -2)))))
    ltl = enc.make_F(enc.make_X(enc.make_F(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[34], xs[26]), msat_make_number(menv, "-2"))))))
