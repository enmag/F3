...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr7 = msat_make_plus(menv, xs[7], n_4_0)
    expr8 = msat_make_plus(menv, xs[8], n_7_0)
    expr9 = msat_make_plus(menv, xs[9], n_18_0)
    expr10 = msat_make_plus(menv, xs[12], n_18_0)
    ...
    # ltl property: ((x_18 - x_23 > -14) | (X (F (x_29 - x_6 > 19))))
    ltl = msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[18], xs[23]), msat_make_number(menv, "-14")), enc.make_X(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[29], xs[6]), msat_make_number(menv, "19")))))
