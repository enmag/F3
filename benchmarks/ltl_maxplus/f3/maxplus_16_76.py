...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (G ((x_11 - x_9 > -8) | (F (x_14 - x_11 > 16))))
    ltl = enc.make_G(msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[11], xs[9]), msat_make_number(menv, "-8")), enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[14], xs[11]), msat_make_number(menv, "16")))))
