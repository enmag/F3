...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr6 = msat_make_plus(menv, xs[6], n_9_0)
    ...
    expr7 = msat_make_plus(menv, xs[7], n_17_0)
    expr8 = msat_make_plus(menv, xs[8], n_13_0)
    ...
    # ltl property: ((X (X (x_27 - x_2 >= 13))) U (x_1 - x_20 > -1))
    ltl = enc.make_U(enc.make_X(enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[27], xs[2]), msat_make_number(menv, "13")))), msat_make_gt(menv, msat_make_minus(menv, xs[1], xs[20]), msat_make_number(menv, "-1")))
