...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((F (x_5 - x_23 > -17)) & (X (x_5 - x_9 >= 7)))
    ltl = msat_make_and(menv, enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[5], xs[23]), msat_make_number(menv, "-17"))), enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[5], xs[9]), msat_make_number(menv, "7"))))
