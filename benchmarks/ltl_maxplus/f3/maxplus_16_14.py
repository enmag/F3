...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (X ((G (x_6 - x_1 >= -12)) U (x_14 - x_6 >= 16)))
    ltl = enc.make_X(enc.make_U(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[6], xs[1]), msat_make_number(menv, "-12"))), msat_make_geq(menv, msat_make_minus(menv, xs[14], xs[6]), msat_make_number(menv, "16"))))
