...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((X (x_0 - x_4 > 7)) & (G (x_7 - x_0 > -9)))
    ltl = msat_make_and(menv, enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[0], xs[4]), msat_make_number(menv, "7"))), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[7], xs[0]), msat_make_number(menv, "-9"))))
