...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr8 = msat_make_plus(menv, xs[10], n_6_0)
    ...
    # ltl property: (F ((x_34 - x_19 > -8) | (G (x_30 - x_13 >= -11))))
    ltl = enc.make_F(msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[34], xs[19]), msat_make_number(menv, "-8")), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[30], xs[13]), msat_make_number(menv, "-11")))))
