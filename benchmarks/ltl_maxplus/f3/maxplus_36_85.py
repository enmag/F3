...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr9 = msat_make_plus(menv, xs[12], n_10_0)
    ...
    expr11 = msat_make_plus(menv, xs[14], n_16_0)
    ...
    expr8 = msat_make_plus(menv, xs[9], n_8_0)
    ...
    expr13 = msat_make_plus(menv, xs[18], n_15_0)
    ...
    # ltl property: ((G (x_18 - x_2 >= -8)) | (F (x_20 - x_6 > -6)))
    ltl = msat_make_or(menv, enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[18], xs[2]), msat_make_number(menv, "-8"))), enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[20], xs[6]), msat_make_number(menv, "-6"))))
