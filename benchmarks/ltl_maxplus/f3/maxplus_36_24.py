...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_19 - x_24 > -12) | ((x_13 - x_19 >= 12) & (x_14 - x_28 > -7)))
    ltl = msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[19], xs[24]), msat_make_number(menv, "-12")), msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[13], xs[19]), msat_make_number(menv, "12")), msat_make_gt(menv, msat_make_minus(menv, xs[14], xs[28]), msat_make_number(menv, "-7"))))
