...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((G (x_8 - x_4 > -2)) & (F (x_3 - x_4 >= 18)))
    ltl = msat_make_and(menv, enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[8], xs[4]), msat_make_number(menv, "-2"))), enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[3], xs[4]), msat_make_number(menv, "18"))))
