...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((F (x_5 - x_3 > -3)) U (G (x_9 - x_1 > -18)))
    ltl = enc.make_U(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[5], xs[3]), msat_make_number(menv, "-3"))), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[9], xs[1]), msat_make_number(menv, "-18"))))
