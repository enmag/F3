...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((X (x_5 - x_1 > 17)) U (X (x_6 - x_1 >= -2)))
    ltl = enc.make_U(enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[5], xs[1]), msat_make_number(menv, "17"))), enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[6], xs[1]), msat_make_number(menv, "-2"))))
