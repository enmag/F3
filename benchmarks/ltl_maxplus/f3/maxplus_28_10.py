...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (X (X (! ((! (x_12 - x_19 > 20)) U (! (x_24 - x_7 > -19))))))
    ltl = enc.make_X(enc.make_X(msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[12], xs[19]), msat_make_number(menv, "20"))), msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[24], xs[7]), msat_make_number(menv, "-19")))))))
