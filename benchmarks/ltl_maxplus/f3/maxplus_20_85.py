...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((G (x_11 - x_3 >= -19)) | (F (x_9 - x_14 > 19)))
    ltl = msat_make_or(menv, enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[11], xs[3]), msat_make_number(menv, "-19"))), enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[9], xs[14]), msat_make_number(menv, "19"))))
