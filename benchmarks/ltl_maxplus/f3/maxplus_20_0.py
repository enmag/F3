...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (X ((F (x_17 - x_9 > 14)) U (x_13 - x_3 > 6)))
    ltl = enc.make_X(enc.make_U(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[17], xs[9]), msat_make_number(menv, "14"))), msat_make_gt(menv, msat_make_minus(menv, xs[13], xs[3]), msat_make_number(menv, "6"))))
