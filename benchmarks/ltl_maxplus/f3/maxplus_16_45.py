...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((G (x_15 - x_3 >= -15)) U (G (x_8 - x_2 >= 0)))
    ltl = enc.make_U(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[15], xs[3]), msat_make_number(menv, "-15"))), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[8], xs[2]), msat_make_number(menv, "0"))))
