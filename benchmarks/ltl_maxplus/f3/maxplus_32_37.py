...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr1 = msat_make_plus(menv, xs[9], n_5_0)
    ...
    # ltl property: ((x_4 - x_28 > -19) | ((x_13 - x_12 >= -6) & (x_12 - x_22 > -19)))
    ltl = msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[4], xs[28]), msat_make_number(menv, "-19")), msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[13], xs[12]), msat_make_number(menv, "-6")), msat_make_gt(menv, msat_make_minus(menv, xs[12], xs[22]), msat_make_number(menv, "-19"))))
