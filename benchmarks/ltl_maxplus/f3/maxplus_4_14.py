...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (X ((G (x_1 - x_0 >= 6)) U (x_0 - x_3 >= 15)))
    ltl = enc.make_X(enc.make_U(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[1], xs[0]), msat_make_number(menv, "6"))), msat_make_geq(menv, msat_make_minus(menv, xs[0], xs[3]), msat_make_number(menv, "15"))))
