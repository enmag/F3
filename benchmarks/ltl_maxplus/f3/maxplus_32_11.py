...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr13 = msat_make_plus(menv, xs[18], n_16_0)
    ...
    # ltl property: (F ((x_0 - x_11 >= 19) U (G (x_19 - x_4 >= -17))))
    ltl = enc.make_F(enc.make_U(msat_make_geq(menv, msat_make_minus(menv, xs[0], xs[11]), msat_make_number(menv, "19")), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[19], xs[4]), msat_make_number(menv, "-17")))))
