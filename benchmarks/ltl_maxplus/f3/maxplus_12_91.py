...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (X (F (G (F (x_11 - x_0 > -4)))))
    ltl = enc.make_X(enc.make_F(enc.make_G(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[11], xs[0]), msat_make_number(menv, "-4"))))))
