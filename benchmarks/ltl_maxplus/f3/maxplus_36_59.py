...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr1 = msat_make_plus(menv, xs[11], n_17_0)
    expr2 = msat_make_plus(menv, xs[14], n_6_0)
    expr3 = msat_make_plus(menv, xs[15], n_17_0)
    ...
    expr14 = msat_make_plus(menv, xs[21], n_10_0)
    expr15 = msat_make_plus(menv, xs[23], n_10_0)
    ...
    # ltl property: ((x_9 - x_17 > -12) | (X (F (x_14 - x_21 > 11))))
    ltl = msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[9], xs[17]), msat_make_number(menv, "-12")), enc.make_X(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[14], xs[21]), msat_make_number(menv, "11")))))
