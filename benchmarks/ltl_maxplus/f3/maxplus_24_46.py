...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((X (x_17 - x_0 > -6)) | (F (x_23 - x_2 > 4)))
    ltl = msat_make_or(menv, enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[17], xs[0]), msat_make_number(menv, "-6"))), enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[23], xs[2]), msat_make_number(menv, "4"))))
