...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr2 = msat_make_plus(menv, xs[8], n_3_0)
    ...
    expr4 = msat_make_plus(menv, xs[5], n_17_0)
    ...
    expr10 = msat_make_plus(menv, xs[15], n_2_0)
    expr11 = msat_make_plus(menv, xs[16], n_4_0)
    expr12 = msat_make_plus(menv, xs[17], n_20_0)
    expr13 = msat_make_plus(menv, xs[18], n_12_0)
    expr14 = msat_make_plus(menv, xs[20], n_5_0)
    expr15 = msat_make_plus(menv, xs[22], n_18_0)
    expr16 = msat_make_plus(menv, xs[23], n_6_0)
    expr17 = msat_make_plus(menv, xs[24], n_10_0)
    expr18 = msat_make_plus(menv, xs[26], n_9_0)
    expr19 = msat_make_plus(menv, xs[31], n_12_0)
    _t = msat_make_and(menv,
    ...
    expr8 = msat_make_plus(menv, xs[14], n_2_0)
    ...
    expr13 = msat_make_plus(menv, xs[21], n_13_0)
    ...
    expr18 = msat_make_plus(menv, xs[29], n_17_0)
    ...
    expr7 = msat_make_plus(menv, xs[10], n_4_0)
    expr8 = msat_make_plus(menv, xs[11], n_9_0)
    expr9 = msat_make_plus(menv, xs[13], n_6_0)
    expr10 = msat_make_plus(menv, xs[14], n_2_0)
    ...
    expr16 = msat_make_plus(menv, xs[28], n_13_0)
    ...
    expr11 = msat_make_plus(menv, xs[22], n_3_0)
    expr12 = msat_make_plus(menv, xs[29], n_19_0)
    ...
    expr2 = msat_make_plus(menv, xs[7], n_6_0)
    expr3 = msat_make_plus(menv, xs[14], n_9_0)
    expr4 = msat_make_plus(menv, xs[15], n_4_0)
    ...
    expr12 = msat_make_plus(menv, xs[30], n_1_0)
    ...
    expr19 = msat_make_plus(menv, xs[33], n_10_0)
    _t = msat_make_and(menv,
    ...
    expr0 = msat_make_plus(menv, xs[4], n_12_0)
    expr1 = msat_make_plus(menv, xs[5], n_10_0)
    ...
    # ltl property: ((x_25 - x_9 >= 11) | (! ((! (x_22 - x_36 >= -6)) U (! (x_17 - x_11 >= -20)))))
    ltl = msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[25], xs[9]), msat_make_number(menv, "11")), msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_geq(menv, msat_make_minus(menv, xs[22], xs[36]), msat_make_number(menv, "-6"))), msat_make_not(menv, msat_make_geq(menv, msat_make_minus(menv, xs[17], xs[11]), msat_make_number(menv, "-20"))))))
