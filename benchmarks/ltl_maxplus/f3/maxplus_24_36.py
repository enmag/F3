...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((F (x_18 - x_12 > -19)) U (G (x_11 - x_8 > -2)))
    ltl = enc.make_U(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[18], xs[12]), msat_make_number(menv, "-19"))), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[11], xs[8]), msat_make_number(menv, "-2"))))
