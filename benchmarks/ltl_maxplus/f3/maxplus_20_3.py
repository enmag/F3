...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F (X ((x_19 - x_17 >= -2) & (x_0 - x_7 >= -18))))
    ltl = enc.make_F(enc.make_X(msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[19], xs[17]), msat_make_number(menv, "-2")), msat_make_geq(menv, msat_make_minus(menv, xs[0], xs[7]), msat_make_number(menv, "-18")))))
