...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr3 = msat_make_plus(menv, xs[13], n_3_0)
    ...
    expr14 = msat_make_plus(menv, xs[24], n_16_0)
    ...
    expr5 = msat_make_plus(menv, xs[5], n_2_0)
    ...
    expr14 = msat_make_plus(menv, xs[21], n_6_0)
    expr15 = msat_make_plus(menv, xs[22], n_17_0)
    ...
    # ltl property: ((X (x_9 - x_18 >= -10)) U (X (x_25 - x_30 > 12)))
    ltl = enc.make_U(enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[9], xs[18]), msat_make_number(menv, "-10"))), enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[25], xs[30]), msat_make_number(menv, "12"))))
