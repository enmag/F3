...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (G ((X (x_24 - x_27 > -5)) U (x_7 - x_2 >= 18)))
    ltl = enc.make_G(enc.make_U(enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[24], xs[27]), msat_make_number(menv, "-5"))), msat_make_geq(menv, msat_make_minus(menv, xs[7], xs[2]), msat_make_number(menv, "18"))))
