...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (X ((x_27 - x_17 > 2) & (X (x_22 - x_24 >= 20))))
    ltl = enc.make_X(msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[27], xs[17]), msat_make_number(menv, "2")), enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[22], xs[24]), msat_make_number(menv, "20")))))
