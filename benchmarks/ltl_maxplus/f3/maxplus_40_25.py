...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr17 = msat_make_plus(menv, xs[28], n_12_0)
    expr18 = msat_make_plus(menv, xs[30], n_8_0)
    ...
    expr16 = msat_make_plus(menv, xs[26], n_14_0)
    ...
    # ltl property: ((G (x_1 - x_22 > 15)) & (F (x_32 - x_22 >= -2)))
    ltl = msat_make_and(menv, enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[1], xs[22]), msat_make_number(menv, "15"))), enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[32], xs[22]), msat_make_number(menv, "-2"))))
