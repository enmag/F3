...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((G (x_4 - x_1 >= 20)) U (G (x_10 - x_11 > -7)))
    ltl = enc.make_U(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[4], xs[1]), msat_make_number(menv, "20"))), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[10], xs[11]), msat_make_number(menv, "-7"))))
