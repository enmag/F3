...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_2 - x_1 > -8) | ((x_3 - x_4 >= 18) & (x_6 - x_7 > -19)))
    ltl = msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[2], xs[1]), msat_make_number(menv, "-8")), msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[3], xs[4]), msat_make_number(menv, "18")), msat_make_gt(menv, msat_make_minus(menv, xs[6], xs[7]), msat_make_number(menv, "-19"))))
