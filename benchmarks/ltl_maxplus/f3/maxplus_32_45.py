...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr12 = msat_make_plus(menv, xs[16], n_18_0)
    ...
    expr7 = msat_make_plus(menv, xs[9], n_13_0)
    ...
    # ltl property: ((G (x_28 - x_2 >= -16)) U (G (x_22 - x_3 > 8)))
    ltl = enc.make_U(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[28], xs[2]), msat_make_number(menv, "-16"))), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[22], xs[3]), msat_make_number(menv, "8"))))
