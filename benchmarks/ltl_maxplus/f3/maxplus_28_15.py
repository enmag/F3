...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F ((x_10 - x_20 >= 17) | (G (x_22 - x_25 >= -20))))
    ltl = enc.make_F(msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[10], xs[20]), msat_make_number(menv, "17")), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[22], xs[25]), msat_make_number(menv, "-20")))))
