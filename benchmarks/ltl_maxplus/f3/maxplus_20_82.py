...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((X (x_2 - x_15 > -9)) | (G (x_15 - x_19 > -13)))
    ltl = msat_make_or(menv, enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[2], xs[15]), msat_make_number(menv, "-9"))), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[15], xs[19]), msat_make_number(menv, "-13"))))
