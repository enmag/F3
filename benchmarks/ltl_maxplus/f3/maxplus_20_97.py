...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (G ((X (x_15 - x_17 > -20)) U (x_10 - x_14 > 7)))
    ltl = enc.make_G(enc.make_U(enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[15], xs[17]), msat_make_number(menv, "-20"))), msat_make_gt(menv, msat_make_minus(menv, xs[10], xs[14]), msat_make_number(menv, "7"))))
