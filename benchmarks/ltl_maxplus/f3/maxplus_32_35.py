...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((G (x_2 - x_4 > -12)) & (F (x_1 - x_15 >= -20)))
    ltl = msat_make_and(menv, enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[2], xs[4]), msat_make_number(menv, "-12"))), enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[1], xs[15]), msat_make_number(menv, "-20"))))
