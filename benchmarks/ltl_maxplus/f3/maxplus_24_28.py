...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (X ((x_17 - x_15 > 19) & (G (x_19 - x_16 >= -4))))
    ltl = enc.make_X(msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[17], xs[15]), msat_make_number(menv, "19")), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[19], xs[16]), msat_make_number(menv, "-4")))))
