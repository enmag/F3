...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((G (x_10 - x_5 > 1)) U (G (x_10 - x_3 >= -10)))
    ltl = enc.make_U(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[10], xs[5]), msat_make_number(menv, "1"))), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[10], xs[3]), msat_make_number(menv, "-10"))))
