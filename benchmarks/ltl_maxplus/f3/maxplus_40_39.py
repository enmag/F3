...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr19 = msat_make_plus(menv, xs[34], n_2_0)
    _t = msat_make_and(menv,
    ...
    expr7 = msat_make_plus(menv, xs[8], n_12_0)
    ...
    expr2 = msat_make_plus(menv, xs[11], n_11_0)
    ...
    expr2 = msat_make_plus(menv, xs[12], n_7_0)
    expr3 = msat_make_plus(menv, xs[14], n_10_0)
    expr4 = msat_make_plus(menv, xs[15], n_9_0)
    ...
    expr4 = msat_make_plus(menv, xs[13], n_10_0)
    ...
    expr16 = msat_make_plus(menv, xs[26], n_9_0)
    expr17 = msat_make_plus(menv, xs[30], n_9_0)
    expr18 = msat_make_plus(menv, xs[31], n_4_0)
    ...
    # ltl property: (F (G ((x_14 - x_29 >= -2) & (x_38 - x_7 >= -19))))
    ltl = enc.make_F(enc.make_G(msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[14], xs[29]), msat_make_number(menv, "-2")), msat_make_geq(menv, msat_make_minus(menv, xs[38], xs[7]), msat_make_number(menv, "-19")))))
