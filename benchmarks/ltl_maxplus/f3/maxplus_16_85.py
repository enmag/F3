...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((G (x_7 - x_10 > 4)) | (F (x_2 - x_8 >= 17)))
    ltl = msat_make_or(menv, enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[7], xs[10]), msat_make_number(menv, "4"))), enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[2], xs[8]), msat_make_number(menv, "17"))))
