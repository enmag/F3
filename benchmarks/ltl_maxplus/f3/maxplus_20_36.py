...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((F (x_18 - x_17 >= -1)) U (G (x_0 - x_13 >= -7)))
    ltl = enc.make_U(enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[18], xs[17]), msat_make_number(menv, "-1"))), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[0], xs[13]), msat_make_number(menv, "-7"))))
