...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (X ((x_0 - x_3 > -3) | (X (x_2 - x_0 > 13))))
    ltl = enc.make_X(msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[0], xs[3]), msat_make_number(menv, "-3")), enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[2], xs[0]), msat_make_number(menv, "13")))))
