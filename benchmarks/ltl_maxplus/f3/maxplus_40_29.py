...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr17 = msat_make_plus(menv, xs[30], n_20_0)
    ...
    expr3 = msat_make_plus(menv, xs[13], n_5_0)
    ...
    expr19 = msat_make_plus(menv, xs[34], n_9_0)
    _t = msat_make_and(menv,
    ...
    expr14 = msat_make_plus(menv, xs[21], n_15_0)
    expr15 = msat_make_plus(menv, xs[22], n_20_0)
    expr16 = msat_make_plus(menv, xs[25], n_11_0)
    expr17 = msat_make_plus(menv, xs[27], n_20_0)
    expr18 = msat_make_plus(menv, xs[28], n_2_0)
    expr19 = msat_make_plus(menv, xs[30], n_18_0)
    _t = msat_make_and(menv,
    ...
    expr6 = msat_make_plus(menv, xs[20], n_16_0)
    expr7 = msat_make_plus(menv, xs[21], n_6_0)
    expr8 = msat_make_plus(menv, xs[23], n_13_0)
    ...
    # ltl property: (! ((! (X (F (x_6 - x_24 >= 20)))) U (! (x_33 - x_13 > -17))))
    ltl = msat_make_not(menv, enc.make_U(msat_make_not(menv, enc.make_X(enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[6], xs[24]), msat_make_number(menv, "20"))))), msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[33], xs[13]), msat_make_number(menv, "-17")))))
