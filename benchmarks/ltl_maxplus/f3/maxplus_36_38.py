...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr12 = msat_make_plus(menv, xs[16], n_1_0)
    expr13 = msat_make_plus(menv, xs[18], n_20_0)
    expr14 = msat_make_plus(menv, xs[22], n_18_0)
    expr15 = msat_make_plus(menv, xs[23], n_20_0)
    ...
    expr5 = msat_make_plus(menv, xs[5], n_20_0)
    ...
    expr16 = msat_make_plus(menv, xs[24], n_18_0)
    ...
    # ltl property: (G (X (! ((! (x_4 - x_31 > 15)) U (! (x_11 - x_24 > 10))))))
    ltl = enc.make_G(enc.make_X(msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[4], xs[31]), msat_make_number(menv, "15"))), msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[11], xs[24]), msat_make_number(menv, "10")))))))
