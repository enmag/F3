...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (X ((x_6 - x_0 > 15) | (G (x_4 - x_5 > 20))))
    ltl = enc.make_X(msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[6], xs[0]), msat_make_number(menv, "15")), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[4], xs[5]), msat_make_number(menv, "20")))))
