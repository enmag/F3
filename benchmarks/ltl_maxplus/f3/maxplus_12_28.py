...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (X ((x_1 - x_2 >= -20) & (G (x_2 - x_8 >= -16))))
    ltl = enc.make_X(msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[1], xs[2]), msat_make_number(menv, "-20")), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[2], xs[8]), msat_make_number(menv, "-16")))))
