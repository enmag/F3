...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((X (x_0 - x_3 > -18)) | (X (x_0 - x_2 > 13)))
    ltl = msat_make_or(menv, enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[0], xs[3]), msat_make_number(menv, "-18"))), enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[0], xs[2]), msat_make_number(menv, "13"))))
