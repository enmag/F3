...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F (G ((x_25 - x_9 >= 2) & (x_4 - x_25 >= 2))))
    ltl = enc.make_F(enc.make_G(msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[25], xs[9]), msat_make_number(menv, "2")), msat_make_geq(menv, msat_make_minus(menv, xs[4], xs[25]), msat_make_number(menv, "2")))))
