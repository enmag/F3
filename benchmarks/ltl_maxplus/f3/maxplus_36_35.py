...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr0 = msat_make_plus(menv, xs[8], n_10_0)
    ...
    expr9 = msat_make_plus(menv, xs[26], n_4_0)
    ...
    expr4 = msat_make_plus(menv, xs[18], n_13_0)
    expr5 = msat_make_plus(menv, xs[19], n_6_0)
    expr6 = msat_make_plus(menv, xs[21], n_14_0)
    expr7 = msat_make_plus(menv, xs[22], n_15_0)
    expr8 = msat_make_plus(menv, xs[24], n_12_0)
    ...
    # ltl property: ((G (x_9 - x_23 > -9)) & (F (x_26 - x_21 >= -4)))
    ltl = msat_make_and(menv, enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[9], xs[23]), msat_make_number(menv, "-9"))), enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[26], xs[21]), msat_make_number(menv, "-4"))))
