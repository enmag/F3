...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_14 - x_11 > -11) | (G (F (x_11 - x_23 > 13))))
    ltl = msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[14], xs[11]), msat_make_number(menv, "-11")), enc.make_G(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[11], xs[23]), msat_make_number(menv, "13")))))
