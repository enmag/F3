...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((X (x_2 - x_20 >= -12)) U (G (x_22 - x_31 >= 6)))
    ltl = enc.make_U(enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[2], xs[20]), msat_make_number(menv, "-12"))), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[22], xs[31]), msat_make_number(menv, "6"))))
