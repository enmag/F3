...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr19 = msat_make_plus(menv, xs[32], n_13_0)
    _t = msat_make_and(menv,
    ...
    expr18 = msat_make_plus(menv, xs[32], n_4_0)
    expr19 = msat_make_plus(menv, xs[33], n_9_0)
    _t = msat_make_and(menv,
    ...
    expr16 = msat_make_plus(menv, xs[26], n_1_0)
    ...
    expr0 = msat_make_plus(menv, xs[4], n_13_0)
    expr1 = msat_make_plus(menv, xs[5], n_7_0)
    ...
    expr11 = msat_make_plus(menv, xs[15], n_19_0)
    expr12 = msat_make_plus(menv, xs[16], n_13_0)
    ...
    expr8 = msat_make_plus(menv, xs[23], n_19_0)
    ...
    expr16 = msat_make_plus(menv, xs[27], n_8_0)
    ...
    expr6 = msat_make_plus(menv, xs[6], n_8_0)
    ...
    expr8 = msat_make_plus(menv, xs[11], n_11_0)
    ...
    expr17 = msat_make_plus(menv, xs[28], n_6_0)
    expr18 = msat_make_plus(menv, xs[36], n_1_0)
    expr19 = msat_make_plus(menv, xs[39], n_9_0)
    _t = msat_make_and(menv,
    ...
    # ltl property: (X ((x_16 - x_32 > -18) & (X (x_5 - x_7 > -7))))
    ltl = enc.make_X(msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[16], xs[32]), msat_make_number(menv, "-18")), enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[5], xs[7]), msat_make_number(menv, "-7")))))
