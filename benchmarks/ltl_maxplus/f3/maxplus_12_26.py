...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_6 - x_0 >= 18) | ((x_7 - x_11 > 20) & (x_1 - x_7 > -9)))
    ltl = msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[6], xs[0]), msat_make_number(menv, "18")), msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[7], xs[11]), msat_make_number(menv, "20")), msat_make_gt(menv, msat_make_minus(menv, xs[1], xs[7]), msat_make_number(menv, "-9"))))
