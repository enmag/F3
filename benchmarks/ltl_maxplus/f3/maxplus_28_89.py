...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F (! ((! (x_27 - x_11 > 18)) U (! (X (x_1 - x_4 > -4))))))
    ltl = enc.make_F(msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[27], xs[11]), msat_make_number(menv, "18"))), msat_make_not(menv, enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[1], xs[4]), msat_make_number(menv, "-4")))))))
