...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr0 = msat_make_plus(menv, xs[8], n_18_0)
    ...
    # ltl property: (G (! ((! (x_0 - x_2 >= 4)) U (! (X (x_27 - x_4 >= 12))))))
    ltl = enc.make_G(msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_geq(menv, msat_make_minus(menv, xs[0], xs[2]), msat_make_number(menv, "4"))), msat_make_not(menv, enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[27], xs[4]), msat_make_number(menv, "12")))))))
