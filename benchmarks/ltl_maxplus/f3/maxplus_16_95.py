...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (((x_1 - x_13 > 10) | (x_15 - x_7 > 17)) U (x_3 - x_4 >= -4))
    ltl = enc.make_U(msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[1], xs[13]), msat_make_number(menv, "10")), msat_make_gt(menv, msat_make_minus(menv, xs[15], xs[7]), msat_make_number(menv, "17"))), msat_make_geq(menv, msat_make_minus(menv, xs[3], xs[4]), msat_make_number(menv, "-4")))
