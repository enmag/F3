...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (G ((G (x_15 - x_17 >= 0)) U (x_30 - x_5 > 9)))
    ltl = enc.make_G(enc.make_U(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[15], xs[17]), msat_make_number(menv, "0"))), msat_make_gt(menv, msat_make_minus(menv, xs[30], xs[5]), msat_make_number(menv, "9"))))
