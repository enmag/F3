...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr11 = msat_make_plus(menv, xs[14], n_8_0)
    ...
    # ltl property: (X (F (G (X (x_22 - x_7 > -16)))))
    ltl = enc.make_X(enc.make_F(enc.make_G(enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[22], xs[7]), msat_make_number(menv, "-16"))))))
