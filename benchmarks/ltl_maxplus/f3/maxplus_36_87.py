...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr0 = msat_make_plus(menv, xs[8], n_4_0)
    expr1 = msat_make_plus(menv, xs[10], n_16_0)
    expr2 = msat_make_plus(menv, xs[12], n_13_0)
    ...
    expr8 = msat_make_plus(menv, xs[9], n_10_0)
    expr9 = msat_make_plus(menv, xs[11], n_9_0)
    ...
    expr5 = msat_make_plus(menv, xs[5], n_1_0)
    ...
    expr6 = msat_make_plus(menv, xs[6], n_15_0)
    ...
    # ltl property: (F ((x_23 - x_18 > 13) | (G (x_23 - x_18 > 13))))
    ltl = enc.make_F(msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[23], xs[18]), msat_make_number(menv, "13")), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[23], xs[18]), msat_make_number(menv, "13")))))
