...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr6 = msat_make_plus(menv, xs[8], n_15_0)
    ...
    expr5 = msat_make_plus(menv, xs[15], n_11_0)
    ...
    expr10 = msat_make_plus(menv, xs[13], n_17_0)
    expr11 = msat_make_plus(menv, xs[14], n_15_0)
    ...
    expr2 = msat_make_plus(menv, xs[9], n_7_0)
    ...
    expr19 = msat_make_plus(menv, xs[33], n_4_0)
    _t = msat_make_and(menv,
    ...
    expr14 = msat_make_plus(menv, xs[23], n_10_0)
    ...
    expr11 = msat_make_plus(menv, xs[14], n_11_0)
    expr12 = msat_make_plus(menv, xs[17], n_13_0)
    expr13 = msat_make_plus(menv, xs[18], n_7_0)
    ...
    expr5 = msat_make_plus(menv, xs[5], n_10_0)
    ...
    # ltl property: (G ((x_12 - x_9 > -6) | (X (x_39 - x_23 >= -5))))
    ltl = enc.make_G(msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[12], xs[9]), msat_make_number(menv, "-6")), enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[39], xs[23]), msat_make_number(menv, "-5")))))
