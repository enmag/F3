...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr2 = msat_make_plus(menv, xs[14], n_14_0)
    expr3 = msat_make_plus(menv, xs[15], n_19_0)
    ...
    # ltl property: ((X (X (x_2 - x_8 >= -19))) U (x_1 - x_5 > -7))
    ltl = enc.make_U(enc.make_X(enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[2], xs[8]), msat_make_number(menv, "-19")))), msat_make_gt(menv, msat_make_minus(menv, xs[1], xs[5]), msat_make_number(menv, "-7")))
