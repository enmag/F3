...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_10 - x_11 > -3) U ((x_21 - x_20 >= -13) U (x_4 - x_1 >= -10)))
    ltl = enc.make_U(msat_make_gt(menv, msat_make_minus(menv, xs[10], xs[11]), msat_make_number(menv, "-3")), enc.make_U(msat_make_geq(menv, msat_make_minus(menv, xs[21], xs[20]), msat_make_number(menv, "-13")), msat_make_geq(menv, msat_make_minus(menv, xs[4], xs[1]), msat_make_number(menv, "-10"))))
