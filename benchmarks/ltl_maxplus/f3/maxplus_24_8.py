...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr0 = msat_make_plus(menv, xs[7], n_10_0)
    ...
    # ltl property: ((G (x_14 - x_17 > 10)) U (X (x_11 - x_12 > 4)))
    ltl = enc.make_U(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[14], xs[17]), msat_make_number(menv, "10"))), enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[11], xs[12]), msat_make_number(menv, "4"))))
