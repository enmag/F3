...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F (X ((x_6 - x_0 >= -7) & (x_3 - x_4 > 0))))
    ltl = enc.make_F(enc.make_X(msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[6], xs[0]), msat_make_number(menv, "-7")), msat_make_gt(menv, msat_make_minus(menv, xs[3], xs[4]), msat_make_number(menv, "0")))))
