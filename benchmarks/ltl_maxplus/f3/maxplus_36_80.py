...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr16 = msat_make_plus(menv, xs[24], n_17_0)
    ...
    # ltl property: ((x_3 - x_28 > 1) | (G (F (x_28 - x_20 > 9))))
    ltl = msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[3], xs[28]), msat_make_number(menv, "1")), enc.make_G(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[28], xs[20]), msat_make_number(menv, "9")))))
