...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((F (x_0 - x_3 > 5)) & (X (x_2 - x_1 > -20)))
    ltl = msat_make_and(menv, enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[0], xs[3]), msat_make_number(menv, "5"))), enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[2], xs[1]), msat_make_number(menv, "-20"))))
