...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((X (x_6 - x_1 > 19)) U (X (x_0 - x_2 > -8)))
    ltl = enc.make_U(enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[6], xs[1]), msat_make_number(menv, "19"))), enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[0], xs[2]), msat_make_number(menv, "-8"))))
