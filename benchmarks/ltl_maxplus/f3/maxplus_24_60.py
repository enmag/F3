...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (G ((x_21 - x_10 >= -13) | (X (x_18 - x_22 >= -7))))
    ltl = enc.make_G(msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[21], xs[10]), msat_make_number(menv, "-13")), enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[18], xs[22]), msat_make_number(menv, "-7")))))
