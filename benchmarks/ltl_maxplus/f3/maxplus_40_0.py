...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr7 = msat_make_plus(menv, xs[22], n_10_0)
    ...
    expr12 = msat_make_plus(menv, xs[30], n_12_0)
    ...
    expr14 = msat_make_plus(menv, xs[22], n_3_0)
    ...
    # ltl property: (X ((F (x_4 - x_34 > 18)) U (x_5 - x_28 > 19)))
    ltl = enc.make_X(enc.make_U(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[4], xs[34]), msat_make_number(menv, "18"))), msat_make_gt(menv, msat_make_minus(menv, xs[5], xs[28]), msat_make_number(menv, "19"))))
