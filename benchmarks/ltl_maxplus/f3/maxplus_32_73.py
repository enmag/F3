...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr1 = msat_make_plus(menv, xs[12], n_9_0)
    expr2 = msat_make_plus(menv, xs[13], n_2_0)
    expr3 = msat_make_plus(menv, xs[14], n_18_0)
    ...
    expr0 = msat_make_plus(menv, xs[5], n_13_0)
    ...
    # ltl property: ((X (X (x_28 - x_8 > 16))) U (x_26 - x_14 > -19))
    ltl = enc.make_U(enc.make_X(enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[28], xs[8]), msat_make_number(menv, "16")))), msat_make_gt(menv, msat_make_minus(menv, xs[26], xs[14]), msat_make_number(menv, "-19")))
