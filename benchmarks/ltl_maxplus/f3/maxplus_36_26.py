...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_21 - x_23 >= 4) | ((x_11 - x_18 >= -17) & (x_10 - x_28 >= -15)))
    ltl = msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[21], xs[23]), msat_make_number(menv, "4")), msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[11], xs[18]), msat_make_number(menv, "-17")), msat_make_geq(menv, msat_make_minus(menv, xs[10], xs[28]), msat_make_number(menv, "-15"))))
