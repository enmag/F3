...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr15 = msat_make_plus(menv, xs[23], n_9_0)
    expr16 = msat_make_plus(menv, xs[26], n_6_0)
    expr17 = msat_make_plus(menv, xs[28], n_1_0)
    expr18 = msat_make_plus(menv, xs[29], n_11_0)
    ...
    expr13 = msat_make_plus(menv, xs[33], n_11_0)
    ...
    expr17 = msat_make_plus(menv, xs[30], n_3_0)
    ...
    expr0 = msat_make_plus(menv, xs[7], n_18_0)
    ...
    expr17 = msat_make_plus(menv, xs[30], n_4_0)
    ...
    # ltl property: (G ((x_7 - x_2 > 14) | (G (x_2 - x_7 > 17))))
    ltl = enc.make_G(msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[7], xs[2]), msat_make_number(menv, "14")), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[2], xs[7]), msat_make_number(menv, "17")))))
