...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr18 = msat_make_plus(menv, xs[31], n_14_0)
    ...
    expr2 = msat_make_plus(menv, xs[10], n_11_0)
    ...
    expr11 = msat_make_plus(menv, xs[26], n_1_0)
    expr12 = msat_make_plus(menv, xs[32], n_5_0)
    expr13 = msat_make_plus(menv, xs[33], n_16_0)
    expr14 = msat_make_plus(menv, xs[34], n_17_0)
    ...
    expr2 = msat_make_plus(menv, xs[15], n_7_0)
    expr3 = msat_make_plus(menv, xs[17], n_17_0)
    expr4 = msat_make_plus(menv, xs[18], n_17_0)
    expr5 = msat_make_plus(menv, xs[19], n_10_0)
    expr6 = msat_make_plus(menv, xs[20], n_12_0)
    ...
    # ltl property: (F ((F (x_0 - x_39 >= -10)) U (x_19 - x_0 > -17)))
    ltl = enc.make_F(enc.make_U(enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[0], xs[39]), msat_make_number(menv, "-10"))), msat_make_gt(menv, msat_make_minus(menv, xs[19], xs[0]), msat_make_number(menv, "-17"))))
