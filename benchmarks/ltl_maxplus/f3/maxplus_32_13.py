...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr13 = msat_make_plus(menv, xs[18], n_10_0)
    ...
    # ltl property: (F ((X (x_27 - x_8 >= -19)) U (x_12 - x_25 > 4)))
    ltl = enc.make_F(enc.make_U(enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[27], xs[8]), msat_make_number(menv, "-19"))), msat_make_gt(menv, msat_make_minus(menv, xs[12], xs[25]), msat_make_number(menv, "4"))))
