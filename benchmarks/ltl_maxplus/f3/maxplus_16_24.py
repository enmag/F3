...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_0 - x_10 >= -3) | ((x_12 - x_10 > -2) & (x_6 - x_8 > 18)))
    ltl = msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[0], xs[10]), msat_make_number(menv, "-3")), msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[12], xs[10]), msat_make_number(menv, "-2")), msat_make_gt(menv, msat_make_minus(menv, xs[6], xs[8]), msat_make_number(menv, "18"))))
