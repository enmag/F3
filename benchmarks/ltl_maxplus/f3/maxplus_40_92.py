...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr6 = msat_make_plus(menv, xs[19], n_5_0)
    ...
    expr11 = msat_make_plus(menv, xs[16], n_20_0)
    ...
    expr17 = msat_make_plus(menv, xs[31], n_13_0)
    expr18 = msat_make_plus(menv, xs[32], n_5_0)
    ...
    expr18 = msat_make_plus(menv, xs[30], n_20_0)
    ...
    expr1 = msat_make_plus(menv, xs[4], n_20_0)
    expr2 = msat_make_plus(menv, xs[9], n_15_0)
    ...
    expr19 = msat_make_plus(menv, xs[36], n_15_0)
    _t = msat_make_and(menv,
    ...
    expr13 = msat_make_plus(menv, xs[32], n_10_0)
    ...
    expr5 = msat_make_plus(menv, xs[16], n_12_0)
    ...
    expr3 = msat_make_plus(menv, xs[12], n_1_0)
    ...
    expr4 = msat_make_plus(menv, xs[17], n_18_0)
    ...
    # ltl property: (F (! ((! (x_36 - x_30 >= -8)) U (! (G (x_6 - x_10 >= 10))))))
    ltl = enc.make_F(msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_geq(menv, msat_make_minus(menv, xs[36], xs[30]), msat_make_number(menv, "-8"))), msat_make_not(menv, enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[6], xs[10]), msat_make_number(menv, "10")))))))
