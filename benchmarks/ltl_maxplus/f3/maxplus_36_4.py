...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((X (x_34 - x_31 >= 12)) | (G (x_1 - x_20 >= 0)))
    ltl = msat_make_or(menv, enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[34], xs[31]), msat_make_number(menv, "12"))), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[1], xs[20]), msat_make_number(menv, "0"))))
