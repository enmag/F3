...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr2 = msat_make_plus(menv, xs[9], n_11_0)
    ...
    expr10 = msat_make_plus(menv, xs[25], n_4_0)
    ...
    expr8 = msat_make_plus(menv, xs[22], n_13_0)
    expr9 = msat_make_plus(menv, xs[23], n_9_0)
    ...
    expr13 = msat_make_plus(menv, xs[32], n_16_0)
    ...
    expr13 = msat_make_plus(menv, xs[20], n_18_0)
    expr14 = msat_make_plus(menv, xs[25], n_11_0)
    expr15 = msat_make_plus(menv, xs[26], n_9_0)
    expr16 = msat_make_plus(menv, xs[27], n_9_0)
    ...
    expr6 = msat_make_plus(menv, xs[7], n_12_0)
    expr7 = msat_make_plus(menv, xs[8], n_9_0)
    expr8 = msat_make_plus(menv, xs[9], n_14_0)
    expr9 = msat_make_plus(menv, xs[10], n_3_0)
    expr10 = msat_make_plus(menv, xs[12], n_1_0)
    ...
    expr14 = msat_make_plus(menv, xs[34], n_9_0)
    ...
    expr9 = msat_make_plus(menv, xs[22], n_19_0)
    expr10 = msat_make_plus(menv, xs[23], n_16_0)
    ...
    expr3 = msat_make_plus(menv, xs[11], n_9_0)
    ...
    expr6 = msat_make_plus(menv, xs[7], n_20_0)
    expr7 = msat_make_plus(menv, xs[8], n_14_0)
    expr8 = msat_make_plus(menv, xs[9], n_18_0)
    ...
    expr15 = msat_make_plus(menv, xs[24], n_15_0)
    expr16 = msat_make_plus(menv, xs[27], n_2_0)
    ...
    # ltl property: (F ((x_15 - x_34 >= 16) U (F (x_29 - x_15 >= 0))))
    ltl = enc.make_F(enc.make_U(msat_make_geq(menv, msat_make_minus(menv, xs[15], xs[34]), msat_make_number(menv, "16")), enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[29], xs[15]), msat_make_number(menv, "0")))))
