...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (G ((x_24 - x_9 > 11) | (X (x_12 - x_1 >= 12))))
    ltl = enc.make_G(msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[24], xs[9]), msat_make_number(menv, "11")), enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[12], xs[1]), msat_make_number(menv, "12")))))
