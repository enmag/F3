...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (! ((! (X (F (x_7 - x_0 > -2)))) U (! (x_3 - x_15 > 7))))
    ltl = msat_make_not(menv, enc.make_U(msat_make_not(menv, enc.make_X(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[7], xs[0]), msat_make_number(menv, "-2"))))), msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[3], xs[15]), msat_make_number(menv, "7")))))
