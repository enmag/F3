...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (X (! ((! (F (x_1 - x_3 > 15))) U (! (x_1 - x_3 > 15)))))
    ltl = enc.make_X(msat_make_not(menv, enc.make_U(msat_make_not(menv, enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[1], xs[3]), msat_make_number(menv, "15")))), msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[1], xs[3]), msat_make_number(menv, "15"))))))
