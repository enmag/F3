...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (G ((x_13 - x_25 > 15) | (F (x_21 - x_6 > 4))))
    ltl = enc.make_G(msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[13], xs[25]), msat_make_number(menv, "15")), enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[21], xs[6]), msat_make_number(menv, "4")))))
