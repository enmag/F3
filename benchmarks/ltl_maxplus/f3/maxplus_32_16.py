...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr3 = msat_make_plus(menv, xs[14], n_6_0)
    ...
    # ltl property: ((G (x_15 - x_18 > -4)) U (X (x_30 - x_21 >= 10)))
    ltl = enc.make_U(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[15], xs[18]), msat_make_number(menv, "-4"))), enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[30], xs[21]), msat_make_number(menv, "10"))))
