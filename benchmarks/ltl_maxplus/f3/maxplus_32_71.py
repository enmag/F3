...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_29 - x_11 > -14) & (G (F (x_19 - x_9 > -3))))
    ltl = msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[29], xs[11]), msat_make_number(menv, "-14")), enc.make_G(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[19], xs[9]), msat_make_number(menv, "-3")))))
