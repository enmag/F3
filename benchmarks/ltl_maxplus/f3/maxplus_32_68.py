...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_2 - x_8 > -14) & (F (G (x_29 - x_24 > -16))))
    ltl = msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[2], xs[8]), msat_make_number(menv, "-14")), enc.make_F(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[29], xs[24]), msat_make_number(menv, "-16")))))
