...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((X (x_7 - x_19 > -10)) U (G (x_17 - x_26 >= 14)))
    ltl = enc.make_U(enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[7], xs[19]), msat_make_number(menv, "-10"))), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[17], xs[26]), msat_make_number(menv, "14"))))
