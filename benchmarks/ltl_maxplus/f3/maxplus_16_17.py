...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (F (X (X (G (x_5 - x_13 > 20)))))
    ltl = enc.make_F(enc.make_X(enc.make_X(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[5], xs[13]), msat_make_number(menv, "20"))))))
