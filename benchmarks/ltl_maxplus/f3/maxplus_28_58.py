...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (G ((G (x_5 - x_23 > 2)) U (x_11 - x_22 > -7)))
    ltl = enc.make_G(enc.make_U(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[5], xs[23]), msat_make_number(menv, "2"))), msat_make_gt(menv, msat_make_minus(menv, xs[11], xs[22]), msat_make_number(menv, "-7"))))
