...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_0 - x_3 > 8) U ((x_4 - x_5 >= 5) & (x_6 - x_7 > -4)))
    ltl = enc.make_U(msat_make_gt(menv, msat_make_minus(menv, xs[0], xs[3]), msat_make_number(menv, "8")), msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[4], xs[5]), msat_make_number(menv, "5")), msat_make_gt(menv, msat_make_minus(menv, xs[6], xs[7]), msat_make_number(menv, "-4"))))
