...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (F ((x_9 - x_23 > 15) & (G (x_14 - x_5 >= -7))))
    ltl = enc.make_F(msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[9], xs[23]), msat_make_number(menv, "15")), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[14], xs[5]), msat_make_number(menv, "-7")))))
