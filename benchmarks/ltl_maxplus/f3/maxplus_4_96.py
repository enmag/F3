...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (X (F (G (X (x_2 - x_1 >= 4)))))
    ltl = enc.make_X(enc.make_F(enc.make_G(enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[2], xs[1]), msat_make_number(menv, "4"))))))
