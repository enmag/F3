...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr8 = msat_make_plus(menv, xs[9], n_9_0)
    expr9 = msat_make_plus(menv, xs[10], n_15_0)
    ...
    expr3 = msat_make_plus(menv, xs[14], n_4_0)
    ...
    # ltl property: ((x_14 - x_12 > 17) U ((x_8 - x_20 >= 7) U (x_12 - x_4 > 3)))
    ltl = enc.make_U(msat_make_gt(menv, msat_make_minus(menv, xs[14], xs[12]), msat_make_number(menv, "17")), enc.make_U(msat_make_geq(menv, msat_make_minus(menv, xs[8], xs[20]), msat_make_number(menv, "7")), msat_make_gt(menv, msat_make_minus(menv, xs[12], xs[4]), msat_make_number(menv, "3"))))
