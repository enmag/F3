...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_31 - x_11 >= -5) U ((x_20 - x_21 >= 20) & (x_28 - x_11 > -8)))
    ltl = enc.make_U(msat_make_geq(menv, msat_make_minus(menv, xs[31], xs[11]), msat_make_number(menv, "-5")), msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[20], xs[21]), msat_make_number(menv, "20")), msat_make_gt(menv, msat_make_minus(menv, xs[28], xs[11]), msat_make_number(menv, "-8"))))
