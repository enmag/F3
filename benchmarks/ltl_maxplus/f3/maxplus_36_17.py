...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr4 = msat_make_plus(menv, xs[19], n_6_0)
    expr5 = msat_make_plus(menv, xs[20], n_17_0)
    expr6 = msat_make_plus(menv, xs[22], n_18_0)
    ...
    # ltl property: (F (X (X (G (x_32 - x_33 >= 2)))))
    ltl = enc.make_F(enc.make_X(enc.make_X(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[32], xs[33]), msat_make_number(menv, "2"))))))
