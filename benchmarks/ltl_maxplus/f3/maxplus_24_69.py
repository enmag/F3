...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (F (G (F (X (x_21 - x_4 >= 18)))))
    ltl = enc.make_F(enc.make_G(enc.make_F(enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[21], xs[4]), msat_make_number(menv, "18"))))))
