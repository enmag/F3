...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr5 = msat_make_plus(menv, xs[6], n_18_0)
    expr6 = msat_make_plus(menv, xs[7], n_2_0)
    expr7 = msat_make_plus(menv, xs[11], n_20_0)
    ...
    expr4 = msat_make_plus(menv, xs[16], n_12_0)
    expr5 = msat_make_plus(menv, xs[18], n_7_0)
    ...
    expr17 = msat_make_plus(menv, xs[30], n_7_0)
    ...
    expr8 = msat_make_plus(menv, xs[17], n_10_0)
    expr9 = msat_make_plus(menv, xs[21], n_15_0)
    ...
    expr3 = msat_make_plus(menv, xs[12], n_17_0)
    ...
    expr0 = msat_make_plus(menv, xs[9], n_13_0)
    expr1 = msat_make_plus(menv, xs[10], n_18_0)
    ...
    # ltl property: (F (! ((! (x_10 - x_24 >= 14)) U (! (X (x_18 - x_27 > 9))))))
    ltl = enc.make_F(msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_geq(menv, msat_make_minus(menv, xs[10], xs[24]), msat_make_number(menv, "14"))), msat_make_not(menv, enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[18], xs[27]), msat_make_number(menv, "9")))))))
