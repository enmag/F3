...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F ((X (x_5 - x_0 > -9)) U (x_3 - x_0 > -4)))
    ltl = enc.make_F(enc.make_U(enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[5], xs[0]), msat_make_number(menv, "-9"))), msat_make_gt(menv, msat_make_minus(menv, xs[3], xs[0]), msat_make_number(menv, "-4"))))
