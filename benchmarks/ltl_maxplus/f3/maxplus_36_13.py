...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr3 = msat_make_plus(menv, xs[8], n_10_0)
    expr4 = msat_make_plus(menv, xs[17], n_10_0)
    expr5 = msat_make_plus(menv, xs[19], n_8_0)
    expr6 = msat_make_plus(menv, xs[20], n_19_0)
    expr7 = msat_make_plus(menv, xs[21], n_18_0)
    ...
    # ltl property: (F ((X (x_33 - x_29 > 17)) U (x_34 - x_1 >= 18)))
    ltl = enc.make_F(enc.make_U(enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[33], xs[29]), msat_make_number(menv, "17"))), msat_make_geq(menv, msat_make_minus(menv, xs[34], xs[1]), msat_make_number(menv, "18"))))
