...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr13 = msat_make_plus(menv, xs[20], n_20_0)
    ...
    expr0 = msat_make_plus(menv, xs[6], n_17_0)
    ...
    # ltl property: ((X (X (x_4 - x_16 >= 18))) U (x_1 - x_31 >= -3))
    ltl = enc.make_U(enc.make_X(enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[4], xs[16]), msat_make_number(menv, "18")))), msat_make_geq(menv, msat_make_minus(menv, xs[1], xs[31]), msat_make_number(menv, "-3")))
