...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((G (x_11 - x_13 >= 18)) & (F (x_9 - x_7 >= -8)))
    ltl = msat_make_and(menv, enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[11], xs[13]), msat_make_number(menv, "18"))), enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[9], xs[7]), msat_make_number(menv, "-8"))))
