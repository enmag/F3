...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((G (x_4 - x_17 > -11)) U (G (x_13 - x_8 >= 7)))
    ltl = enc.make_U(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[4], xs[17]), msat_make_number(menv, "-11"))), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[13], xs[8]), msat_make_number(menv, "7"))))
