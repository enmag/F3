...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (G ((x_8 - x_22 >= 6) | (G (x_6 - x_14 >= 19))))
    ltl = enc.make_G(msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[8], xs[22]), msat_make_number(menv, "6")), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[6], xs[14]), msat_make_number(menv, "19")))))
