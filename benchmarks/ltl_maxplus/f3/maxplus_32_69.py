...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr10 = msat_make_plus(menv, xs[12], n_4_0)
    ...
    # ltl property: (F (G (F (X (x_29 - x_8 >= 18)))))
    ltl = enc.make_F(enc.make_G(enc.make_F(enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[29], xs[8]), msat_make_number(menv, "18"))))))
