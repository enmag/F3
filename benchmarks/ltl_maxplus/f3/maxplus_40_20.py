...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr14 = msat_make_plus(menv, xs[21], n_19_0)
    ...
    expr14 = msat_make_plus(menv, xs[25], n_19_0)
    expr15 = msat_make_plus(menv, xs[26], n_5_0)
    ...
    expr14 = msat_make_plus(menv, xs[21], n_19_0)
    expr15 = msat_make_plus(menv, xs[22], n_1_0)
    ...
    expr11 = msat_make_plus(menv, xs[27], n_4_0)
    ...
    expr17 = msat_make_plus(menv, xs[31], n_15_0)
    ...
    expr8 = msat_make_plus(menv, xs[9], n_12_0)
    ...
    # ltl property: ((x_31 - x_13 > -5) | (X (F (x_26 - x_2 >= -10))))
    ltl = msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[31], xs[13]), msat_make_number(menv, "-5")), enc.make_X(enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[26], xs[2]), msat_make_number(menv, "-10")))))
