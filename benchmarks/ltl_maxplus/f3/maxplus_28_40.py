...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((X (x_7 - x_11 >= 13)) | (X (x_25 - x_4 > -1)))
    ltl = msat_make_or(menv, enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[7], xs[11]), msat_make_number(menv, "13"))), enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[25], xs[4]), msat_make_number(menv, "-1"))))
