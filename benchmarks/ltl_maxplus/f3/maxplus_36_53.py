...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr3 = msat_make_plus(menv, xs[14], n_11_0)
    expr4 = msat_make_plus(menv, xs[17], n_1_0)
    expr5 = msat_make_plus(menv, xs[19], n_15_0)
    ...
    expr3 = msat_make_plus(menv, xs[14], n_8_0)
    ...
    # ltl property: (F ((F (x_11 - x_18 >= -6)) U (x_6 - x_11 > 13)))
    ltl = enc.make_F(enc.make_U(enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[11], xs[18]), msat_make_number(menv, "-6"))), msat_make_gt(menv, msat_make_minus(menv, xs[6], xs[11]), msat_make_number(menv, "13"))))
