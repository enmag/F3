...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((X (X (x_8 - x_0 >= 13))) U (x_8 - x_5 > -19))
    ltl = enc.make_U(enc.make_X(enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[8], xs[0]), msat_make_number(menv, "13")))), msat_make_gt(menv, msat_make_minus(menv, xs[8], xs[5]), msat_make_number(menv, "-19")))
