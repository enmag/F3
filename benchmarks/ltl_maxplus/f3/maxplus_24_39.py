...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F (G ((x_18 - x_12 >= -19) & (x_20 - x_1 > -18))))
    ltl = enc.make_F(enc.make_G(msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[18], xs[12]), msat_make_number(menv, "-19")), msat_make_gt(menv, msat_make_minus(menv, xs[20], xs[1]), msat_make_number(menv, "-18")))))
