...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((G (x_16 - x_10 > -20)) U (G (x_10 - x_0 >= -12)))
    ltl = enc.make_U(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[16], xs[10]), msat_make_number(menv, "-20"))), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[10], xs[0]), msat_make_number(menv, "-12"))))
