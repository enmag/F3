...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (X ((x_2 - x_12 > 11) U (G (x_13 - x_0 > -4))))
    ltl = enc.make_X(enc.make_U(msat_make_gt(menv, msat_make_minus(menv, xs[2], xs[12]), msat_make_number(menv, "11")), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[13], xs[0]), msat_make_number(menv, "-4")))))
