...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((G (x_10 - x_9 > 6)) U (G (x_24 - x_21 > -14)))
    ltl = enc.make_U(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[10], xs[9]), msat_make_number(menv, "6"))), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[24], xs[21]), msat_make_number(menv, "-14"))))
