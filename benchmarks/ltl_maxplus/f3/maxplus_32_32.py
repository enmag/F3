...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((F (x_5 - x_25 > -20)) & (X (x_30 - x_23 > -16)))
    ltl = msat_make_and(menv, enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[5], xs[25]), msat_make_number(menv, "-20"))), enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[30], xs[23]), msat_make_number(menv, "-16"))))
