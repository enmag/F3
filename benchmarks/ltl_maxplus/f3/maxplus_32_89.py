...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F (! ((! (x_6 - x_11 >= -4)) U (! (X (x_3 - x_20 > -18))))))
    ltl = enc.make_F(msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_geq(menv, msat_make_minus(menv, xs[6], xs[11]), msat_make_number(menv, "-4"))), msat_make_not(menv, enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[3], xs[20]), msat_make_number(menv, "-18")))))))
