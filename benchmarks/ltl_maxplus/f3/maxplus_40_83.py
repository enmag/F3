...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr6 = msat_make_plus(menv, xs[19], n_4_0)
    ...
    expr1 = msat_make_plus(menv, xs[6], n_15_0)
    ...
    expr16 = msat_make_plus(menv, xs[26], n_13_0)
    ...
    expr10 = msat_make_plus(menv, xs[30], n_5_0)
    expr11 = msat_make_plus(menv, xs[31], n_8_0)
    ...
    expr2 = msat_make_plus(menv, xs[4], n_17_0)
    expr3 = msat_make_plus(menv, xs[12], n_5_0)
    ...
    # ltl property: ((x_13 - x_12 >= -18) & ((x_39 - x_34 > -2) U (x_26 - x_19 >= -13)))
    ltl = msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[13], xs[12]), msat_make_number(menv, "-18")), enc.make_U(msat_make_gt(menv, msat_make_minus(menv, xs[39], xs[34]), msat_make_number(menv, "-2")), msat_make_geq(menv, msat_make_minus(menv, xs[26], xs[19]), msat_make_number(menv, "-13"))))
