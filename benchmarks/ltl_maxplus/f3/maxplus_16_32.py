...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((F (x_4 - x_10 >= -6)) & (X (x_7 - x_11 >= 17)))
    ltl = msat_make_and(menv, enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[4], xs[10]), msat_make_number(menv, "-6"))), enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[7], xs[11]), msat_make_number(menv, "17"))))
