...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr7 = msat_make_plus(menv, xs[23], n_9_0)
    expr8 = msat_make_plus(menv, xs[25], n_18_0)
    expr9 = msat_make_plus(menv, xs[27], n_12_0)
    ...
    expr4 = msat_make_plus(menv, xs[15], n_12_0)
    ...
    expr2 = msat_make_plus(menv, xs[13], n_6_0)
    expr3 = msat_make_plus(menv, xs[14], n_2_0)
    expr4 = msat_make_plus(menv, xs[16], n_18_0)
    ...
    # ltl property: ((x_5 - x_19 > 1) | ((x_0 - x_34 >= -4) & (x_20 - x_0 > 3)))
    ltl = msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[5], xs[19]), msat_make_number(menv, "1")), msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[0], xs[34]), msat_make_number(menv, "-4")), msat_make_gt(menv, msat_make_minus(menv, xs[20], xs[0]), msat_make_number(menv, "3"))))
