...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (X ((F (x_0 - x_13 >= 20)) U (x_9 - x_0 >= 11)))
    ltl = enc.make_X(enc.make_U(enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[0], xs[13]), msat_make_number(menv, "20"))), msat_make_geq(menv, msat_make_minus(menv, xs[9], xs[0]), msat_make_number(menv, "11"))))
