...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (F (X ((x_6 - x_17 > 12) & (x_18 - x_11 > 20))))
    ltl = enc.make_F(enc.make_X(msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[6], xs[17]), msat_make_number(menv, "12")), msat_make_gt(menv, msat_make_minus(menv, xs[18], xs[11]), msat_make_number(menv, "20")))))
