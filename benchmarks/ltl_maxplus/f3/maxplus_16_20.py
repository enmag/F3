...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_1 - x_0 > -9) | (X (F (x_0 - x_15 > 10))))
    ltl = msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[1], xs[0]), msat_make_number(menv, "-9")), enc.make_X(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[0], xs[15]), msat_make_number(menv, "10")))))
