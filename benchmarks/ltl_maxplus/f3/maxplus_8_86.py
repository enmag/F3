...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_0 - x_3 > -20) & (G (F (x_6 - x_3 >= 20))))
    ltl = msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[0], xs[3]), msat_make_number(menv, "-20")), enc.make_G(enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[6], xs[3]), msat_make_number(menv, "20")))))
