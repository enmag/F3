...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (G ((x_3 - x_22 > -17) | (F (x_23 - x_22 >= -3))))
    ltl = enc.make_G(msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[3], xs[22]), msat_make_number(menv, "-17")), enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[23], xs[22]), msat_make_number(menv, "-3")))))
