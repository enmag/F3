...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_14 - x_18 >= 17) & (G (F (x_9 - x_23 >= 4))))
    ltl = msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[14], xs[18]), msat_make_number(menv, "17")), enc.make_G(enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[9], xs[23]), msat_make_number(menv, "4")))))
