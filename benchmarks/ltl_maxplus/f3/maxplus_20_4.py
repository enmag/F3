...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((X (x_1 - x_2 > -12)) | (G (x_2 - x_6 >= 6)))
    ltl = msat_make_or(menv, enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[1], xs[2]), msat_make_number(menv, "-12"))), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[2], xs[6]), msat_make_number(menv, "6"))))
