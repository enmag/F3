...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr3 = msat_make_plus(menv, xs[14], n_14_0)
    ...
    # ltl property: ((X (x_2 - x_5 > -15)) | (G (x_17 - x_6 > -9)))
    ltl = msat_make_or(menv, enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[2], xs[5]), msat_make_number(menv, "-15"))), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[17], xs[6]), msat_make_number(menv, "-9"))))
