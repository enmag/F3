...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr1 = msat_make_plus(menv, xs[10], n_5_0)
    expr2 = msat_make_plus(menv, xs[13], n_18_0)
    ...
    expr15 = msat_make_plus(menv, xs[24], n_7_0)
    expr16 = msat_make_plus(menv, xs[28], n_19_0)
    ...
    # ltl property: ((X (x_6 - x_24 >= 17)) | (G (x_28 - x_23 > -11)))
    ltl = msat_make_or(menv, enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[6], xs[24]), msat_make_number(menv, "17"))), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[28], xs[23]), msat_make_number(menv, "-11"))))
