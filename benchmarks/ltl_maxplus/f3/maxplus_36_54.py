...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr3 = msat_make_plus(menv, xs[15], n_6_0)
    ...
    # ltl property: (X (! ((! (F (x_18 - x_12 > 5))) U (! (x_18 - x_12 > 5)))))
    ltl = enc.make_X(msat_make_not(menv, enc.make_U(msat_make_not(menv, enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[18], xs[12]), msat_make_number(menv, "5")))), msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[18], xs[12]), msat_make_number(menv, "5"))))))
