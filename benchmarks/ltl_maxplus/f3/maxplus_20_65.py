...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (G ((x_6 - x_9 > -1) | (G (x_1 - x_4 > 19))))
    ltl = enc.make_G(msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[6], xs[9]), msat_make_number(menv, "-1")), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[1], xs[4]), msat_make_number(menv, "19")))))
