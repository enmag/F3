...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((X (x_5 - x_14 >= 18)) U (X (x_17 - x_5 > -19)))
    ltl = enc.make_U(enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[5], xs[14]), msat_make_number(menv, "18"))), enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[17], xs[5]), msat_make_number(menv, "-19"))))
