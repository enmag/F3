...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr6 = msat_make_plus(menv, xs[22], n_13_0)
    expr7 = msat_make_plus(menv, xs[24], n_12_0)
    expr8 = msat_make_plus(menv, xs[25], n_15_0)
    expr9 = msat_make_plus(menv, xs[26], n_19_0)
    ...
    expr9 = msat_make_plus(menv, xs[26], n_14_0)
    ...
    expr1 = msat_make_plus(menv, xs[8], n_5_0)
    ...
    # ltl property: ((X (x_0 - x_2 >= -2)) | (X (x_7 - x_24 >= -16)))
    ltl = msat_make_or(menv, enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[0], xs[2]), msat_make_number(menv, "-2"))), enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[7], xs[24]), msat_make_number(menv, "-16"))))
