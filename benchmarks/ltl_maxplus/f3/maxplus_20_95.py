...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (((x_12 - x_17 >= -15) | (x_13 - x_4 >= 1)) U (x_12 - x_14 > 11))
    ltl = enc.make_U(msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[12], xs[17]), msat_make_number(menv, "-15")), msat_make_geq(menv, msat_make_minus(menv, xs[13], xs[4]), msat_make_number(menv, "1"))), msat_make_gt(menv, msat_make_minus(menv, xs[12], xs[14]), msat_make_number(menv, "11")))
