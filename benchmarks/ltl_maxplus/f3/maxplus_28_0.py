...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (X ((F (x_8 - x_13 >= -8)) U (x_10 - x_19 >= 17)))
    ltl = enc.make_X(enc.make_U(enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[8], xs[13]), msat_make_number(menv, "-8"))), msat_make_geq(menv, msat_make_minus(menv, xs[10], xs[19]), msat_make_number(menv, "17"))))
