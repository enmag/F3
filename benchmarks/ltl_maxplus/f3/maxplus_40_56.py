...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr7 = msat_make_plus(menv, xs[9], n_10_0)
    expr8 = msat_make_plus(menv, xs[10], n_8_0)
    expr9 = msat_make_plus(menv, xs[11], n_11_0)
    expr10 = msat_make_plus(menv, xs[13], n_9_0)
    ...
    expr5 = msat_make_plus(menv, xs[5], n_9_0)
    ...
    expr1 = msat_make_plus(menv, xs[6], n_1_0)
    ...
    expr14 = msat_make_plus(menv, xs[21], n_16_0)
    expr15 = msat_make_plus(menv, xs[23], n_3_0)
    expr16 = msat_make_plus(menv, xs[25], n_16_0)
    expr17 = msat_make_plus(menv, xs[26], n_16_0)
    expr18 = msat_make_plus(menv, xs[27], n_5_0)
    expr19 = msat_make_plus(menv, xs[39], n_9_0)
    _t = msat_make_and(menv,
    ...
    expr9 = msat_make_plus(menv, xs[11], n_6_0)
    ...
    expr10 = msat_make_plus(menv, xs[26], n_8_0)
    ...
    expr12 = msat_make_plus(menv, xs[29], n_12_0)
    ...
    # ltl property: ((x_25 - x_39 > -14) | (X (F (x_32 - x_10 >= 12))))
    ltl = msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[25], xs[39]), msat_make_number(menv, "-14")), enc.make_X(enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[32], xs[10]), msat_make_number(menv, "12")))))
