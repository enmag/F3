...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F ((x_2 - x_9 > 6) & (G (x_5 - x_33 > 5))))
    ltl = enc.make_F(msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[2], xs[9]), msat_make_number(menv, "6")), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[5], xs[33]), msat_make_number(menv, "5")))))
