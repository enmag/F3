...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (G ((G (x_10 - x_1 >= 12)) U (x_3 - x_10 > -15)))
    ltl = enc.make_G(enc.make_U(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[10], xs[1]), msat_make_number(menv, "12"))), msat_make_gt(menv, msat_make_minus(menv, xs[3], xs[10]), msat_make_number(menv, "-15"))))
