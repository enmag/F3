...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr0 = msat_make_plus(menv, xs[7], n_4_0)
    ...
    expr0 = msat_make_plus(menv, xs[8], n_19_0)
    ...
    # ltl property: ((X (x_29 - x_15 >= -7)) | (G (x_23 - x_16 >= 6)))
    ltl = msat_make_or(menv, enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[29], xs[15]), msat_make_number(menv, "-7"))), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[23], xs[16]), msat_make_number(menv, "6"))))
