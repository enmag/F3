...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((X (x_11 - x_4 > 14)) U (X (x_3 - x_10 >= 19)))
    ltl = enc.make_U(enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[11], xs[4]), msat_make_number(menv, "14"))), enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[3], xs[10]), msat_make_number(menv, "19"))))
