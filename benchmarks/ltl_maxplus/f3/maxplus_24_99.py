...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr0 = msat_make_plus(menv, xs[1], n_13_0)
    expr1 = msat_make_plus(menv, xs[10], n_15_0)
    ...
    # ltl property: (X ((x_15 - x_7 >= 5) | (G (x_0 - x_12 >= -20))))
    ltl = enc.make_X(msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[15], xs[7]), msat_make_number(menv, "5")), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[0], xs[12]), msat_make_number(menv, "-20")))))
