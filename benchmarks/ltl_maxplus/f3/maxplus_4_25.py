...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((G (x_2 - x_0 >= 20)) & (F (x_2 - x_3 >= 11)))
    ltl = msat_make_and(menv, enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[2], xs[0]), msat_make_number(menv, "20"))), enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[2], xs[3]), msat_make_number(menv, "11"))))
