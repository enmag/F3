...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (((x_7 - x_6 >= 9) | (x_0 - x_8 >= 6)) U (x_8 - x_7 > -20))
    ltl = enc.make_U(msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[7], xs[6]), msat_make_number(menv, "9")), msat_make_geq(menv, msat_make_minus(menv, xs[0], xs[8]), msat_make_number(menv, "6"))), msat_make_gt(menv, msat_make_minus(menv, xs[8], xs[7]), msat_make_number(menv, "-20")))
