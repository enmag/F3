...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (X ((x_6 - x_28 > 6) | (X (x_24 - x_0 >= 4))))
    ltl = enc.make_X(msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[6], xs[28]), msat_make_number(menv, "6")), enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[24], xs[0]), msat_make_number(menv, "4")))))
