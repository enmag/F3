...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (F (G ((x_14 - x_20 >= 14) & (x_3 - x_9 > -20))))
    ltl = enc.make_F(enc.make_G(msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[14], xs[20]), msat_make_number(menv, "14")), msat_make_gt(menv, msat_make_minus(menv, xs[3], xs[9]), msat_make_number(menv, "-20")))))
