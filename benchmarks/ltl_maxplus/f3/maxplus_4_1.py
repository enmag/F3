...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_2 - x_0 >= -17) | (X (G (x_2 - x_3 >= -1))))
    ltl = msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[2], xs[0]), msat_make_number(menv, "-17")), enc.make_X(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[2], xs[3]), msat_make_number(menv, "-1")))))
