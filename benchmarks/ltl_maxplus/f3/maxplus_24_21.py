...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr2 = msat_make_plus(menv, xs[12], n_9_0)
    ...
    # ltl property: (F (G ((x_20 - x_7 > -18) & (x_22 - x_11 >= 19))))
    ltl = enc.make_F(enc.make_G(msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[20], xs[7]), msat_make_number(menv, "-18")), msat_make_geq(menv, msat_make_minus(menv, xs[22], xs[11]), msat_make_number(menv, "19")))))
