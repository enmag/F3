...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F ((X (x_1 - x_7 > 2)) U (x_5 - x_8 >= 4)))
    ltl = enc.make_F(enc.make_U(enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[1], xs[7]), msat_make_number(menv, "2"))), msat_make_geq(menv, msat_make_minus(menv, xs[5], xs[8]), msat_make_number(menv, "4"))))
