...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr0 = msat_make_plus(menv, xs[7], n_17_0)
    ...
    # ltl property: (! ((! (x_24 - x_21 > 2)) U (! (! ((! (x_28 - x_6 >= -12)) U (! (x_13 - x_21 >= -15)))))))
    ltl = msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[24], xs[21]), msat_make_number(menv, "2"))), msat_make_not(menv, msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_geq(menv, msat_make_minus(menv, xs[28], xs[6]), msat_make_number(menv, "-12"))), msat_make_not(menv, msat_make_geq(menv, msat_make_minus(menv, xs[13], xs[21]), msat_make_number(menv, "-15"))))))))
