...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (F (G ((x_28 - x_6 >= -13) & (x_1 - x_8 > -2))))
    ltl = enc.make_F(enc.make_G(msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[28], xs[6]), msat_make_number(menv, "-13")), msat_make_gt(menv, msat_make_minus(menv, xs[1], xs[8]), msat_make_number(menv, "-2")))))
