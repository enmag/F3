...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (X ((x_19 - x_3 > 12) | (G (x_17 - x_23 >= 8))))
    ltl = enc.make_X(msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[19], xs[3]), msat_make_number(menv, "12")), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[17], xs[23]), msat_make_number(menv, "8")))))
