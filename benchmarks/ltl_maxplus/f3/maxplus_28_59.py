...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_6 - x_17 >= 15) | (X (F (x_24 - x_27 > 5))))
    ltl = msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[6], xs[17]), msat_make_number(menv, "15")), enc.make_X(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[24], xs[27]), msat_make_number(menv, "5")))))
