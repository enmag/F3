...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (F (X ((x_15 - x_23 >= -19) & (x_7 - x_19 >= 18))))
    ltl = enc.make_F(enc.make_X(msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[15], xs[23]), msat_make_number(menv, "-19")), msat_make_geq(menv, msat_make_minus(menv, xs[7], xs[19]), msat_make_number(menv, "18")))))
