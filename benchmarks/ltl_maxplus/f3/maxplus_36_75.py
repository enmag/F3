...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr1 = msat_make_plus(menv, xs[9], n_3_0)
    ...
    # ltl property: ((x_12 - x_31 > 12) & (X (F (x_4 - x_23 >= 6))))
    ltl = msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[12], xs[31]), msat_make_number(menv, "12")), enc.make_X(enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[4], xs[23]), msat_make_number(menv, "6")))))
