...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((X (x_9 - x_0 >= 15)) U (G (x_9 - x_3 >= -17)))
    ltl = enc.make_U(enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[9], xs[0]), msat_make_number(menv, "15"))), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[9], xs[3]), msat_make_number(menv, "-17"))))
