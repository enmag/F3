...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (X ((x_3 - x_6 > 6) U (G (x_3 - x_4 > -10))))
    ltl = enc.make_X(enc.make_U(msat_make_gt(menv, msat_make_minus(menv, xs[3], xs[6]), msat_make_number(menv, "6")), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[3], xs[4]), msat_make_number(menv, "-10")))))
