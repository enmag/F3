...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_1 - x_2 > -10) U ((x_5 - x_2 > 18) & (x_11 - x_6 >= 13)))
    ltl = enc.make_U(msat_make_gt(menv, msat_make_minus(menv, xs[1], xs[2]), msat_make_number(menv, "-10")), msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[5], xs[2]), msat_make_number(menv, "18")), msat_make_geq(menv, msat_make_minus(menv, xs[11], xs[6]), msat_make_number(menv, "13"))))
