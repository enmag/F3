...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr0 = msat_make_plus(menv, xs[8], n_6_0)
    expr1 = msat_make_plus(menv, xs[10], n_3_0)
    expr2 = msat_make_plus(menv, xs[14], n_4_0)
    expr3 = msat_make_plus(menv, xs[15], n_5_0)
    ...
    expr3 = msat_make_plus(menv, xs[13], n_12_0)
    ...
    # ltl property: ((x_5 - x_24 >= -10) & ((x_13 - x_25 >= -1) | (x_24 - x_2 >= -15)))
    ltl = msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[5], xs[24]), msat_make_number(menv, "-10")), msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[13], xs[25]), msat_make_number(menv, "-1")), msat_make_geq(menv, msat_make_minus(menv, xs[24], xs[2]), msat_make_number(menv, "-15"))))
