...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_5 - x_2 >= -16) | (G (F (x_9 - x_10 > 11))))
    ltl = msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[5], xs[2]), msat_make_number(menv, "-16")), enc.make_G(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[9], xs[10]), msat_make_number(menv, "11")))))
