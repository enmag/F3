...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_4 - x_2 >= 2) & ((x_1 - x_13 >= 18) | (x_10 - x_1 > -3)))
    ltl = msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[4], xs[2]), msat_make_number(menv, "2")), msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[1], xs[13]), msat_make_number(menv, "18")), msat_make_gt(menv, msat_make_minus(menv, xs[10], xs[1]), msat_make_number(menv, "-3"))))
