...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F ((x_3 - x_10 >= -17) U (F (x_10 - x_3 >= 16))))
    ltl = enc.make_F(enc.make_U(msat_make_geq(menv, msat_make_minus(menv, xs[3], xs[10]), msat_make_number(menv, "-17")), enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[10], xs[3]), msat_make_number(menv, "16")))))
