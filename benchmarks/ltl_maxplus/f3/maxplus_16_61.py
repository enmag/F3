...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((X (X (x_3 - x_11 > 5))) U (x_6 - x_8 >= 4))
    ltl = enc.make_U(enc.make_X(enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[3], xs[11]), msat_make_number(menv, "5")))), msat_make_geq(menv, msat_make_minus(menv, xs[6], xs[8]), msat_make_number(menv, "4")))
