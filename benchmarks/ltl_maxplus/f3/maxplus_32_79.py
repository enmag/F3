...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr13 = msat_make_plus(menv, xs[17], n_17_0)
    ...
    # ltl property: (F ((x_12 - x_9 >= -19) & (G (x_4 - x_9 > 6))))
    ltl = enc.make_F(msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[12], xs[9]), msat_make_number(menv, "-19")), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[4], xs[9]), msat_make_number(menv, "6")))))
