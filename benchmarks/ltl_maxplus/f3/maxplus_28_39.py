...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (F (G ((x_4 - x_18 >= 3) & (x_25 - x_18 > -3))))
    ltl = enc.make_F(enc.make_G(msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[4], xs[18]), msat_make_number(menv, "3")), msat_make_gt(menv, msat_make_minus(menv, xs[25], xs[18]), msat_make_number(menv, "-3")))))
