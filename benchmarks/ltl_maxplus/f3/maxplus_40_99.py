...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr6 = msat_make_plus(menv, xs[6], n_13_0)
    expr7 = msat_make_plus(menv, xs[8], n_17_0)
    expr8 = msat_make_plus(menv, xs[10], n_7_0)
    expr9 = msat_make_plus(menv, xs[12], n_3_0)
    expr10 = msat_make_plus(menv, xs[13], n_15_0)
    expr11 = msat_make_plus(menv, xs[14], n_10_0)
    ...
    expr12 = msat_make_plus(menv, xs[17], n_7_0)
    ...
    expr17 = msat_make_plus(menv, xs[29], n_20_0)
    ...
    expr14 = msat_make_plus(menv, xs[23], n_11_0)
    ...
    # ltl property: (X ((x_17 - x_15 > -11) | (G (x_16 - x_32 >= 11))))
    ltl = enc.make_X(msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[17], xs[15]), msat_make_number(menv, "-11")), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[16], xs[32]), msat_make_number(menv, "11")))))
