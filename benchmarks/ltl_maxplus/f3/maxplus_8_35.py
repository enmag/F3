...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((G (x_7 - x_4 > 19)) & (F (x_7 - x_0 > 0)))
    ltl = msat_make_and(menv, enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[7], xs[4]), msat_make_number(menv, "19"))), enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[7], xs[0]), msat_make_number(menv, "0"))))
