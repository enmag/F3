...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((G (x_1 - x_8 > 16)) U (G (x_12 - x_25 >= 11)))
    ltl = enc.make_U(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[1], xs[8]), msat_make_number(menv, "16"))), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[12], xs[25]), msat_make_number(menv, "11"))))
