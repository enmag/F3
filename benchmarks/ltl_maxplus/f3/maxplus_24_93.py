...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F (X (F (G (x_14 - x_1 > -6)))))
    ltl = enc.make_F(enc.make_X(enc.make_F(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[14], xs[1]), msat_make_number(menv, "-6"))))))
