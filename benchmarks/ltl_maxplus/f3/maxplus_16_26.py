...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_2 - x_4 >= 16) | ((x_10 - x_15 >= 19) & (x_15 - x_9 >= -12)))
    ltl = msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[2], xs[4]), msat_make_number(menv, "16")), msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[10], xs[15]), msat_make_number(menv, "19")), msat_make_geq(menv, msat_make_minus(menv, xs[15], xs[9]), msat_make_number(menv, "-12"))))
