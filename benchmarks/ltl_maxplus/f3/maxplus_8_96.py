...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (X (F (G (X (x_7 - x_1 > -2)))))
    ltl = enc.make_X(enc.make_F(enc.make_G(enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[7], xs[1]), msat_make_number(menv, "-2"))))))
