...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr17 = msat_make_plus(menv, xs[28], n_7_0)
    _t = msat_make_and(menv,
    ...
    # ltl property: ((G (x_15 - x_35 >= 2)) U (X (x_29 - x_2 >= -2)))
    ltl = enc.make_U(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[15], xs[35]), msat_make_number(menv, "2"))), enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[29], xs[2]), msat_make_number(menv, "-2"))))
