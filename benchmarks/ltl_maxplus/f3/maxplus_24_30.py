...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((X (x_20 - x_17 > 20)) U (G (x_14 - x_4 > -14)))
    ltl = enc.make_U(enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[20], xs[17]), msat_make_number(menv, "20"))), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[14], xs[4]), msat_make_number(menv, "-14"))))
