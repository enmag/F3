...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr4 = msat_make_plus(menv, xs[13], n_5_0)
    ...
    expr9 = msat_make_plus(menv, xs[25], n_15_0)
    ...
    expr6 = msat_make_plus(menv, xs[15], n_9_0)
    expr7 = msat_make_plus(menv, xs[16], n_19_0)
    expr8 = msat_make_plus(menv, xs[24], n_5_0)
    ...
    # ltl property: (X (! ((! (F (x_19 - x_21 > -4))) U (! (x_19 - x_21 > -4)))))
    ltl = enc.make_X(msat_make_not(menv, enc.make_U(msat_make_not(menv, enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[19], xs[21]), msat_make_number(menv, "-4")))), msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[19], xs[21]), msat_make_number(menv, "-4"))))))
