...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr9 = msat_make_plus(menv, xs[10], n_19_0)
    expr10 = msat_make_plus(menv, xs[12], n_2_0)
    ...
    # ltl property: ((x_1 - x_6 > 11) | (X (F (x_13 - x_15 > 7))))
    ltl = msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[1], xs[6]), msat_make_number(menv, "11")), enc.make_X(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[13], xs[15]), msat_make_number(menv, "7")))))
