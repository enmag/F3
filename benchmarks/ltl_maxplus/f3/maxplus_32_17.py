...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (F (X (X (G (x_22 - x_31 > -11)))))
    ltl = enc.make_F(enc.make_X(enc.make_X(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[22], xs[31]), msat_make_number(menv, "-11"))))))
