...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_10 - x_0 > 0) & (F (G (x_5 - x_9 > -13))))
    ltl = msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[10], xs[0]), msat_make_number(menv, "0")), enc.make_F(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[5], xs[9]), msat_make_number(menv, "-13")))))
