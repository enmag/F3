...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_4 - x_5 > 4) U ((x_17 - x_16 >= -13) & (x_2 - x_0 >= -13)))
    ltl = enc.make_U(msat_make_gt(menv, msat_make_minus(menv, xs[4], xs[5]), msat_make_number(menv, "4")), msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[17], xs[16]), msat_make_number(menv, "-13")), msat_make_geq(menv, msat_make_minus(menv, xs[2], xs[0]), msat_make_number(menv, "-13"))))
