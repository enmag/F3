...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr9 = msat_make_plus(menv, xs[25], n_11_0)
    ...
    expr1 = msat_make_plus(menv, xs[8], n_15_0)
    ...
    expr19 = msat_make_plus(menv, xs[33], n_8_0)
    _t = msat_make_and(menv,
    ...
    expr1 = msat_make_plus(menv, xs[3], n_4_0)
    expr2 = msat_make_plus(menv, xs[10], n_15_0)
    ...
    # ltl property: (F ((x_20 - x_36 > 5) & (G (x_7 - x_27 >= -16))))
    ltl = enc.make_F(msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[20], xs[36]), msat_make_number(menv, "5")), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[7], xs[27]), msat_make_number(menv, "-16")))))
