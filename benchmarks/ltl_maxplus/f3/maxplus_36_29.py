...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr13 = msat_make_plus(menv, xs[18], n_18_0)
    expr14 = msat_make_plus(menv, xs[19], n_13_0)
    ...
    # ltl property: (! ((! (X (F (x_9 - x_26 > -7)))) U (! (x_1 - x_29 >= 3))))
    ltl = msat_make_not(menv, enc.make_U(msat_make_not(menv, enc.make_X(enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[9], xs[26]), msat_make_number(menv, "-7"))))), msat_make_not(menv, msat_make_geq(menv, msat_make_minus(menv, xs[1], xs[29]), msat_make_number(menv, "3")))))
