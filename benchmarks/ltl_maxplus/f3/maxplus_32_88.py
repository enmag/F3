...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (F (X ((x_6 - x_23 > 3) | (x_2 - x_21 > 11))))
    ltl = enc.make_F(enc.make_X(msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[6], xs[23]), msat_make_number(menv, "3")), msat_make_gt(menv, msat_make_minus(menv, xs[2], xs[21]), msat_make_number(menv, "11")))))
