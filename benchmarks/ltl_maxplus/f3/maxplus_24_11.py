...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr0 = msat_make_plus(menv, xs[8], n_2_0)
    expr1 = msat_make_plus(menv, xs[10], n_14_0)
    ...
    # ltl property: (F ((x_4 - x_2 > 12) U (G (x_4 - x_19 > -6))))
    ltl = enc.make_F(enc.make_U(msat_make_gt(menv, msat_make_minus(menv, xs[4], xs[2]), msat_make_number(menv, "12")), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[4], xs[19]), msat_make_number(menv, "-6")))))
