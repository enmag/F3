...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr4 = msat_make_plus(menv, xs[14], n_20_0)
    ...
    expr10 = msat_make_plus(menv, xs[13], n_12_0)
    ...
    expr14 = msat_make_plus(menv, xs[24], n_8_0)
    ...
    expr14 = msat_make_plus(menv, xs[24], n_18_0)
    ...
    expr14 = msat_make_plus(menv, xs[21], n_12_0)
    expr15 = msat_make_plus(menv, xs[24], n_8_0)
    expr16 = msat_make_plus(menv, xs[25], n_20_0)
    expr17 = msat_make_plus(menv, xs[26], n_8_0)
    ...
    expr0 = msat_make_plus(menv, xs[6], n_8_0)
    ...
    expr13 = msat_make_plus(menv, xs[30], n_5_0)
    ...
    expr11 = msat_make_plus(menv, xs[17], n_3_0)
    expr12 = msat_make_plus(menv, xs[18], n_6_0)
    ...
    expr18 = msat_make_plus(menv, xs[31], n_6_0)
    ...
    expr7 = msat_make_plus(menv, xs[8], n_11_0)
    ...
    # ltl property: (F ((x_8 - x_38 >= -1) | (G (x_8 - x_38 >= -1))))
    ltl = enc.make_F(msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[8], xs[38]), msat_make_number(menv, "-1")), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[8], xs[38]), msat_make_number(menv, "-1")))))
