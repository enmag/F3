...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: (F ((x_8 - x_0 >= -16) U (F (x_11 - x_9 > -4))))
    ltl = enc.make_F(enc.make_U(msat_make_geq(menv, msat_make_minus(menv, xs[8], xs[0]), msat_make_number(menv, "-16")), enc.make_F(msat_make_gt(menv, msat_make_minus(menv, xs[11], xs[9]), msat_make_number(menv, "-4")))))
