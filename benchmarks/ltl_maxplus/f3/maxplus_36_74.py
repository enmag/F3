...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr10 = msat_make_plus(menv, xs[12], n_13_0)
    expr11 = msat_make_plus(menv, xs[14], n_9_0)
    expr12 = msat_make_plus(menv, xs[17], n_10_0)
    expr13 = msat_make_plus(menv, xs[18], n_3_0)
    ...
    expr2 = msat_make_plus(menv, xs[12], n_5_0)
    ...
    expr5 = msat_make_plus(menv, xs[18], n_12_0)
    expr6 = msat_make_plus(menv, xs[20], n_18_0)
    expr7 = msat_make_plus(menv, xs[23], n_3_0)
    ...
    # ltl property: ((x_30 - x_26 > -19) & (F (G (x_27 - x_34 >= -12))))
    ltl = msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[30], xs[26]), msat_make_number(menv, "-19")), enc.make_F(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[27], xs[34]), msat_make_number(menv, "-12")))))
