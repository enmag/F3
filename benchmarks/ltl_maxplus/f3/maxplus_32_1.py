...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_0 - x_14 > 4) | (X (G (x_27 - x_11 > 15))))
    ltl = msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[0], xs[14]), msat_make_number(menv, "4")), enc.make_X(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[27], xs[11]), msat_make_number(menv, "15")))))
