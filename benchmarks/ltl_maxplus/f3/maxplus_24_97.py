...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (G ((X (x_2 - x_17 > 12)) U (x_11 - x_5 >= -10)))
    ltl = enc.make_G(enc.make_U(enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[2], xs[17]), msat_make_number(menv, "12"))), msat_make_geq(menv, msat_make_minus(menv, xs[11], xs[5]), msat_make_number(menv, "-10"))))
