...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((x_14 - x_2 >= 9) | (X (F (x_0 - x_13 >= 11))))
    ltl = msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[14], xs[2]), msat_make_number(menv, "9")), enc.make_X(enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[0], xs[13]), msat_make_number(menv, "11")))))
