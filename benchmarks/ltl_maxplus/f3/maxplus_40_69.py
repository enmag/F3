...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr14 = msat_make_plus(menv, xs[34], n_4_0)
    ...
    expr0 = msat_make_plus(menv, xs[6], n_12_0)
    ...
    expr16 = msat_make_plus(menv, xs[25], n_15_0)
    expr17 = msat_make_plus(menv, xs[27], n_6_0)
    ...
    expr16 = msat_make_plus(menv, xs[27], n_19_0)
    ...
    expr0 = msat_make_plus(menv, xs[6], n_16_0)
    ...
    # ltl property: (F (G (F (X (x_17 - x_7 > 15)))))
    ltl = enc.make_F(enc.make_G(enc.make_F(enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[17], xs[7]), msat_make_number(menv, "15"))))))
