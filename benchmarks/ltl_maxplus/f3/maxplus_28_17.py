...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F (X (X (G (x_19 - x_7 > -18)))))
    ltl = enc.make_F(enc.make_X(enc.make_X(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[19], xs[7]), msat_make_number(menv, "-18"))))))
