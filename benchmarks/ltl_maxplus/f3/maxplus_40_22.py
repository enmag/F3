...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr15 = msat_make_plus(menv, xs[23], n_15_0)
    expr16 = msat_make_plus(menv, xs[24], n_15_0)
    ...
    # ltl property: (G ((G (x_5 - x_3 >= 15)) U (x_26 - x_37 >= -6)))
    ltl = enc.make_G(enc.make_U(enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[5], xs[3]), msat_make_number(menv, "15"))), msat_make_geq(menv, msat_make_minus(menv, xs[26], xs[37]), msat_make_number(menv, "-6"))))
