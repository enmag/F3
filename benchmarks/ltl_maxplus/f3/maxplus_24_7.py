...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (! ((! (x_0 - x_23 >= -14)) U (! (! ((! (x_19 - x_22 > -18)) U (! (x_10 - x_19 > -13)))))))
    ltl = msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_geq(menv, msat_make_minus(menv, xs[0], xs[23]), msat_make_number(menv, "-14"))), msat_make_not(menv, msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[19], xs[22]), msat_make_number(menv, "-18"))), msat_make_not(menv, msat_make_gt(menv, msat_make_minus(menv, xs[10], xs[19]), msat_make_number(menv, "-13"))))))))
