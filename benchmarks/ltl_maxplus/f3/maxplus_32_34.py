...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr5 = msat_make_plus(menv, xs[5], n_12_0)
    ...
    # ltl property: (G (! ((! (X (x_26 - x_21 >= 1))) U (! (x_27 - x_25 >= -7)))))
    ltl = enc.make_G(msat_make_not(menv, enc.make_U(msat_make_not(menv, enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[26], xs[21]), msat_make_number(menv, "1")))), msat_make_not(menv, msat_make_geq(menv, msat_make_minus(menv, xs[27], xs[25]), msat_make_number(menv, "-7"))))))
