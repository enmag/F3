...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((x_8 - x_5 >= 12) | ((x_19 - x_0 > 1) & (x_11 - x_1 > 12)))
    ltl = msat_make_or(menv, msat_make_geq(menv, msat_make_minus(menv, xs[8], xs[5]), msat_make_number(menv, "12")), msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[19], xs[0]), msat_make_number(menv, "1")), msat_make_gt(menv, msat_make_minus(menv, xs[11], xs[1]), msat_make_number(menv, "12"))))
