...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    # ltl property: ((X (x_6 - x_9 > -16)) | (G (x_6 - x_7 >= -12)))
    ltl = msat_make_or(menv, enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[6], xs[9]), msat_make_number(menv, "-16"))), enc.make_G(msat_make_geq(menv, msat_make_minus(menv, xs[6], xs[7]), msat_make_number(menv, "-12"))))
