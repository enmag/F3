...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    expr5 = msat_make_plus(menv, xs[18], n_1_0)
    ...
    # ltl property: (F (G ((x_3 - x_15 > 7) & (x_27 - x_3 >= 4))))
    ltl = enc.make_F(enc.make_G(msat_make_and(menv, msat_make_gt(menv, msat_make_minus(menv, xs[3], xs[15]), msat_make_number(menv, "7")), msat_make_geq(menv, msat_make_minus(menv, xs[27], xs[3]), msat_make_number(menv, "4")))))
