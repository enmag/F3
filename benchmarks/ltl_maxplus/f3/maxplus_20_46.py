...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((X (x_2 - x_6 > 1)) | (F (x_9 - x_19 >= 2)))
    ltl = msat_make_or(menv, enc.make_X(msat_make_gt(menv, msat_make_minus(menv, xs[2], xs[6]), msat_make_number(menv, "1"))), enc.make_F(msat_make_geq(menv, msat_make_minus(menv, xs[9], xs[19]), msat_make_number(menv, "2"))))
