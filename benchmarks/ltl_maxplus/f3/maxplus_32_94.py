...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr7 = msat_make_plus(menv, xs[7], n_15_0)
    ...
    expr1 = msat_make_plus(menv, xs[11], n_8_0)
    ...
    # ltl property: ((x_1 - x_18 >= 1) U ((x_13 - x_15 > 6) | (x_13 - x_24 > 18)))
    ltl = enc.make_U(msat_make_geq(menv, msat_make_minus(menv, xs[1], xs[18]), msat_make_number(menv, "1")), msat_make_or(menv, msat_make_gt(menv, msat_make_minus(menv, xs[13], xs[15]), msat_make_number(menv, "6")), msat_make_gt(menv, msat_make_minus(menv, xs[13], xs[24]), msat_make_number(menv, "18"))))
