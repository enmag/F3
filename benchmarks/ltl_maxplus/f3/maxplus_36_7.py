...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> Tuple[Iterable, msat_term,
    ...
    expr12 = msat_make_plus(menv, xs[16], n_10_0)
    ...
    expr14 = msat_make_plus(menv, xs[21], n_3_0)
    ...
    expr9 = msat_make_plus(menv, xs[26], n_1_0)
    ...
    # ltl property: (! ((! (x_31 - x_21 >= -1)) U (! (! ((! (x_19 - x_34 >= -2)) U (! (x_4 - x_24 >= -10)))))))
    ltl = msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_geq(menv, msat_make_minus(menv, xs[31], xs[21]), msat_make_number(menv, "-1"))), msat_make_not(menv, msat_make_not(menv, enc.make_U(msat_make_not(menv, msat_make_geq(menv, msat_make_minus(menv, xs[19], xs[34]), msat_make_number(menv, "-2"))), msat_make_not(menv, msat_make_geq(menv, msat_make_minus(menv, xs[4], xs[24]), msat_make_number(menv, "-10"))))))))
