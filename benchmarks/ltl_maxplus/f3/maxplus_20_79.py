...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: (F ((x_14 - x_17 >= -18) & (G (x_16 - x_13 > 1))))
    ltl = enc.make_F(msat_make_and(menv, msat_make_geq(menv, msat_make_minus(menv, xs[14], xs[17]), msat_make_number(menv, "-18")), enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[16], xs[13]), msat_make_number(menv, "1")))))
