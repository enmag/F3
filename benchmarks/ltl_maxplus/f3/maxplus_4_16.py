...
def check_ltl(menv: msat_env, enc: LTLEncoder) -> (Iterable, msat_term,
    ...
    # ltl property: ((G (x_0 - x_1 > -17)) U (X (x_0 - x_1 >= 6)))
    ltl = enc.make_U(enc.make_G(msat_make_gt(menv, msat_make_minus(menv, xs[0], xs[1]), msat_make_number(menv, "-17"))), enc.make_X(msat_make_geq(menv, msat_make_minus(menv, xs[0], xs[1]), msat_make_number(menv, "6"))))
