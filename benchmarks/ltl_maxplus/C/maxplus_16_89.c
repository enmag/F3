...
float x_12, _x_x_12;
  ...
  bool __ok = (1 && ((( !(_EL_U_858 || ( !(( !_EL_X_852) || (( !((x_0 + (-1.0 * x_13)) <= -4.0)) && _EL_U_854))))) && ( !_J881)) && ( !_J887)));
