...
float x_1, _x_x_1;
  ...
  while (__steps_to_fair >= 0 && __ok) {
    ...
    __ok = ((((((((x_1 + (-1.0 * _x_x_0)) <= -1.0) && ((x_3 + (-1.0 * _x_x_0)) <= -20.0)) && (((x_1 + (-1.0 * _x_x_0)) == -1.0) || ((x_3 + (-1.0 * _x_x_0)) == -20.0))) && ((((x_1 + (-1.0 * _x_x_1)) <= -3.0) && ((x_2 + (-1.0 * _x_x_1)) <= -12.0)) && (((x_1 + (-1.0 * _x_x_1)) == -3.0) || ((x_2 + (-1.0 * _x_x_1)) == -12.0)))) && ((((x_0 + (-1.0 * _x_x_2)) <= -20.0) && ((x_1 + (-1.0 * _x_x_2)) <= -20.0)) && (((x_0 + (-1.0 * _x_x_2)) == -20.0) || ((x_1 + (-1.0 * _x_x_2)) == -20.0)))) && ((((x_1 + (-1.0 * _x_x_3)) <= -11.0) && ((x_3 + (-1.0 * _x_x_3)) <= -17.0)) && (((x_1 + (-1.0 * _x_x_3)) == -11.0) || ((x_3 + (-1.0 * _x_x_3)) == -17.0)))) && ((_EL_X_90 == _x__EL_X_87) && ((_EL_X_92 == ((_x_x_1 + (-1.0 * _x_x_3)) <= -10.0)) && (_EL_X_87 == ((_x_x_1 + (-1.0 * _x_x_3)) <= 16.0)))));
    x_0 = _x_x_0;
