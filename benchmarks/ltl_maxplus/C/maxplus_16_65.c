...
float x_11, _x_x_11;
  ...
  bool __ok = (1 && (((_EL_U_851 || ( !(( !(-12.0 <= (x_0 + (-1.0 * x_14)))) || ( !(( !(-10.0 <= (x_4 + (-1.0 * x_5)))) || _EL_U_847))))) && ( !_J866)) && ( !_J879)));
