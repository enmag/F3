...
float x_0, _x_x_0;
  ...
  bool __ok = (1 && _EL_X_94);
  while (__steps_to_fair >= 0 && __ok) {
    if ((( !(12.0 <= (x_1 + (-1.0 * x_2)))) || ( !(( !(12.0 <= (x_1 + (-1.0 * x_2)))) || (( !(6.0 <= (x_0 + (-1.0 * x_1)))) && _EL_U_90))))) {
