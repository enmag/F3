...
def hints(env: PysmtEnv) -> FrozenSet[Hint]:
    ...
    loc.set_progress(0, eq_0=mgr.Equals(x_y, mgr.Plus(i_1, y)))
    ...
    stutter = mgr.Equals(x_y, y)
    loc = Location(env, mgr.TRUE(), mgr.LE(x, i_20), stutterT=stutter)
    loc.set_progress(0, eq_0=mgr.Equals(x_y, mgr.Plus(x, y)))
    ...
    loc0.set_progress(1, eq_0=mgr.Equals(x_y, mgr.Plus(x, y)))
    loc1 = Location(env, mgr.TRUE(), mgr.GE(x, m_100))
    loc1.set_progress(0, eq_0=mgr.Equals(x_y, m_100))
    h_y = Hint("h_y2", env, frozenset([y]), symbs)
    h_y.set_locs([loc0, loc1])
    res.append(h_y)

    loc0 = Location(env, mgr.GE(x, i_1), mgr.GE(y, i_1))
    loc0.set_progress(1, eq_0=mgr.Equals(x_x, mgr.Plus(x, y)))
    loc1 = Location(env, mgr.GE(x, i_2), mgr.GE(y, i_1))
    loc1.set_progress(0, eq_0=mgr.Equals(x_x, y))
    h_x = Hint("h_x2", env, frozenset([x]), symbs)
    h_x.set_locs([loc0, loc1])
    res.append(h_x)

    loc0 = Location(env, mgr.GE(y, m_100), mgr.LE(x, i_20))
    loc0.set_progress(1, eq_0=mgr.Equals(x_y, mgr.Times(x, y)))
    loc1 = Location(env, mgr.TRUE(), mgr.GE(x, m_100))
    loc1.set_progress(0, eq_0=mgr.Equals(x_y, m_100))
    ...
    loc0 = Location(env, mgr.GE(x, i_1), mgr.GE(y, i_1))
    loc0.set_progress(1, eq_0=mgr.Equals(x_x, mgr.Times(x, y)))
    ...
    loc0.set_progress(1, eq_0=mgr.GT(x_pc, mgr.Plus(pc, i_1)))
    ...
    loc0.set_progress(1, eq_0=mgr.Equals(x_y, mgr.Times(x, y)))
    loc1 = Location(env, mgr.TRUE(), mgr.GE(x, m_100))
    loc1.set_progress(2, eq_0=mgr.GE(x_y, i_20))
    loc2 = Location(env, mgr.TRUE())
    loc2.set_progress(0, eq_0=mgr.And(mgr.GE(x_y, m_100), mgr.LE(x_y, i_0)))
    ...
    loc0.set_progress(1, eq_0=mgr.Equals(x_x, mgr.Times(x, y)))
    loc1 = Location(env, mgr.GE(x, i_1), mgr.GE(y, i_1))
    loc1.set_progress(2, eq_0=mgr.GT(x_x, y))
    loc2 = Location(env, mgr.GE(x, i_2))
    loc2.set_progress(0, eq_0=mgr.GE(x_x, i_20))
    h_x = Hint("h_x4", env, frozenset([x]), symbs)
    h_x.set_locs([loc0, loc1, loc2])
    res.append(h_x)

    loc0 = Location(env, mgr.TRUE())
    loc0.set_progress(0, eq_0=mgr.TRUE())
    h_pc = Hint("h_pc1", env, frozenset([pc]), symbs)
    h_pc.set_locs([loc0])
    res.append(h_pc)

    loc0 = Location(env, mgr.GE(y, m_100))
    loc0.set_progress(0, eq_0=mgr.Equals(x_y, mgr.Times(y, y)))
    h_y = Hint("h_y5", env, frozenset([y]), symbs)
    h_y.set_locs([loc0])
    res.append(h_y)

    loc0 = Location(env, mgr.LE(x, i_0))
    loc0.set_progress(1, eq_0=mgr.Equals(x_x, mgr.Times(x, x)))
    loc1 = Location(env, mgr.GE(x, i_0))
    loc1.set_progress(0, eq_0=mgr.LT(x_x, mgr.Times(m_1, x, x)))
    h_x = Hint("h_x5", env, frozenset([x]), symbs)
    h_x.set_locs([loc0, loc1])
    res.append(h_x)

    loc0 = Location(env, mgr.Equals(pc, i_1))
    loc0.set_progress(1, eq_0=mgr.GT(x_pc, pc))
    loc1 = Location(env, mgr.GE(pc, i_2))
    loc1.set_progress(0, eq_0=mgr.Equals(x_pc, mgr.Div(pc, pc)))
    h_pc = Hint("h_pc2", env, frozenset([pc]), symbs)
    h_pc.set_locs([loc0, loc1])
    res.append(h_pc)

    loc0 = Location(env, mgr.GE(y, m_100))
    loc0.set_progress(1, eq_0=mgr.Equals(x_y, mgr.Times(y, y)))
    loc1 = Location(env, mgr.GE(y, i_0))
    loc1.set_progress(0, eq_0=mgr.GE(x_y, mgr.Plus(y, i_1)))
    h_y = Hint("h_y6", env, frozenset([y]), symbs)
    h_y.set_locs([loc0, loc1])
    res.append(h_y)

    loc0 = Location(env, mgr.LE(x, i_20))
    loc0.set_progress(1, eq_0=mgr.Equals(x_x, mgr.Plus(mgr.Times(x, x), i_1)))
    ...
    loc0.set_progress(1, eq_0=mgr.Equals(x_y, mgr.Plus(y, pc)))
    loc1 = Location(env, mgr.GE(y, i_1))
    loc1.set_progress(0, eq_0=mgr.Equals(x_y, y))
    h_y = Hint("h_y7", env, frozenset([y]), symbs)
    h_y.set_locs([loc0, loc1])
    res.append(h_y)

    loc0 = Location(env, mgr.GE(x, i_1), mgr.GT(y, i_1))
    loc0.set_progress(1, eq_0=mgr.Equals(x_x, mgr.Plus(mgr.Times(x, y), i_1)))
    loc1 = Location(env, mgr.GE(x, i_2))
    loc1.set_progress(2, eq_0=mgr.LT(x_x, mgr.Times(m_1, x, x)))
    loc1 = Location(env, mgr.LE(x, i_4))
    loc1.set_progress(0, eq_0=mgr.GE(x_x, mgr.Div(x, x)))
