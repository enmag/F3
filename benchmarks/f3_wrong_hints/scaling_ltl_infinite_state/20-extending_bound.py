...
def hints(env: PysmtEnv) -> FrozenSet[Hint]:
    ...
    loc.set_progress(0, eq_0=mgr.Equals(x_i, mgr.Plus(i, n1)))
    h_i = Hint("h_i0", env, frozenset([i]), symbs)
    h_i.set_locs([loc])
    res.append(h_i)

    loc = Location(env, mgr.GE(r, n0))
    loc.set_progress(0, eq_0=mgr.Equals(x_r, mgr.Plus(r, n1)))
    h_r = Hint("h_r0", env, frozenset([r]), symbs)
    h_r.set_locs([loc])
    res.append(h_r)

    loc = Location(env, mgr.GE(l, n0))
    loc.set_progress(0, eq_0=mgr.Equals(x_l, mgr.Plus(l, n1)))
    h_l = Hint("h_l0", env, frozenset([l]), symbs)
    h_l.set_locs([loc])
    res.append(h_l)

    loc = Location(env, inc_i)
    loc.set_progress(0, eq_0=x_inc_i)
    ...
    loc0.set_progress(1, eq_0=mgr.Equals(x_i, mgr.Plus(i, n1)))
    loc1 = Location(env, mgr.GE(i, n0))
    loc1.set_progress(2, eq_0=mgr.Equals(x_i, i))
    loc2 = Location(env, mgr.GE(i, n0))
    loc2.set_progress(0, eq_0=mgr.Equals(x_i, i))
    ...
    loc0.set_progress(1, eq_0=mgr.Equals(x_r, r))
    loc1 = Location(env, mgr.GE(r, n0))
    loc1.set_progress(2, eq_0=mgr.Equals(x_r, mgr.Plus(r, n1)))
    loc2 = Location(env, mgr.GE(r, n0))
    loc2.set_progress(0, eq_0=mgr.Equals(x_r, r))
    ...
    loc0.set_progress(1, eq_0=mgr.Equals(x_l, mgr.Plus(l, n1)))
    loc1 = Location(env, mgr.GE(l, n0))
    loc1.set_progress(2, eq_0=mgr.Equals(x_l, l))
    loc2 = Location(env, mgr.GE(l, n0))
    loc2.set_progress(0, eq_0=mgr.Equals(x_l, l))
    ...
    loc0.set_progress(1, eq_0=x_inc_i)
    loc1 = Location(env, inc_i, stutterT=x_inc_i)
    loc1.set_progress(2, eq_0=mgr.Not(x_inc_i))
    loc2 = Location(env, mgr.Not(inc_i))
    loc2.set_progress(0, eq_0=mgr.Not(x_inc_i))
