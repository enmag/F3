...
def hints(env: PysmtEnv) -> FrozenSet[Hint]:
    ...
    loc.set_progress(0, eq_0=mgr.Equals(x_x, mgr.Times(x, y)))
    h_x = Hint("h_x0", env, frozenset([x]), symbs)
    h_x.set_locs([loc])
    res.append(h_x)

    loc = Location(env, mgr.LE(z, i_0))
    loc.set_progress(0, eq_0=mgr.Equals(x_z, z))
    h_z = Hint("h_z0", env, frozenset([z]), symbs)
    h_z.set_locs([loc])
    res.append(h_z)

    loc0 = Location(env, mgr.Equals(pc, i_1))
    loc0.set_progress(1, eq_0=mgr.Equals(x_pc, i_2))
    loc1 = Location(env, mgr.Equals(pc, i_2))
    loc1.set_progress(2, eq_0=mgr.Equals(x_pc, i_3))
    loc2 = Location(env, mgr.Equals(pc, i_3))
    loc2.set_progress(0, eq_0=mgr.Equals(x_pc, i_1))
    ...
    loc0.set_progress(1, eq_0=mgr.Equals(x_y, mgr.Plus(y, i_1)))
    loc1 = Location(env, mgr.GE(y, i_1))
    loc1.set_progress(2, eq_0=mgr.Equals(x_y, mgr.Plus(y, i_1)))
    loc2 = Location(env, mgr.GE(y, i_2))
    loc2.set_progress(0, eq_0=mgr.Equals(x_y, y))
    ...
    loc = Location(env, mgr.GT(x, i_0), mgr.And(mgr.GT(y, i_1), mgr.GT(z, i_1)),
                   stutterT=stutter)
    loc.set_progress(0, eq_0=mgr.GE(x_x, mgr.Minus(mgr.Times(y, z), i_2)))
    h_x = Hint("h_x1", env, frozenset([x]), symbs)
    h_x.set_locs([loc])
    res.append(h_x)

    loc0 = Location(env, mgr.GE(z, i_3))
    loc0.set_progress(0, eq_0=mgr.GT(x_z, z))
    h_z = Hint("h_z1", env, frozenset([z]), symbs)
    h_z.set_locs([loc0])
    res.append(h_z)

    loc0 = Location(env, mgr.Equals(pc, i_0))
    loc0.set_progress(1, eq_0=mgr.Equals(x_pc, i_1))
    loc1 = Location(env, mgr.Equals(pc, i_1))
    loc1.set_progress(2, eq_0=mgr.Equals(x_pc, i_2))
    loc2 = Location(env, mgr.Equals(pc, i_2))
    loc2.set_progress(0, eq_0=mgr.Equals(x_pc, i_3))
    loc3 = Location(env, mgr.Equals(pc, i_3))
    loc3.set_progress(0, eq_0=mgr.Equals(x_pc, i_0))
    ...
    loc1.set_progress(0, eq_0=mgr.Equals(x_y, mgr.Plus(y, z)))
    ...
    loc0.set_progress(1, eq_0=mgr.GE(x_x, mgr.Minus(mgr.Times(y, z), i_1)))
    loc1 = Location(env, mgr.GT(x, i_0))
    loc1.set_progress(0, eq_0=mgr.Equals(x_x, mgr.Plus(x, i_1)))
    h_x = Hint("h_x2", env, frozenset([x]), symbs)
    h_x.set_locs([loc0, loc1])
    res.append(h_x)

    loc0 = Location(env, mgr.GE(z, i_3), mgr.GE(y, i_0))
    loc0.set_progress(1, eq_0=mgr.GE(x_z, mgr.Plus(z, y)))
    loc1 = Location(env, mgr.GE(z, i_3), mgr.GE(x, i_0))
    loc1.set_progress(0, eq_0=mgr.GE(x_z, mgr.Plus(z, i_0)))
    h_z = Hint("h_z2", env, frozenset([z]), symbs)
    h_z.set_locs([loc0, loc1])
    res.append(h_z)

    loc0 = Location(env, mgr.Equals(pc, i_1))
    loc0.set_progress(1, eq_0=mgr.Equals(x_pc, i_3))
    loc1 = Location(env, mgr.Equals(pc, i_3))
    loc1.set_progress(0, eq_0=mgr.Equals(x_pc, i_1))
    ...
    loc1.set_progress(0, eq_0=mgr.Equals(x_y, mgr.Plus(y, x)))
    ...
    loc1.set_progress(0, eq_0=mgr.Equals(x_x, mgr.Plus(x, y)))
    h_x = Hint("h_x3", env, frozenset([x]), symbs)
    h_x.set_locs([loc0, loc1])
    res.append(h_x)

    loc0 = Location(env, mgr.GE(z, i_3), mgr.GE(y, i_0))
    loc0.set_progress(1, eq_0=mgr.Equals(x_z, y))
    loc1 = Location(env, mgr.GE(z, i_0), mgr.GE(x, i_3))
    loc1.set_progress(0, eq_0=mgr.GE(x_z, mgr.Plus(z, x)))
    h_z = Hint("h_z3", env, frozenset([z]), symbs)
    h_z.set_locs([loc0, loc1])
    res.append(h_z)

    loc0 = Location(env, mgr.Equals(pc, i_2))
    loc0.set_progress(1, eq_0=mgr.GT(x_pc, i_2))
    loc1 = Location(env, mgr.GE(pc, i_3))
    loc1.set_progress(0, eq_0=mgr.Equals(x_pc, i_2))
    ...
    loc1.set_progress(2, eq_0=mgr.Equals(x_y, y))
    loc2 = Location(env, mgr.GE(y, i_3))
    loc2.set_progress(2, eq_0=mgr.Equals(x_y, mgr.Plus(y, i_1)))
    ...
    loc0.set_progress(1, eq_0=mgr.GE(x_x, mgr.Minus(mgr.Times(y, z), i_1)))
    loc1 = Location(env, mgr.GT(x, i_0), mgr.GE(y, i_1))
    loc1.set_progress(2, eq_0=mgr.Equals(x_x, mgr.Plus(x, y)))
    loc2 = Location(env, mgr.GT(x, i_3))
    loc2.set_progress(2, eq_0=mgr.Equals(x_x, x))
    h_x = Hint("h_x4", env, frozenset([x]), symbs)
    h_x.set_locs([loc0, loc1, loc2])
    res.append(h_x)

    loc0 = Location(env, mgr.GE(z, i_0))
    loc0.set_progress(1, eq_0=mgr.Equals(x_z, z))
    loc1 = Location(env, mgr.GE(z, i_0))
    loc1.set_progress(0, eq_0=mgr.Equals(x_z, mgr.Plus(z, i_3)))
