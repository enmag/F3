//@ ltl invariant negative: ( (<> ([] (! ( AP((((5.0 * cm0_cm) + ((-1.0 * sm0_sm) + ((-1.0 * sm1_sm) + ((-1.0 * sm2_sm) + ((-1.0 * sm3_sm) + (-1.0 * sm4_sm)))))) == 0.0)) && AP((((5.0 * cm1_cm) + ((-1.0 * sm0_sm) + ((-1.0 * sm1_sm) + ((-1.0 * sm2_sm) + ((-1.0 * sm3_sm) + (-1.0 * sm4_sm)))))) == 0.0)))))) || (! ([] (<> AP((1.0 <= _diverge_delta))))));
...
int main()
{
  ...
  __ok = (((((((((0.0 <= delta) && ((((cm0_mode == 0) && (cm0_x == 0.0)) && (cm0_cm == 0.0)) && (((cm0_mode == 0) || ((cm0_x == 0.0) && (delta == 0.0))) && (( !(cm0_mode == 0)) || (cm0_x <= 2.0))))) && ((((cm1_mode == 0) && (cm1_x == 0.0)) && (cm1_cm == 0.0)) && (((cm1_mode == 0) || ((delta == 0.0) && (cm1_x == 0.0))) && (( !(cm1_mode == 0)) || (cm1_x <= 2.0))))) && ((sm0_mode == 0) && (sm0_sm == 0.0))) && ((sm1_mode == 0) && (sm1_sm == 0.0))) && ((sm2_mode == 0) && (sm2_sm == 0.0))) && ((sm3_mode == 0) && (sm3_sm == 0.0))) && ((sm4_mode == 0) && (sm4_sm == 0.0))) && (delta == _diverge_delta));
  while (__ok) {
