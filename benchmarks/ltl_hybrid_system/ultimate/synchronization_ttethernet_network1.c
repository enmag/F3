//@ ltl invariant negative: ( (<> ([] (! ( AP((((5.0 * cm0_cm) - ((sm0_sm) + ((sm1_sm) + ((sm2_sm) + ((sm3_sm) + (sm4_sm)))))) == 0.0)) && AP((((5.0 * cm1_cm) + ((sm0_sm) + ((sm1_sm) + ((sm2_sm) + ((sm3_sm) + (sm4_sm)))))) == 0.0)))))) || (! ([] (<> AP((1.0 <= _diverge_delta))))));
