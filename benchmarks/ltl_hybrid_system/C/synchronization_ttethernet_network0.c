...
bool _J703, _x__J703;
bool _J697, _x__J697;
bool _EL_U_653, _x__EL_U_653;
bool _EL_U_655, _x__EL_U_655;
bool _EL_U_657, _x__EL_U_657;
bool _EL_U_659, _x__EL_U_659;
  ...
  _EL_U_653 = __VERIFIER_nondet_bool();
  _EL_U_655 = __VERIFIER_nondet_bool();
  _EL_U_657 = __VERIFIER_nondet_bool();
  _EL_U_659 = __VERIFIER_nondet_bool();

  bool __ok = ((((((((((0.0 <= delta) && ((((cm0_mode == 0) && (cm0_x == 0.0)) && (cm0_cm == 0.0)) && (((cm0_mode == 0) || ((cm0_x == 0.0) && (delta == 0.0))) && (( !(cm0_mode == 0)) || (cm0_x <= 2.0))))) && ((((cm1_mode == 0) && (cm1_x == 0.0)) && (cm1_cm == 0.0)) && (((cm1_mode == 0) || ((delta == 0.0) && (cm1_x == 0.0))) && (( !(cm1_mode == 0)) || (cm1_x <= 2.0))))) && ((sm0_mode == 0) && (sm0_sm == 0.0))) && ((sm1_mode == 0) && (sm1_sm == 0.0))) && ((sm2_mode == 0) && (sm2_sm == 0.0))) && ((sm3_mode == 0) && (sm3_sm == 0.0))) && ((sm4_mode == 0) && (sm4_sm == 0.0))) && (delta == _diverge_delta)) && ((((( !((_EL_U_659 || ( !(((((((cm0_cm + (cm1_cm + (-2.0 * sm0_sm))) == 0.0) && ((cm0_cm + (cm1_cm + (-2.0 * sm1_sm))) == 0.0)) && ((cm0_cm + (cm1_cm + (-2.0 * sm2_sm))) == 0.0)) && ((cm0_cm + (cm1_cm + (-2.0 * sm3_sm))) == 0.0)) && ((cm0_cm + (cm1_cm + (-2.0 * sm4_sm))) == 0.0)) || _EL_U_657))) || (_EL_U_655 || ( !((1.0 <= _diverge_delta) || _EL_U_653))))) && ( !_J697)) && ( !_J703)) && ( !_J709)) && ( !_J715)));
  while (__steps_to_fair >= 0 && __ok) {
    if ((((_J697 && _J703) && _J709) && _J715)) {
    ...
    _J703 = _x__J703;
    _J697 = _x__J697;
    _EL_U_653 = _x__EL_U_653;
    _EL_U_655 = _x__EL_U_655;
    _EL_U_657 = _x__EL_U_657;
    _EL_U_659 = _x__EL_U_659;
