//@ ltl invariant negative: ( (! ([] (<> AP((semaphore == 0))))) || (! ( ( ([] (<> AP((run == 0)))) && ([] (<> AP((run == 1))))) && ([] (<> AP((run == 2)))))));
...
int main()
{
  ...
  int __ok = ((((semaphore == 0) && ((sm0_state != 0) && (( !(sm0_loop_len <= 0)) && (sm0_l == 0)))) && ((sm1_state != 0) && (( !(sm1_loop_len <= 0)) && (sm1_l == 0)))) && ((sm2_state != 0) && (( !(sm2_loop_len <= 0)) && (sm2_l == 0))));
  while (__ok) {
    ...
    __ok = (((((_x_semaphore == 0) || ( !(semaphore == 3))) && ((((((((((sm0_l == 0) && ( !(_x_sm0_loop_len <= sm0_loop_len))) || ( !((_x_sm0_state != 0) && ( !(sm0_state != 0))))) && (((_x_sm0_state != 0) && ( !(sm0_state != 0))) || (sm0_loop_len == _x_sm0_loop_len))) && (( !(sm0_state != 0)) || ((sm0_l + (-1 * _x_sm0_l)) == 1))) && ((_x_sm0_state != 0) || ( !((sm0_state != 0) && ( !(sm0_loop_len <= sm0_l)))))) && ((_x_sm0_state != 0) || ( !(((semaphore == 3) && (_x_semaphore == 0)) && ( !(sm0_state != 0)))))) && (((sm0_state != 0) == (_x_sm0_state != 0)) || ( !(( !(((semaphore == 3) && (_x_semaphore == 0)) && ( !(sm0_state != 0)))) && ( !(run == 0)))))) && ((semaphore == _x_semaphore) || ( !((run == 0) && ((sm0_state != 0) == (_x_sm0_state != 0)))))) && (((semaphore + (-1 * _x_semaphore)) == -1) || ( !(( !(_x_sm0_state != 0)) && ((run == 0) && (sm0_state != 0))))))) && ((((((((((sm1_l == 0) && ( !(_x_sm1_loop_len <= sm1_loop_len))) || ( !((_x_sm1_state != 0) && ( !(sm1_state != 0))))) && (((_x_sm1_state != 0) && ( !(sm1_state != 0))) || (sm1_loop_len == _x_sm1_loop_len))) && (( !(sm1_state != 0)) || ((sm1_l + (-1 * _x_sm1_l)) == 1))) && ((_x_sm1_state != 0) || ( !((sm1_state != 0) && ( !(sm1_loop_len <= sm1_l)))))) && ((_x_sm1_state != 0) || ( !(((semaphore == 3) && (_x_semaphore == 0)) && ( !(sm1_state != 0)))))) && (((sm1_state != 0) == (_x_sm1_state != 0)) || ( !(( !(((semaphore == 3) && (_x_semaphore == 0)) && ( !(sm1_state != 0)))) && ( !(run == 1)))))) && ((semaphore == _x_semaphore) || ( !((run == 1) && ((sm1_state != 0) == (_x_sm1_state != 0)))))) && (((semaphore + (-1 * _x_semaphore)) == -1) || ( !(( !(_x_sm1_state != 0)) && ((run == 1) && (sm1_state != 0))))))) && ((((((((((sm2_l == 0) && ( !(_x_sm2_loop_len <= sm2_loop_len))) || ( !((_x_sm2_state != 0) && ( !(sm2_state != 0))))) && (((_x_sm2_state != 0) && ( !(sm2_state != 0))) || (sm2_loop_len == _x_sm2_loop_len))) && (( !(sm2_state != 0)) || ((sm2_l + (-1 * _x_sm2_l)) == 1))) && ((_x_sm2_state != 0) || ( !((sm2_state != 0) && ( !(sm2_loop_len <= sm2_l)))))) && ((_x_sm2_state != 0) || ( !(((semaphore == 3) && (_x_semaphore == 0)) && ( !(sm2_state != 0)))))) && (((sm2_state != 0) == (_x_sm2_state != 0)) || ( !(( !(((semaphore == 3) && (_x_semaphore == 0)) && ( !(sm2_state != 0)))) && ( !(run == 2)))))) && ((semaphore == _x_semaphore) || ( !((run == 2) && ((sm2_state != 0) == (_x_sm2_state != 0)))))) && (((semaphore + (-1 * _x_semaphore)) == -1) || ( !(( !(_x_sm2_state != 0)) && ((run == 2) && (sm2_state != 0)))))));
    sm2_l = _x_sm2_l;
