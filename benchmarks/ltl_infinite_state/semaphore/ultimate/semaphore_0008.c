//@ ltl invariant negative: ( (! ([] (<> AP((semaphore == 0))))) || (! ( ( ( ( ( ( ( ([] (<> AP((run == 0)))) && ([] (<> AP((run == 1))))) && ([] (<> AP((run == 2))))) && ([] (<> AP((run == 3))))) && ([] (<> AP((run == 4))))) && ([] (<> AP((run == 5))))) && ([] (<> AP((run == 6))))) && ([] (<> AP((run == 7)))))));
...
int main()
{
  ...
  int __ok = (((((((((semaphore == 0) && ((sm0_state != 0) && (( !(sm0_loop_len <= 0)) && (sm0_l == 0)))) && ((sm1_state != 0) && (( !(sm1_loop_len <= 0)) && (sm1_l == 0)))) && ((sm2_state != 0) && (( !(sm2_loop_len <= 0)) && (sm2_l == 0)))) && ((sm3_state != 0) && (( !(sm3_loop_len <= 0)) && (sm3_l == 0)))) && ((sm4_state != 0) && (( !(sm4_loop_len <= 0)) && (sm4_l == 0)))) && ((sm5_state != 0) && (( !(sm5_loop_len <= 0)) && (sm5_l == 0)))) && ((sm6_state != 0) && (( !(sm6_loop_len <= 0)) && (sm6_l == 0)))) && ((sm7_state != 0) && (( !(sm7_loop_len <= 0)) && (sm7_l == 0))));
  while (__ok) {
