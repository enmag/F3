//@ ltl invariant negative: ( (! ([] (<> AP((semaphore == 0))))) || (! ( ( ( ( ( ( ( ( ( ( ( ( ( ( ( ( ( ([] (<> AP((run == 0)))) && ([] (<> AP((run == 1))))) && ([] (<> AP((run == 2))))) && ([] (<> AP((run == 3))))) && ([] (<> AP((run == 4))))) && ([] (<> AP((run == 5))))) && ([] (<> AP((run == 6))))) && ([] (<> AP((run == 7))))) && ([] (<> AP((run == 8))))) && ([] (<> AP((run == 9))))) && ([] (<> AP((run == 10))))) && ([] (<> AP((run == 11))))) && ([] (<> AP((run == 12))))) && ([] (<> AP((run == 13))))) && ([] (<> AP((run == 14))))) && ([] (<> AP((run == 15))))) && ([] (<> AP((run == 16))))) && ([] (<> AP((run == 17)))))));
