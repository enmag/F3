...
def hints(env: PysmtEnv) -> FrozenSet[Hint]:
    ...
    l0.set_progress(0, eq_0=mgr.Equals(x_x, mgr.Minus(x, d)))
    ...
    l0.set_progress(0, eq_0=mgr.Equals(x_y, i_0))
    ...
    l0.set_progress(1, eq_0=mgr.Equals(x_d, mgr.Minus(d, i_1)))
    l1 = Location(env, mgr.Equals(d, i_0), stutterT=stutter)
    l1.set_progress(1, eq_0=mgr.Equals(x_d, d))
